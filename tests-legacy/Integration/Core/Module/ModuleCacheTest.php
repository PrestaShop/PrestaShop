...
class ModuleCacheTest extends IntegrationTestCase
{
    ...
    public function testCacheBehaviour()
    {
        ...
        $trustedFileCreationTime = filemtime(_PS_CONFIG_DIR_ . 'xml/trusted_modules_list.xml');
        sleep(1);
        clearstatcache();
        Module::getModulesOnDisk();
        $newTrustedFileCreationTime = filemtime(_PS_CONFIG_DIR_ . 'xml/trusted_modules_list.xml');
