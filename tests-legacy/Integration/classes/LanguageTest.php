...
class LanguageTest extends IntegrationTestCase
{
    ...
    public function testGetIdByIsoWithCache()
    {
        $this->assertNull(Language::getIdByIso('zz'));
        $this->addDummyLanguage();
        $this->assertIsString(Language::getIdByIso('zz'));
    }
    public function testGetIdByIsoWithoutCache()
    {
        $this->assertNull(Language::getIdByIso('zz', true));
        $this->addDummyLanguage();
        $this->assertIsString(Language::getIdByIso('zz', true));
    }

    protected function addDummyLanguage()
    {
