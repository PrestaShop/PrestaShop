...
class CartTaxesTest extends AbstractCartCalculationTest
{
    ...
    const PRODUCT_FIXTURES = array(
        1 => array('price' => 19.812, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_1),
        2 => array('price' => 32.388, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_1),
        3 => array('price' => 31.188, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_1),
        4 => array('price' => 35.567, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_1, 'outOfStock' => true),
        5 => array('price' => 19.812, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_2),
        6 => array('price' => 32.388, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_2),
        7 => array('price' => 31.188, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_2),
        8 => array('price' => 35.567, 'taxRuleGroupId' => self::TAX_RULE_GROUPID_2, 'outOfStock' => true),
    );
    ...
    public function cartTaxesProvider()
    {
        return array(
            ...
            'tax #1: 3 products in cart, several quantities' => array(
                'products' => array(
                    2 => 2,
                    1 => 3,
                    3 => 1,
            ...
            'tax #2: 3 products in cart, several quantities' => array(
                'products' => array(
                    6 => 2,
                    5 => 3,
                    7 => 1,
            ...
            'tax #3: 3 products in cart, several quantities' => array(
                'products' => array(
                    6 => 2,
                    5 => 3,
                    7 => 1,
