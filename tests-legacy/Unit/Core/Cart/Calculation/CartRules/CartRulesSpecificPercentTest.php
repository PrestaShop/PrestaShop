...
class CartRulesSpecificPercentTest extends AbstractCartCalculationTest
{
    ...
    public function cartWithOneProductSpecificCartRulesPercentProvider()
    {
        return array(
            ...
            'one product in cart, quantity 1, one specific 50% voucher on product #2' => array(
                'products' => array(
                    1 => 1,
                ),
            ...
            'one product in cart, quantity 3, one specific 50% voucher on product #2' => array(
                'products' => array(
                    1 => 3,
                ),
            ...
            'one product #2 in cart, quantity 3, one specific 50% voucher on product #2' => array(
                'products' => array(
                    2 => 3,
                ),
            ...
            '3 products in cart, several quantities, one specific 50% voucher on product #2' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
    ...
    public function cartWithMultipleProductSpecificCartRulesPercentProvider()
    {
        return array(
            'empty cart' => array(
                'products' => array(),
                'expectedTotal' => 0,
                'cartRules' => array(10, 11),
                'knownToFailOnV1' => false,
            ),
            'one product in cart, quantity 1, specific 50% voucher on product #2, specific 10% voucher on product #2' => array(
                'products' => array(
                    1 => 1,
                ),
                'expectedTotal' => static::PRODUCT_FIXTURES[1]['price']
            ...
            'one product in cart, quantity 3, specific 50% voucher on product #2, specific 10% voucher on product #2' => array(
                'products' => array(
                    1 => 3,
                ),
                'expectedTotal' => 3 * static::PRODUCT_FIXTURES[1]['price']
            ...
            'one product #2 in cart, quantity 3, specific 50% voucher on product #2, specific 10% voucher on product #2' => array(
                'products' => array(
                    2 => 3,
                ),
            ...
            '3 products in cart, several quantities, specific 50% voucher on product #2, specific 10% voucher on product #2' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
