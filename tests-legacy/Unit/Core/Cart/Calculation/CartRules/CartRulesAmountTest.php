...
class CartRulesAmountTest extends AbstractCartCalculationTest
{
    ...
    public function cartWithOneCartRuleAmountProvider()
    {
        return array(
            ...
            'one product in cart, quantity 1, one 5€ global voucher' => array(
                'products' => array(
                    1 => 1,
                ),
            ...
            'one product in cart, quantity 1, one 500€ global voucher' => array(
                'products' => array(
                    1 => 1,
                ),
            ...
            'one product in cart, quantity 3, one 5€ global voucher' => array(
                'products' => array(
                    1 => 3,
                ),
            ...
            '3 products in cart, several quantities, one 5€ global voucher (reduced product at first place)' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
            ...
            '3 products in cart, several quantities, one 5€ global voucher (reduced product at second place)' => array(
                'products' => array(
                    1 => 3, // 59.43
                    2 => 2, // 64.776
                    3 => 1, // 31.188
            ...
            '3 products in cart, several quantities, one 500€ global voucher' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
    ...
    public function cartWithMultipleCartRulesAmountProvider()
    {
        return array(
            ...
            'one product in cart, quantity 1, one 5€ global voucher, one 10€ global voucher' => array(
                'products' => array(
                    1 => 1,
                ),
                'expectedTotal' => static::PRODUCT_FIXTURES[1]['price']
            ...
            'one product in cart, quantity 3, one 5€ global voucher, one 10€ global voucher' => array(
                'products' => array(
                    1 => 3,
                ),
                'expectedTotal' => 3 * static::PRODUCT_FIXTURES[1]['price']
            ...
            '3 products in cart, several quantities, one 5€ global voucher, one 10€ global voucher' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
