...
class CartRulesSpecificAmountTest extends AbstractCartCalculationTest
{
    ...
    public function cartWithOneProductSpecificCartRulesAmountProvider()
    {
        return array(
            ...
            'one product in cart, quantity 1, one specific 5€ voucher on product #2' => array(
                'products' => array(
                    1 => 1,
                ),
            ...
            'one product in cart, quantity 3, one specific 5€ voucher on product #2' => array(
                'products' => array(
                    1 => 3,
                ),
            ...
            '3 products in cart, several quantities, one specific 5€ voucher on product #2' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
            ...
            '3 products in cart, several quantities, one specific 500€ voucher on product #2' => array(
                'products' => array(
                    2 => 2, // 64.776
                    1 => 3, // 59.43
                    3 => 1, // 31.188
