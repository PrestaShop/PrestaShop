...
class BlockLayered extends Module
{
	...
	public function hookAttributeGroupForm($params)
	{
		...
		<div class="form-group">
			<label for="url_1" class="control-label col-lg-3">
			<span class="label-tooltip" data-toggle="tooltip" data-html="true" data-toggle="tooltip" data-original-title="'.$this->l('Invalid characters:').' <>;=#{}_">
				'.$this->l('URL:').'
			</span>
			</label>';
		...
		<div class="col-lg-4">
			...
			foreach ($languages as $language) {
				...
				<div class="translatable-field lang-'.$language['id_lang'].'"';
					...
					$return .= '<input id="url_1" class="" type="text" value="'.Tools::safeOutput(@$lang_value[$language['id_lang']]['url_name'], true).'" name="url_1">';
				if(count($languages) > 1)
				{
					$return .= '
					</div>
