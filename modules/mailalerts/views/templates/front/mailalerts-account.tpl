	...
	{if $mailAlerts}
		<div>
			...
			<div class="mailalert clearfix">
				<a href="{$link->getProductLink($mailAlert.id_product, null, null, null, null, $mailAlert.id_shop)}" title="{$mailAlert.name}" class="product_img_link" mod='mailalerts'}" rel="nofollow"><img src="{$link->getImageLink($mailAlert.link_rewrite, $mailAlert.cover, 'small_default')}" alt="" /></a>
				<h3><a href="{$link->getProductLink($mailAlert.id_product, null, null, null, null, $mailAlert.id_shop)}" title="{$mailAlert.name}" rel="nofollow">{$mailAlert.name}</a></h3>
