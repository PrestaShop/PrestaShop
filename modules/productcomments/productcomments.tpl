	...
	<div id="new_comment_form">
		<form action="#">
			...
			<div class="product clearfix">
				<img src="{$link->getImageLink($product->link_rewrite, $productcomment_cover, 'home_default')}" height="{getHeightSize type='home_default'}" width="{getWidthSize type='home_default'}" alt="{$product->name|escape:html:'UTF-8'}" />
