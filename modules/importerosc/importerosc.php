...
class importerosc extends ImportModule
{
	...
	public function getCategories($limit = 0, $nrb_import = 100)
	{
		...
		$categories = $this->executeS('
									SELECT c.categories_id as id_category, c.parent_id as id_parent, level as level_depth, cd.language_id as id_lang, cd.categories_name as name , 1 as active, categories_image as images, NOW() as date_add
