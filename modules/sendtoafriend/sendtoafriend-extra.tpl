...
<div style="display: none;">
	<div id="send_friend_form">
			...
			<div class="product clearfix">
				<img src="{$link->getImageLink($stf_product->link_rewrite, $stf_product_cover, 'home_default')}" height="{getHeightSize type='home_default'}" width="{getWidthSize type='home_default'}" alt="{$stf_product->name|escape:html:'UTF-8'}" />
