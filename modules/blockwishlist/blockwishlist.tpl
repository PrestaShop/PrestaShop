...
<div id="wishlist_block" class="block account">
	<h4>
		<a href="{$wishlist_link}" title="{l s='Manage my Wishlist' mod='blockwishlist'}" rel="nofollow">{l s='Wishlist' mod='blockwishlist'}</a>
	</h4>
	<div class="block_content">
		...
		{/if}
			<a href="{$wishlist_link}" title="{l s='Manage my wishlists' mod='blockwishlist'}" rel="nofollow">&raquo; {l s='My wishlists' mod='blockwishlist'}</a>
		</p>
	</div>
</div>
