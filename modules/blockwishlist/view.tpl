...
<div class="addresses" id="featured-products_block_center">
	...
	<div class="ajax_block_product">
		...
		$product.link_rewrite, $product.category_rewrite)}" title="{l s='View' mod='blockwishlist'}" title="{$product.name|escape:'htmlall':'UTF-8'}">{$product.name|truncate:30:'...'|escape:'htmlall':'UTF-8'}</a></li>
