...
{if $products}
	...
	<div class="wishlistLinkTop">
		...
		<ul class="clearfix display_list">
			...
			<li>
				<a href="#" id="hideBoughtProductsInfos" class="button_account" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Hide bought product\'s info' mod='blockwishlist'}">{l s='Hide bought product\'s info' mod='blockwishlist'}</a>
				<a href="#" id="showBoughtProductsInfos" class="button_account"  onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Show bought product\'s info' mod='blockwishlist'}">{l s='Show bought product\'s info' mod='blockwishlist'}</a>
			</li>
			{/if}
		</ul>
