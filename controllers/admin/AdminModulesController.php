...
class AdminModulesControllerCore extends AdminController
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->list_modules_categories['administration']['name'] = $this->trans('Administration');
        $this->list_modules_categories['advertising_marketing']['name'] = $this->trans('Advertising and Marketing');
        $this->list_modules_categories['analytics_stats']['name'] = $this->trans('Analytics and Stats');
        $this->list_modules_categories['billing_invoicing']['name'] = $this->trans('Taxes & Invoicing');
        $this->list_modules_categories['checkout']['name'] = $this->trans('Checkout');
        $this->list_modules_categories['content_management']['name'] = $this->trans('Content Management');
        $this->list_modules_categories['customer_reviews']['name'] = $this->trans('Customer Reviews');
        $this->list_modules_categories['export']['name'] = $this->trans('Export', array(), 'Admin.Actions');
        $this->list_modules_categories['front_office_features']['name'] = $this->trans('Front office Features');
        $this->list_modules_categories['i18n_localization']['name'] = $this->trans('Internationalization and Localization');
        $this->list_modules_categories['merchandizing']['name'] = $this->trans('Merchandising');
        $this->list_modules_categories['migration_tools']['name'] = $this->trans('Migration Tools');
        $this->list_modules_categories['payments_gateways']['name'] = $this->trans('Payments and Gateways');
        $this->list_modules_categories['payment_security']['name'] = $this->trans('Site certification & Fraud prevention');
        $this->list_modules_categories['pricing_promotion']['name'] = $this->trans('Pricing and Promotion');
        $this->list_modules_categories['quick_bulk_update']['name'] = $this->trans('Quick / Bulk update');
        /* 		$this->list_modules_categories['search_filter']['name'] = $this->trans('Search and Filter'); */
        $this->list_modules_categories['seo']['name'] = $this->trans('SEO');
        $this->list_modules_categories['shipping_logistics']['name'] = $this->trans('Shipping and Logistics');
        $this->list_modules_categories['slideshows']['name'] = $this->trans('Slideshows');
        $this->list_modules_categories['smart_shopping']['name'] = $this->trans('Comparison site & Feed management');
        $this->list_modules_categories['market_place']['name'] = $this->trans('Marketplace');
        $this->list_modules_categories['others']['name'] = $this->trans('Other Modules');
        $this->list_modules_categories['mobile']['name'] = $this->trans('Mobile');
        $this->list_modules_categories['dashboard']['name'] = $this->trans('Dashboard');
        $this->list_modules_categories['i18n_localization']['name'] = $this->trans('Internationalization & Localization');
        $this->list_modules_categories['emailing']['name'] = $this->trans('Emailing & SMS');
        $this->list_modules_categories['social_networks']['name'] = $this->trans('Social Networks');
        $this->list_modules_categories['social_community']['name'] = $this->trans('Social & Community');
    ...
    */
    ...
    public function renderKpis()
    {
        ...
        $helper->color = 'color1';
        $helper->title = $this->trans('Installed Modules');
        ...
        $helper->color = 'color2';
        $helper->title = $this->trans('Disabled Modules');
    ...
    public function initModal()
    {
        ...
        $this->modals[] = array(
            ...
            'modal_class' => 'modal-lg',
            'modal_title' => $this->trans('This module is Untrusted for your country'),
            'modal_content' => $modal_content,
        );
    }
