...
class AdminAttributesGroupsControllerCore extends AdminController
{
    ...
    public function renderFormAttributes()
    {
        ...
        foreach ($attributes_groups as $attribute_group) {
            $str_attributes_groups .= '"'.$attribute_group['id_attribute_group'].'" : '.('color' == $attribute_group['group_type'] ? '1' : '0').', ';
        }
    ...
    public function initContent()
    {
        if (Combination::isFeatureActive()) {
            ...
            } elseif ('editAttributes' == $this->display) {
    ...
    public function initToolbar()
    {
        switch ($this->display) {
            ...
            case 'editAttributes':
                ...
                if ('editAttributes' == $this->display && !$this->id_attribute) {
    ...
    public function postProcess()
    {
        ...
        if (Tools::getValue('updateattribute') || Tools::isSubmit('deleteattribute') || Tools::isSubmit('submitAddattribute')) {
            ...
            if (false !== Tools::getValue('position') && Tools::getValue('id_attribute')) {
