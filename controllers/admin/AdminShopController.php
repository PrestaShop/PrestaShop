...
class AdminShopControllerCore extends AdminController
{
	...
	public function postProcess()
	{
		...
		if ($result !== false && (Tools::isSubmit('submitAddshopAndStay') || Tools::isSubmit('submitAddshop')) && isset($result->id_category) && (int)$result->id_category != (int)Configuration::get('PS_HOME_CATEGORY', null, null, (int)$result->id))
