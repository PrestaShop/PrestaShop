        ...
        switch ((int) Tools::getValue('entity')) {
            ...
            case $this->entities[$this->trans('Addresses', [], 'Admin.Global')]:
                ...
                $this->available_fields = [
                    ...
                    'siret' => ['label' => $this->trans('Siret', [], 'Admin.Orderscustomers.Feature')],
                    'APE' => ['label' => $this->trans('APE', [], 'Admin.Orderscustomers.Feature')],
            ...
            case $this->entities[$this->trans('Store contacts', [], 'Admin.Advparameters.Feature')]:
                ...
                $this->available_fields = [
                    ...
                    'siret' => ['label' => $this->trans('Siret', [], 'Admin.Global')],
                    'APE' => ['label' => $this->trans('APE', [], 'Admin.Global')],
                    'vat_number' => ['label' => $this->trans('VAT number', [], 'Admin.Global')],
                    'iban' => ['label' => $this->trans('Iban', [], 'Admin.Global')],
