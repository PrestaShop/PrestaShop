...
class AdminImportControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->entities = array(
            ...
            $this->trans('SpecificPrice', array(), 'Admin.Global'),
        ...
        switch ((int)Tools::getValue('entity')) {
            case $this->entities[$this->trans('Combinations', array(), 'Admin.Global')]:
                ...
                $this->available_fields = array(
                    ...
                    'group' => array(
                        'label' => $this->trans('Attribute (Name:Type:Position)', array(),
                    ...
                    'available_date' => array(
                        'label' => $this->trans('Combination availability date', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'image_position' => array(
                        'label' => $this->trans('Choose among product images by position (1,2,3...)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'image_url' => array(
                    ...
                    'shop' => array(
                        ...
                        'help' => $this->trans('Ignore this field if you don\'t use the Multistore tool. If you leave this field empty, the default shop will be used.',
                    ...
                    'advanced_stock_management' => array(
                        ...
                        'help' => $this->trans('Enable Advanced Stock Management on product (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Help'),
                    ),
                    'depends_on_stock' => array(
                        'label' => $this->trans('Depends on stock', array(), 'Admin.Advparameters.Feature'),
                        'help' => $this->trans('0 = Use quantity set in product, 1 = Use quantity from warehouse.',
                            array(), 'Admin.Advparameters.Help'),
                    ),
                    'warehouse' => array(
                        'label' => $this->trans('Warehouse', array(), 'Admin.Advparameters.Feature'),
                        'help' => $this->trans('ID of the warehouse to set as storage.', array(),
                            'Admin.Advparameters.Help'),
                    ),
                );
            ...
            case $this->entities[$this->trans('Categories', array(), 'Admin.Global')]:
                $this->available_fields = array(
                    ...
                    'is_root_category' => array(
                        ...
                        'help' => $this->trans('A category root is where a category tree can begin. This is used with multistore.',
                            array(), 'Admin.Advparameters.Help'),
                    ),
            ...
            case $this->entities[$this->trans('Products', array(), 'Admin.Global')]:
                ...
                $this->available_fields = array(
                    ...
                    'name' => array('label' => $this->trans('Name', array(), 'Admin.Global')),
                    'redirect_type' => array(
                        'label' => $this->trans('Redirect type', array(), 'Admin.Advparameters.Feature'),
                    ),
                    ...
                    'available_for_order' => array(
                        'label' => $this->trans('Available for order (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'available_date' => array(
                    ...
                    'delete_existing_images' => array(
                        'label' => $this->trans('Delete existing images (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'features' => array(
                        'label' => $this->trans('Feature (Name:Value:Position:Customized)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'online_only' => array(
                        'label' => $this->trans('Available online only (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'condition' => array('label' => $this->trans('Condition', array(), 'Admin.Catalog.Feature')),
                    'customizable' => array(
                        'label' => $this->trans('Customizable (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'uploadable_files' => array(
                        'label' => $this->trans('Uploadable files (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'text_fields' => array(
                        'label' => $this->trans('Text fields (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'out_of_stock' => array(
                    ...
                    'is_virtual' => array(
                        'label' => $this->trans('Virtual product (0 = No, 1 = Yes)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    ...
                    'nb_downloadable' => array(
                        ...
                        'help' => $this->trans('Number of days this file can be accessed by customers. Set to zero for unlimited access.',
                    ...
                    'advanced_stock_management' => array(
                        'label' => $this->trans('Advanced Stock Management', array(), 'Admin.Advparameters.Feature'),
                        'help' => $this->trans('Enable Advanced Stock Management on product (0 = No, 1 = Yes).',
                            array(), 'Admin.Advparameters.Help'),
                    ),
                    'depends_on_stock' => array(
                        'label' => $this->trans('Depends on stock', array(), 'Admin.Advparameters.Feature'),
                ...
                break;
            case $this->entities[$this->trans('SpecificPrice', array(), 'Admin.Global')]:
                $this->available_fields = array(
                    'no' => array(
                        'label' => $this->trans('Ignore this column', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'id_specific_price' => array('label' => $this->trans('ID', array(), 'Admin.Global')),
                    'id_product' => array(
                        'label' => $this->trans('ID product', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'product_reference' => array(
                        'label' => $this->trans('Product Reference', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'id_product_attribute' => array(
                        'label' => $this->trans('ID Product attribute', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'product_attribute_reference' => array(
                        'label' => $this->trans('Product Attribute Reference', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'currency' => array('label' => $this->trans('Currency', array(), 'Admin.Global').'*'),
                    'country' => array('label' => $this->trans('Country', array(), 'Admin.Advparameters.Feature')),
                    'group' => array('label' => $this->trans('Customer group', array(), 'Admin.Global').'*'),
                    'price' => array('label' => $this->trans('Price', array(), 'Admin.Global').'*'),
                    'from_quantity' => array(
                        'label' => $this->trans('From quantity', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'reduction' => array('label' => $this->trans('Reduction', array(), 'Admin.Advparameters.Feature')),
                    'reduction_tax' => array(
                        'label' => $this->trans('Reduction tax', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'reduction_type' => array(
                        'label' => $this->trans('Reduction type', array(), 'Admin.Advparameters.Feature'),
                    ),
                    'from' => array('label' => $this->trans('Valid from', array(), 'Admin.Advparameters.Feature')),
                    'to' => array('label' => $this->trans('Valid to', array(), 'Admin.Advparameters.Feature')),
                    'id_shop' => array(
                        'label' => $this->trans('ID / Name of shop', array(), 'Admin.Advparameters.Feature'),
                        'help' => $this->trans('Ignore this field if you don\'t use the Multistore tool. If you leave this field empty, the default shop will be used.',
                            array(), 'Admin.Advparameters.Help'),
            ...
            case $this->entities[$this->trans('Customers', array(), 'Admin.Global')]:
                ...
                $this->available_fields = array(
                    ...
                    'active' => array('label' => $this->trans('Active  (0/1)', array(), 'Admin.Advparameters.Feature')),
                    'id_gender' => array(
                        'label' => $this->trans('Titles ID (Mr = 1, Ms = 2, else 0)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    ...
                    'date_add' => array(
                        'label' => $this->trans('Registration date (yyyy-mm-dd)', array(),
                            'Admin.Advparameters.Feature'),
                    ),
                    'group' => array(
        ...
        $this->separator = ($separator = Tools::substr(strval(trim(Tools::getValue('separator'))), 0,
            1)) ? $separator : ';';
        $this->convert = false;
        $this->multiple_value_separator = ($separator = Tools::substr(strval(trim(Tools::getValue('multiple_value_separator'))),
            0, 1)) ? $separator : ',';
    }
    ...
    */
    ...
    public function renderForm()
    {
        if (!is_dir(AdminImportController::getPath())) {
            return !($this->errors[] = $this->trans('The import directory doesn\'t exist. Please check your file path.',
                array(), 'Admin.Advparameters.Notification'));
        }
        
        if (!is_writable(AdminImportController::getPath())) {
            $this->displayWarning($this->trans('The import directory must be writable (CHMOD 755 / 777).', array(),
        ...
        if (isset($_FILES['file']) && !empty($_FILES['file']['error'])) {
            switch ($_FILES['file']['error']) {
                case UPLOAD_ERR_INI_SIZE:
                    $_FILES['file']['error'] = $this->trans('The uploaded file exceeds the upload_max_filesize directive in php.ini. If your server configuration allows it, you may add a directive in your .htaccess.',
                        array(), 'Admin.Advparameters.Notification');
                    break;
                case UPLOAD_ERR_FORM_SIZE:
                    $_FILES['file']['error'] = $this->trans('The uploaded file exceeds the post_max_size directive in php.ini. If your server configuration allows it, you may add a directive in your .htaccess, for example:',
                            array(), 'Admin.Advparameters.Notification')
                        .'<br/><a href="'.$this->context->link->getAdminLink('AdminMeta').'" >
					<code>php_value post_max_size 20M</code> '.
                        $this->trans('(click to open "Generators" page)', array(),
                            'Admin.Advparameters.Notification').'</a>';
                    break;
                    break;
                case UPLOAD_ERR_PARTIAL:
                    $_FILES['file']['error'] = $this->trans('The uploaded file was only partially uploaded.', array(),
                        'Admin.Advparameters.Notification');
                    break;
                    break;
                case UPLOAD_ERR_NO_FILE:
                    $_FILES['file']['error'] = $this->trans('No file was uploaded.', array(),
                        'Admin.Advparameters.Notification');
                    break;
                    break;
            }
        } elseif (!preg_match('#([^\.]*?)\.(csv|xls[xt]?|o[dt]s)$#is', $_FILES['file']['name'])) {
            $_FILES['file']['error'] = $this->trans('The extension of your file should be .csv.', array(),
                'Admin.Advparameters.Notification');
        } elseif (!@filemtime($_FILES['file']['tmp_name']) ||
            !@move_uploaded_file($_FILES['file']['tmp_name'],
                AdminImportController::getPath().$filename_prefix.str_replace("\0", '', $_FILES['file']['name']))) {
            $_FILES['file']['error'] = $this->trans('An error occurred while uploading / copying the file.', array(),
                'Admin.Advparameters.Notification');
        } else {
    ...
    public function initContent()
    {
        if ($this->display == 'import') {
            if (Tools::getValue('csv')) {
                ...
                $this->errors[] = $this->trans('To proceed, please upload a file first.', array(),
                    'Admin.Advparameters.Notification');
    ...
    public function getAvailableFields($in_array = false)
    {
        ...
        foreach ($this->available_fields as $k => $field) {
            ...
            if ($k === 'price_tin') { // Special case for Product : either one or the other. Not both.
                $fields[$i - 1] = '<div>'.$this->available_fields[$keys[$i - 1]]['label'].'<br/>&nbsp;&nbsp;<i>'.$this->trans('or',
                        array(), 'Admin.Advparameters.Help').'</i>&nbsp;&nbsp; '.$field['label'].'</div>';
            } else {
                if (isset($field['help'])) {
    ...
    public function categoryImport(
        ...
        for ($current_line = 0; ($line = fgetcsv($handle, MAX_LINE_SIZE,
            $this->separator)) && (!$limit || $current_line < $limit); $current_line++) {
            $line_count++;
            if ($this->convert) {
            ...
            if (count($line) == 1 && $line[0] == null) {
                $this->warnings[] = $this->trans('There is an empty row in the file that won\'t be imported.', array(),
                    'Admin.Advparameters.Notification');
                continue;
            }
    ...
    public function storeContactImportOne(
        $info,
        $shop_is_feature_active,
        $regenerate,
        $force_ids,
        ...
        if ($force_ids && isset($info['id']) && (int)$info['id']) {
            ...
            if (array_key_exists('id', $info) && (int)$info['id'] && Store::existsInDatabase((int)$info['id'],
                    'store')) {
                $store = new Store((int)$info['id']);
            } else {
                $store = new Store();
        ...
        if (isset($store->image) && !empty($store->image)) {
            if (!(AdminImportController::copyImg($store->id, null, $store->image, 'stores', !$regenerate))) {
                $this->warnings[] = $store->image.' '.$this->trans('cannot be copied.', array(),
                        'Admin.Advparameters.Notification');
            }
        }
        ...
        if (isset($store->country) && is_numeric($store->country)) {
            ...
            if ($id_country = Country::getIdByName(null, $store->country)) {
                ...
                $country->iso_code = Tools::strtoupper(Tools::substr($store->country, 0,
                    2)); // Default iso for country to create
                ...
                if (($field_error = $country->validateFields(UNFRIENDLY_ERROR, true)) === true &&
                    ...
                    if (!$validateOnly) {
                        $default_language_id = (int)Configuration::get('PS_LANG_DEFAULT');
                        $this->errors[] = sprintf($this->trans('%s cannot be saved', array(),
                            'Admin.Advparameters.Notification'), $country->name[$default_language_id]);
                    }
                    if ($field_error !== true || isset($lang_field_error) && $lang_field_error !== true) {
                        $this->errors[] = ($field_error !== true ? $field_error : '').(isset($lang_field_error) && $lang_field_error !== true ? $lang_field_error : '').
                            Db::getInstance()->getMsgError();
        ...
        if (isset($store->state) && is_numeric($store->state)) {
            ...
            if ($id_state = State::getIdByName($store->state)) {
                ...
                $state->iso_code = Tools::strtoupper(Tools::substr($store->state, 0,
                    2)); // Default iso for state to create
                ...
                if (($field_error = $state->validateFields(UNFRIENDLY_ERROR, true)) === true &&
                    ...
                    if (!$validateOnly) {
                        $this->errors[] = sprintf($this->trans('%s cannot be saved', array(),
                            'Admin.Advparameters.Notification'), $state->name);
                    }
                    if ($field_error !== true || isset($lang_field_error) && $lang_field_error !== true) {
                        $this->errors[] = ($field_error !== true ? $field_error : '').(isset($lang_field_error) && $lang_field_error !== true ? $lang_field_error : '').
                            Db::getInstance()->getMsgError();
        ...
        if (($field_error = $store->validateFields(UNFRIENDLY_ERROR, true)) === true &&
            ...
            $this->errors[] = $this->trans('Store is invalid', array(),
                    'Admin.Advparameters.Notification').' ('.$store->name.')';
            $this->errors[] = ($field_error !== true ? $field_error : '').(isset($lang_field_error) && $lang_field_error !== true ? $lang_field_error : '');
        }
    }
    ...
    public function postProcess()
    {
        ...
        if (_PS_MODE_DEMO_) {
            $this->errors[] = $this->trans('This functionality has been disabled.', array(),
    ...
    public function importByGroups(
        ...
        if (Tools::getValue('csv')) {
            ...
            switch ((int)Tools::getValue('entity')) {
                ...
                case $this->entities[$import_type = $this->trans('Products', array(), 'Admin.Global')]:
                    ...
                    $moreStepLabels = array(
                        $this->trans('Linking Accessories...', array(), 'Admin.Advparameters.Notification'),
                    );
                ...
                case $this->entities[$import_type = $this->trans('Alias', array(), 'Admin.Shopparameters.Feature')]:
                    ...
                    break;
                case $this->entities[$import_type = $this->trans('Store contacts', array(),
                    'Admin.Advparameters.Feature')]:
            ...
            if (Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT')) {
                switch ((int)Tools::getValue('entity')) {
                    case $this->entities[$import_type = $this->trans('Supply Orders', array(),
                        'Admin.Advparameters.Feature')]:
                        if (Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT')) {
                            $doneCount += $this->supplyOrdersImport($offset, $limit, $validateOnly);
                        }
                        break;
                    case $this->entities[$import_type = $this->trans('Supply Order Details', array(),
                        'Admin.Advparameters.Feature')]:
                        if (Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT')) {
            ...
            if ($import_type !== false) {
                $log_message = sprintf($this->trans('%s import', array(), 'Admin.Advparameters.Notification'),
                    $import_type);
                if ($offset !== false && $limit !== false) {
                    $log_message .= ' '.sprintf($this->trans('(from %s to %s)', array(),
                            'Admin.Advparameters.Notification'), $offset, $limit);
                }
                if (Tools::getValue('truncate')) {
                    $log_message .= ' '.$this->trans('with truncate', array(), 'Admin.Advparameters.Notification');
                }
                PrestaShopLogger::addLog($log_message, 1, null, $import_type, null, true,
    ...
    public function ajaxProcessImport()
    {
        ...
        if (!$validateOnly && (bool)$results['isFinished'] && !isset($results['oneMoreStep']) && (bool)Tools::getValue('sendemail')) {
            ...
            try {
                ...
                if (!$mailSuccess) {
                    $results['warnings'][] = $this->trans('The confirmation email couldn\'t be sent, but the import is successful. Yay!',
                        array(), 'Admin.Advparameters.Notification');
                }
            } catch (\Exception $e) {
                $results['warnings'][] = $this->trans('The confirmation email couldn\'t be sent, but the import is successful. Yay!',
    ...
    protected function categoryImportOne(
        ...
        if (isset($info['id']) && in_array((int)$info['id'], $tab_categ)) {
            $this->errors[] = $this->trans('The category ID must be unique. It can\'t be the same as the one for Root or Home category.',
                array(), 'Admin.Advparameters.Notification');
        ...
        if ((isset($category->link_rewrite) && empty($category->link_rewrite[$default_language_id])) || !$valid_link) {
            ...
            if ($category->link_rewrite == '') {
                ...
                $this->warnings[] = sprintf($this->trans('URL rewriting failed to auto-generate a friendly URL for: %s',
                    array(), 'Admin.Advparameters.Notification'), $category->name[$default_language_id]);
            }
        ...
        if (($field_error = $category->validateFields(UNFRIENDLY_ERROR, true)) === true &&
            ($lang_field_error = $category->validateFieldsLang(UNFRIENDLY_ERROR,
                true)) === true && empty($this->errors)) {
            ...
            if ($category->id && $category->id == $category->id_parent) {
                $this->errors[] = sprintf(
                    $this->trans('A category cannot be its own parent. The parent category ID is either missing or unknown (ID: %1$s).',
                        array(), 'Admin.Advparameters.Notification'),
            ...
            if ($category->id == Configuration::get('PS_ROOT_CATEGORY')) {
                $this->errors[] = $this->trans('The root category cannot be modified.', array(),
                    'Admin.Advparameters.Notification');
            }
        ...
        if (isset($category->image) && !empty($category->image)) {
            if (!(AdminImportController::copyImg($category->id, null, $category->image, 'categories', !$regenerate))) {
                $this->warnings[] = $category->image.' '.$this->trans('cannot be copied.', array(),
                        'Admin.Advparameters.Notification');
            }
        }
    ...
    protected function productImportOne(
        ...
        } elseif (array_key_exists('id', $info) && (int)$info['id'] && Product::existsInDatabase((int)$info['id'],
                'product')) {
            $product = new Product((int)$info['id']);
        } else {
            $product = new Product();
        ...
        if ((int)$product->id_tax_rules_group != 0) {
            if (Validate::isLoadedObject(new TaxRulesGroup($product->id_tax_rules_group))) {
                ...
                $this->addProductWarning(
                    ...
                    $this->trans('Unknown tax rule group ID. You need to create a group with this ID first.', array(),
                        'Admin.Advparameters.Notification')
                );
            }
        }
            ...
            foreach ($product->category as $value) {
                if (is_numeric($value)) {
                    if (Category::categoryExists((int)$value)) {
                        ...
                        $category_to_create->link_rewrite = AdminImportController::createMultiLangField($category_link_rewrite);
                        if (($field_error = $category_to_create->validateFields(UNFRIENDLY_ERROR, true)) === true &&
                            ($lang_field_error = $category_to_create->validateFieldsLang(UNFRIENDLY_ERROR,
                                true)) === true &&
                            !$validateOnly &&  // Do not move this condition: previous tests should be played always, but next ->add() test should not be played in validateOnly mode
                            $category_to_create->add()) {
                    ...
                    $category = Category::searchByPath($default_language_id, trim($value), $this,
        ...
        if (!isset($product->id_category_default) || !$product->id_category_default) {
            ...
            if (isset($product->id_category[0])) {
                ...
                $product->id_category_default = Category::getRootCategory(null,
                    Validate::isLoadedObject($defaultProductShop) ? $defaultProductShop : null)->id;
            }
        }
        ...
        foreach ($product_shop as $shop) {
            ...
            if (in_array($shop, $shop_ids)) {
                ...
                $this->addProductWarning(Tools::safeOutput($info['name']), $product->id,
        ...
        if (!$res) {
            ...
            // Product supplier
            if (!$validateOnly && isset($product->id) && $product->id && isset($product->id_supplier) && property_exists($product,
                    'supplier_reference')) {
                $id_product_supplier = (int)ProductSupplier::getIdByProductAndSupplier((int)$product->id, 0,
                ...
                foreach ($product->image as $key => $url) {
                    ...
                    if (!empty($url)) {
                        ...
                        if (($field_error = $image->validateFields(UNFRIENDLY_ERROR, true)) === true &&
                            ($lang_field_error = $image->validateFieldsLang(UNFRIENDLY_ERROR,
                                true)) === true && $image->add()) {
                            ...
                            if (!AdminImportController::copyImg($product->id, $image->id, $url, 'products',
                                !$regenerate)) {
                                $image->delete();
                                $this->warnings[] = sprintf($this->trans('Error copying image: %s', array(),
                                    'Admin.Advparameters.Notification'), $url);
                            }
                        } else {
                            $error = true;
                        }
                    ...
                    if ($error) {
                        $this->warnings[] = sprintf($this->trans('Product #%1$d: the picture (%2$s) cannot be saved.',
                            array(), 'Admin.Advparameters.Notification'), $image->id_product, $url);
                    }
                }
            }
            ...
            if (!$validateOnly && isset($features['features']) && !empty($features['features'])) {
                foreach (explode($this->multiple_value_separator, $features['features']) as $single_feature) {
                    ...
                    if (!empty($feature_name) && !empty($feature_value)) {
                        ...
                        $id_feature_value = (int)FeatureValue::addFeatureValueImport($id_feature, $feature_value,
                            $id_product, $id_lang, $custom);
            ...
            if (!$validateOnly && isset($product->advanced_stock_management)) {
                if ($product->advanced_stock_management != 1 && $product->advanced_stock_management != 0) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management has incorrect value. Not set for product %1$s ',
                        array(), 'Admin.Advparameters.Notification'), $product->name[$default_language_id]);
                } elseif (!Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT') && $product->advanced_stock_management == 1) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management is not enabled, cannot enable on product %1$s ',
                        array(), 'Admin.Advparameters.Notification'), $product->name[$default_language_id]);
            ...
            if (isset($product->warehouse) && $product->warehouse) {
                if (!Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT')) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management is not enabled, warehouse not set on product %1$s ',
                        array(), 'Admin.Advparameters.Notification'), $product->name[$default_language_id]);
                } elseif (!$validateOnly) {
                    if (Warehouse::exists($product->warehouse)) {
                        ...
                        if (WarehouseProductLocation::getProductLocation($product->id, 0,
                        ...
                        $this->warnings[] = sprintf($this->trans('Warehouse did not exist, cannot set on product %1$s.',
                            array(), 'Admin.Advparameters.Notification'), $product->name[$default_language_id]);
                    }
                }
            }
            ...
            if (isset($product->depends_on_stock)) {
                if ($product->depends_on_stock != 0 && $product->depends_on_stock != 1) {
                    $this->warnings[] = sprintf($this->trans('Incorrect value for "Depends on stock" for product %1$s ',
                        array(), 'Admin.Advparameters.Notification'), $product->name[$default_language_id]);
                } elseif ((!$product->advanced_stock_management || $product->advanced_stock_management == 0) && $product->depends_on_stock == 1) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management is not enabled, cannot set "Depends on stock" for product %1$s ',
                        array(), 'Admin.Advparameters.Notification'), $product->name[$default_language_id]);
                } elseif (!$validateOnly) {
                ...
                if (!$validateOnly && isset($product->quantity)) {
                    ...
                    if ($product->depends_on_stock == 1) {
                        ...
                        if ($stock_manager->addProduct((int)$product->id, 0, $warehouse, (int)$product->quantity, 1,
                            $price, true)) {
    ...
    protected function specificPriceImportOne(
        $info,
        &$product,
        $id_shop_list,
        $match_ref,
            ...
            foreach (explode($this->multiple_value_separator, $info['attribute']) as $key => $attribute) {
                ...
                if (isset($groups_attributes[$key])) {
                    ...
                    if (!Validate::isEan13($info['ean13'])) {
                        $this->warnings[] = sprintf($this->trans('EAN13 "%1s" has incorrect value for product with id %2d.',
                            array(), 'Admin.Advparameters.Notification'), $info['ean13'], $product->id);
                        $info['ean13'] = '';
                    }
...
// until here
        ...
        if ($id_product_attribute) {
            ...
            if (isset($info['advanced_stock_management'])) {
                if ($info['advanced_stock_management'] != 1 && $info['advanced_stock_management'] != 0) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management has incorrect value. Not set for product with id %d.',
                        array(), 'Admin.Advparameters.Notification'), $product->id);
                } elseif (!Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT') && $info['advanced_stock_management'] == 1) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management is not enabled, cannot enable on product with id %d.',
                        array(), 'Admin.Advparameters.Notification'), $product->id);
                } elseif (!$validateOnly) {
            ...
            if (isset($info['warehouse']) && $info['warehouse']) {
                if (!Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT')) {
                    $this->warnings[] = sprintf($this->trans('Advanced stock management is not enabled, warehouse is not set on product with id %d.',
                        array(), 'Admin.Advparameters.Notification'), $product->id);
                } else {
                    if (Warehouse::exists($info['warehouse'])) {
                        ...
                        $this->warnings[] = sprintf($this->trans('Warehouse did not exist, cannot set on product %1$s.',
                            array(), 'Admin.Advparameters.Notification'), $product->name[$default_language]);
                    }
                }
            }
            ...
            if (isset($info['depends_on_stock'])) {
                if ($info['depends_on_stock'] != 0 && $info['depends_on_stock'] != 1) {
                    $this->warnings[] = sprintf($this->trans('Incorrect value for "Depends on stock" for product %1$s ',
                        array(), 'Admin.Notifications.Error'), $product->name[$default_language]);
    ...
    protected function customerImportOne(
        ...
        if ($force_ids && isset($info['id']) && (int)$info['id']) {
            ...
            if (array_key_exists('id',
                    $info) && (int)$info['id'] && Customer::customerIdExistsStatic((int)$info['id'])) {
                $customer = new Customer((int)$info['id']);
            } else {
        ...
        if (array_key_exists('id',
                $info) && (int)$info['id'] && Customer::customerIdExistsStatic((int)$info['id']) && Validate::isLoadedObject($customer)) {
            ...
            foreach ($customers_shop as $id_shop => $id_group) {
                ...
                if ($id_shop == 'shared') {
                    foreach ($id_group as $key => $id) {
                        ...
                        if ($customer_exist && ((int)$current_id_shop_group == (int)$id || in_array($current_id_shop,
                                    ShopGroup::getShopsFromGroup($id)))) {
    ...
    protected function addressImportOne($info, $force_ids, $validateOnly = false)
    {
        ...
        if (isset($address->country) && is_numeric($address->country)) {
            ...
            if ($id_country = Country::getIdByName(null, $address->country)) {
                ...
                $country->id_zone = 0; // Default zone for country to create
                $country->iso_code = Tools::strtoupper(Tools::substr($address->country, 0,
                    2)); // Default iso for country to create
                $country->contains_states = 0; // Default value for country to create
                $lang_field_error = $country->validateFieldsLang(UNFRIENDLY_ERROR, true);
                if (($field_error = $country->validateFields(UNFRIENDLY_ERROR, true)) === true &&
        ...
        if (isset($address->state) && is_numeric($address->state)) {
            ...
            if ($id_state = State::getIdByName($address->state)) {
                ...
                $state->id_country = isset($country->id) ? (int)$country->id : 0;
                $state->id_zone = 0; // Default zone for state to create
                $state->iso_code = Tools::strtoupper(Tools::substr($address->state, 0,
                    2)); // Default iso for state to create
                $state->tax_behavior = 0;
                if (($field_error = $state->validateFields(UNFRIENDLY_ERROR, true)) === true &&
                    ($lang_field_error = $state->validateFieldsLang(UNFRIENDLY_ERROR, true)) === true &&
        ...
        if (isset($address->customer_email) && !empty($address->customer_email)) {
            if (Validate::isEmail($address->customer_email)) {
                ...
                $this->errors[] = sprintf($this->trans('"%s" is not a valid email address.', array(),
                    'Admin.Advparameters.Notification'), $address->customer_email);
    ...
    protected function manufacturerImportOne(
        ...
        if ($force_ids && isset($info['id']) && (int)$info['id']) {
            ...
            if (array_key_exists('id', $info) && (int)$info['id'] && Manufacturer::existsInDatabase((int)$info['id'],
                    'manufacturer')) {
                $manufacturer = new Manufacturer((int)$info['id']);
            } else {
                $manufacturer = new Manufacturer();
        ...
        if (($field_error = $manufacturer->validateFields(UNFRIENDLY_ERROR, true)) === true &&
            ...
            if (!$validateOnly && isset($manufacturer->image) && !empty($manufacturer->image)) {
                if (!AdminImportController::copyImg($manufacturer->id, null, $manufacturer->image, 'manufacturers',
                    !$regenerate)) {
                    $this->warnings[] = $manufacturer->image.' '.$this->trans('cannot be copied.', array(),
                            'Admin.Advparameters.Notification');
                }
            }
    ...
    protected function supplierImportOne($info, $shop_is_feature_active, $regenerate, $force_ids, $validateOnly = false)
    {
        ...
        if ($force_ids && isset($info['id']) && (int)$info['id']) {
            ...
            if (array_key_exists('id', $info) && (int)$info['id'] && Supplier::existsInDatabase((int)$info['id'],
                    'supplier')) {
                $supplier = new Supplier((int)$info['id']);
            } else {
                $supplier = new Supplier();
        ...
        if (($field_error = $supplier->validateFields(UNFRIENDLY_ERROR, true)) === true &&
            ...
            if (!$validateOnly && isset($supplier->image) && !empty($supplier->image)) {
                if (!AdminImportController::copyImg($supplier->id, null, $supplier->image, 'suppliers', !$regenerate)) {
                    $this->warnings[] = $supplier->image.' '.$this->trans('cannot be copied.', array(),
                            'Admin.Advparameters.Notification');
                }
            }
            ...
            $this->errors[] = $this->trans('Supplier is invalid', array(),
                    'Admin.Advparameters.Notification').' ('.$supplier->name.')';
            $this->errors[] = ($field_error !== true ? $field_error : '').(isset($lang_field_error) && $lang_field_error !== true ? $lang_field_error : '');
        }
    }
    ...
    protected function aliasImportOne($info, $force_ids, $validateOnly = false)
    {
        ...
        if ($force_ids && isset($info['id']) && (int)$info['id']) {
            ...
            if (array_key_exists('id', $info) && (int)$info['id'] && Alias::existsInDatabase((int)$info['id'],
                    'alias')) {
                $alias = new Alias((int)$info['id']);
            } else {
                $alias = new Alias();
        ...
        if (($field_error = $alias->validateFields(UNFRIENDLY_ERROR, true)) === true &&
            ...
            $this->errors[] = $this->trans('Alias is invalid', array(),
                    'Admin.Advparameters.Notification').' ('.$alias->name.')';
            $this->errors[] = ($field_error !== true ? $field_error : '').(isset($lang_field_error) && $lang_field_error !== true ? $lang_field_error : '');
        }
    }
    ...
    protected function supplyOrdersImportOne($info, $force_ids, $current_line, $validateOnly = false)
    {
        ...
        } elseif (array_key_exists('reference',
                $info) && $info['reference'] && SupplyOrder::exists(pSQL($info['reference']))) {
        ...
        if (!Supplier::supplierExists($id_supplier)) {
            $error = sprintf($this->trans('Supplier ID (%d) is not valid (at line %d).', array(),
                'Admin.Advparameters.Notification'), $id_supplier, $current_line + 1);
        }
        if (!Language::getLanguage($id_lang)) {
            $error = sprintf($this->trans('Lang ID (%d) is not valid (at line %d).', array(),
                'Admin.Advparameters.Notification'), $id_lang, $current_line + 1);
        }
        if (!Warehouse::exists($id_warehouse)) {
            $error = sprintf($this->trans('Warehouse ID (%d) is not valid (at line %d).', array(),
                'Admin.Advparameters.Notification'), $id_warehouse, $current_line + 1);
        }
        if (!Currency::getCurrency($id_currency)) {
            $error = sprintf($this->trans('Currency ID (%d) is not valid (at line %d).', array(),
                'Admin.Advparameters.Notification'), $id_currency, $current_line + 1);
        }
        if (empty($supply_order->reference) && SupplyOrder::exists($reference)) {
            $error = sprintf($this->trans('Reference (%s) already exists (at line %d).', array(),
                'Admin.Advparameters.Notification'), $reference, $current_line + 1);
        }
        ...
        if (!Validate::isDateFormat($date_delivery_expected)) {
            $error = sprintf($this->trans('Date format (%s) is not valid (at line %d). It should be: %s.', array(),
                'Admin.Advparameters.Notification'), $date_delivery_expected, $current_line + 1,
                $this->trans('YYYY-MM-DD', array(), 'Admin.Advparameters.Notification'));
        } elseif (new DateTime($date_delivery_expected) <= new DateTime('yesterday')) {
            $error = sprintf($this->trans('Date (%s) cannot be in the past (at line %d). Format: %s.', array(),
                'Admin.Advparameters.Notification'), $date_delivery_expected, $current_line + 1,
                $this->trans('YYYY-MM-DD', array(), 'Admin.Advparameters.Notification'));
        }
        if ($discount_rate < 0 || $discount_rate > 100) {
            $error = sprintf($this->trans('Discount rate (%d) is not valid (at line %d). %s.', array(),
                'Admin.Advparameters.Notification'), $discount_rate, $current_line + 1,
                $this->trans('Format: Between 0 and 100', array(), 'Admin.Advparameters.Notification'));
        }
        if ($supply_order->id > 0 && !$supply_order->isEditable()) {
            $error = sprintf($this->trans('Supply Order (%d) is not editable (at line %d).', array(),
                'Admin.Advparameters.Notification'), $supply_order->id, $current_line + 1);
        }
        ...
        if (empty($error)) {
            ...
            // errors
            if (!$res) {
                $this->errors[] = sprintf($this->trans('Supply Order could not be saved (at line %d).', array(),
                    'Admin.Advparameters.Notification'), $current_line + 1);
            }
        } else {
            $this->errors[] = $error;
        }
    ...
    protected function supplyOrdersDetailsImportOne(
        ...
        if (array_key_exists('supply_order_reference',
                $info) && pSQL($info['supply_order_reference']) && SupplyOrder::exists(pSQL($info['supply_order_reference']))) {
            $supply_order = SupplyOrder::getSupplyOrderByReference(pSQL($info['supply_order_reference']));
        } else {
            $this->errors[] = sprintf($this->trans('Supply Order (%s) could not be loaded (at line %d).', array(),
                'Admin.Advparameters.Notification'), $info['supply_order_reference'], $current_line + 1);
        }
        ...
        if (empty($this->errors)) {
            ...
            if (isset($products[$id_product][$id_product_attribute])) {
                $this->errors[] = sprintf(
                    $this->trans('Product/Attribute (%d/%d) cannot be added twice (at line %d).', array(),
                        'Admin.Advparameters.Notification'),
                    $id_product,
                    $id_product_attribute,
                    $current_line + 1
            ...
            // checks parameters
            if (false === ($supplier_reference = ProductSupplier::getProductSupplierReference($id_product,
                    $id_product_attribute, $supply_order->id_supplier))) {
                $this->errors[] = sprintf(
                    $this->trans('Product (%d/%d) is not available for this order (at line %d).', array(),
                        'Admin.Advparameters.Notification'),
                    $id_product,
                    $id_product_attribute,
                    $current_line + 1
            ...
            if ($unit_price_te < 0) {
                $this->errors[] = sprintf($this->trans('Unit Price (tax excl.) (%d) is not valid (at line %d).',
                    array(), 'Admin.Advparameters.Notification'), $unit_price_te, $current_line + 1);
            }
            if ($quantity_expected < 0) {
                $this->errors[] = sprintf($this->trans('Quantity Expected (%d) is not valid (at line %d).', array(),
                    'Admin.Advparameters.Notification'), $quantity_expected, $current_line + 1);
            }
            if ($discount_rate < 0 || $discount_rate > 100) {
                $this->errors[] = sprintf(
                    $this->trans('Discount rate (%d) is not valid (at line %d). %s.', array(),
                        'Admin.Advparameters.Notification'),
                    $discount_rate,
                    $current_line + 1,
                    $this->trans('Format: Between 0 and 100', array(), 'Admin.Advparameters.Notification')
            ...
            if ($tax_rate < 0 || $tax_rate > 100) {
                $this->errors[] = sprintf(
                    $this->trans('Quantity Expected (%d) is not valid (at line %d).', array(),
                        'Admin.Advparameters.Notification'),
                    $tax_rate,
                    $current_line + 1,
                    $this->trans('Format: Between 0 and 100', array(), 'Admin.Advparameters.Notification')
            ...
            if (empty($this->errors)) {
                ...
                AdminImportController::arrayWalk($info, array('AdminImportController', 'fillInfo'),
                    $supply_order_detail);
                ...
                $supply_order_detail->name = Product::getProductName($id_product, $id_product_attribute,
                    $supply_order->id_lang);
                ...
                $query->leftJoin('product_attribute', 'pa',
                    'pa.id_product = p.id_product AND id_product_attribute = '.(int)$id_product_attribute);
