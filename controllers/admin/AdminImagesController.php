			...
			'images' => array(
				...
				'fields' =>	array(
					...
					'PS_PRODUCT_PICTURE_WIDTH' => array(
						...
						'hint' => $this->l('The maximum width of product customization pictures that customers can upload (in pixels).'),
						'validation' => 'isUnsignedInt',
						'required' => true,
						'cast' => 'intval',
						'type' => 'text',
					...
					'PS_PRODUCT_PICTURE_HEIGHT' => array(
						...
						'hint' => $this->l('The maximum height of product customization pictures that customers can upload (in pixels).'),
						'validation' => 'isUnsignedInt',
						'required' => true,
						'cast' => 'intval',
						'type' => 'text',
