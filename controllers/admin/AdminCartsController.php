    ...
    protected function getCartSummary()
    {
        ...
        if (count($summary['products'])) {
            foreach ($summary['products'] as &$product) {
                ...
                $product['price'] = str_replace($currency->getSymbol(), '', $this->context->getCurrentLocale()->formatPrice($product['price'], $currency->iso_code));
                $product['total'] = str_replace($currency->getSymbol(), '', $this->context->getCurrentLocale()->formatPrice($product['total'], $currency->iso_code));
