                ...
                if (!Validate::isLoadedObject($customer)) {
                    ...
                    foreach ($rules['validate'] as $field => $function) {
                        if (Tools::getValue($field)) {
                            if ((PHP_MAJOR_VERSION < 7 && !Validate::$function(htmlentities(Tools::getValue($field), ENT_COMPAT, 'UTF-8'))) || !Validate::{$function}(htmlentities(Tools::getValue($field), ENT_COMPAT, 'UTF-8'))) {
