...
class AdminOrdersControllerCore extends AdminController
{
	...
	public function postProcess()
	{
		...
		{
			$this->processSubmitNewVoucher($order);
		}
		elseif (Tools::isSubmit('sendStateEmail') && Tools::getValue('sendStateEmail') > 0 && Tools::getValue('id_order') > 0)
		{
			$this->processSendStateEmail();
		}

		parent::postProcess();
	}

	protected function processSubmitShippingNumber($order)
	{
		if ($this->tabAccess['edit'] === '1')
		{
	...
	protected function processSubmitState($order)
	{
		if ($this->tabAccess['edit'] === '1')
		{
	...
	protected function processSubmitMessage($order)
	{
		if ($this->tabAccess['edit'] === '1')
		{
	...
	protected function processPartialRefund($order)
	{
		if ($this->tabAccess['edit'] == '1')
		{
	...
	protected function processSubmitEditNote()
	{
	...
	protected function processSubmitNewVoucher($order)
	{
		if ($this->tabAccess['edit'] === '1')
		{
	...
	protected function processSendStateEmail()
	{
		if ($this->tabAccess['edit'] === '1')
		{
