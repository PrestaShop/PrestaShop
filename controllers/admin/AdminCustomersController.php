...
class AdminCustomersControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        if (Shop::isFeatureActive() && (Shop::CONTEXT_ALL == Shop::getContext() || Shop::CONTEXT_GROUP == Shop::getContext())) {
    ...
    {
        if (!$this->can_add_customer && 'add' == $this->display) {
    ...
    public function initProcess()
    {
        ...
        if ('delete' == $this->action || 'bulkdelete' == $this->action) {
            if ('real' == Tools::getValue('deleteMode') || 'deleted' == Tools::getValue('deleteMode')) {
    ...
    public function renderKpis()
    {
        ...
        if (false !== ConfigurationKPI::get('CUSTOMER_MAIN_GENDER', $this->context->language->id)) {
        ...
        $helper->subtitle = $this->trans('All Time', array(), 'Admin.Global');
        if (false !== ConfigurationKPI::get('AVG_CUSTOMER_AGE', $this->context->language->id)) {
        ...
        $helper->subtitle = $this->trans('All Time', array(), 'Admin.Global');
        if (false !== ConfigurationKPI::get('ORDERS_PER_CUSTOMER')) {
        ...
        $helper->subtitle = $this->trans('All Time', array(), 'Admin.Global');
        if (false !== ConfigurationKPI::get('NEWSLETTER_REGISTRATIONS')) {
    ...
    {
        if ('real' == $this->delete_mode) {
            $this->deleted = false;
        } elseif ('deleted' == $this->delete_mode) {
            $this->deleted = true;
        } else {
