            ...
            'general' => array(
                ...
                'fields' =>    array(
                    'PS_LOGS_BY_EMAIL' => array(
                        ...
                        'hint' => Tools::safeOutput($this->trans('Enter "5" if you do not want to receive any emails.').'<br />'.$this->trans('Emails will be sent to the shop owner.', array(), 'Admin.AdvParameters.Help'), true),
                        'cast' => 'intval',
                        'type' => 'text',
                    ),
                ),
