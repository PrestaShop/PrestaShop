...
class AdminSearchControllerCore extends AdminController
{
    ...
    public function searchModule()
    {
        ...
        foreach ($all_modules as $module) {
            if (false !== stripos($module->name, $this->query) || false !== stripos($module->displayName, $this->query) || false !== stripos($module->description, $this->query)) {
    ...
    public function searchFeatures()
    {
        ...
        foreach ($_LANGADM as $key => $value) {
            if (false !== stripos($value, $this->query)) {
