	...
	public function initProcess()
	{
		...
		elseif (Tools::isSubmit('id_product'))
		{
			...
			if ($post_max_size && isset($_SERVER['CONTENT_LENGTH']) && $_SERVER['CONTENT_LENGTH'] && $_SERVER['CONTENT_LENGTH'] > $post_max_size)
				$this->errors[] = sprintf(Tools::displayError('The uploaded file exceeds the "Maximum size for attachment" set In Preferences (%1dMB) or the post_max_size/ directive in php.ini (%2dMB).'), number_format((Configuration::get('PS_LIMIT_UPLOAD_FILE_VALUE'))), ($post_max_size / 1024 / 1024));
		}
