...
class AdminModulesPositionsControllerCore extends AdminController
{
    ...
    public function postProcess()
    {
        ...
        if (Tools::getValue('show_modules') && 'all' != strval(Tools::getValue('show_modules'))) {
    ...
    public function initMain()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'can_move' => (Shop::isFeatureActive() && Shop::CONTEXT_SHOP != Shop::getContext()) ? false : true,
        ));
