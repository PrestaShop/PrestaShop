...
class AdminTaxRulesGroupControllerCore extends AdminController
{
    ...
    public function initProcess()
    {
        ...
        } elseif ('create_rule' == Tools::getValue('action')) {
            if ($this->access('add')) {
    ...
    protected function processCreateRule()
    {
        ...
        if (0 == (int) ($id_country = Tools::getValue('country'))) {
        ...
        if (empty($this->selected_states) || 0 == count($this->selected_states)) {
