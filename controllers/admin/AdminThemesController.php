...
class AdminThemesControllerCore extends AdminController
{
            ...
            'appearance' => array(
                ...
                'buttons' => array(
                    'storeLink' => array(
                        ...
                        'href' => '//addons.prestashop.com/en/3-templates-prestashop'
    ...
    public function ajaxProcessGetAddonsThemes()
    {
        ...
        $addons_url = '//addons.prestashop.com/iframe/search-1.6.php?psVersion='._PS_VERSION_.'&onlyThemes=1&isoLang='.$iso_lang.'&isoCurrency='.$iso_currency.'&isoCountry='.$iso_country.'&activity='.(int)$activity.'&parentUrl='.$parent_domain;
