...
class AdminAddressesControllerCore extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        foreach ($addresses_fields as $addr_field_item) {
            ...
            } elseif ('lastname' == $addr_field_item) {
                if (isset($customer) &&
            ...
            } elseif ('firstname' == $addr_field_item) {
                if (isset($customer) &&
                    !Tools::isSubmit('submit' . mb_strtoupper($this->table)) &&
                    Validate::isLoadedObject($customer) &&
                    !Validate::isLoadedObject($this->object)) {
            ...
            } elseif ('address1' == $addr_field_item) {
                $temp_fields[] = array(
                    'type' => 'text',
            ...
            } elseif ('address2' == $addr_field_item) {
                $temp_fields[] = array(
                    'type' => 'text',
            ...
            } elseif ('postcode' == $addr_field_item) {
                $temp_fields[] = array(
                    'type' => 'text',
            ...
            } elseif ('country' == $addr_field_item || 'Country:name' == $addr_field_item) {
                $temp_fields[] = array(
                    'type' => 'select',
            ...
            } elseif ('phone_mobile' == $addr_field_item) {
                $temp_fields[] = array(
                    'type' => 'text',
    ...
    public function processSave()
    {
        ...
        $address_type = 2 == (int) Tools::getValue('address_type') ? 'invoice' : 'delivery';

        if ('save' == $this->action && ($id_order = (int) Tools::getValue('id_order')) && !count($this->errors) && !empty($address_type)) {
