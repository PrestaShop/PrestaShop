...
class AdminDashboardControllerCore extends AdminController
{
	...
	public function renderView()
	{
		...
		$this->tpl_view_vars = array(
			...
			'new_version_url' => Tools::getCurrentUrlProtocolPrefix().'api.prestashop.com/version/check_version.php?v='._PS_VERSION_.'&lang='.$this->context->language->iso_code.'&autoupgrade='.(bool)(Module::isInstalled('autoupgrade') && Module::isEnabled('autoupgrade')),
