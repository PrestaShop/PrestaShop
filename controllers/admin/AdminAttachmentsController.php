...
class AdminAttachmentsControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->_select = 'IFNULL(virtualp.products, 0) as products';
        $this->_join = 'LEFT JOIN (SELECT id_attachment, COUNT(*) as products FROM '._DB_PREFIX_.'product_attachment GROUP BY id_attachment) virtualp ON a.id_attachment = virtualp.id_attachment';
