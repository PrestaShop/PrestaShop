...
class OrderControllerCore extends FrontController
{
    ...
    protected function bootstrap(): void
    {
        ...
        $resolvedCheckoutProcess = (new CheckoutProcessProviderResolver())->resolve($session, $translator);
        $this->checkoutProcess = $resolvedCheckoutProcess instanceof CheckoutProcess
            ? $resolvedCheckoutProcess
            : $this->buildCheckoutProcess($session, $translator);
