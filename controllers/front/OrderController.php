...
class OrderControllerCore extends ParentOrderController
{
    ...
    public function init()
    {
        ...
        if ($packProduct !== true) {
            $this->step = 0;
            $this->errors[] = sprintf(Tools::displayError('An item (%1s) in your cart is no longer available in this quantity. You cannot proceed with your order until the quantity is adjusted.'), $packProduct['name']);
        }
