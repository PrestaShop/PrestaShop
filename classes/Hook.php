...
class HookCore extends ObjectModel
{
    ...
    {
        if ('displayheader' == mb_strtolower($hookName)) {
    ...
    public static function getHookModuleExecList($hook_name = null)
    {
        ...
        if (!Cache::isStored($cache_id) || 'displayPayment' == $hook_name || 'displayPaymentEU' == $hook_name || 'paymentOptions' == $hook_name || 'displayBackOfficeHeader' == $hook_name) {
            $frontend = true;
            $groups = array();
            ...
            $sql->from('module', 'm');
            if ('displayBackOfficeHeader' != $hook_name) {
            ...
            if ('displayPayment' != $hook_name && 'displayPaymentEU' != $hook_name && 'paymentOptions' != $hook_name && 'displayBackOfficeHeader' != $hook_name) {
                Cache::store($cache_id, $list);
    ...
    public static function exec(
        ...
        if (null === $disable_non_native_modules) {
        ...
        if (null !== $id_shop && Validate::isUnsignedId($id_shop) && $id_shop != $context->shop->getContextShopID()) {
