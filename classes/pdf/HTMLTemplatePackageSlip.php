...
class HTMLTemplatePackageSlipCore extends HTMLTemplate
{
	...
	public function __construct(OrderInvoice $order_invoice, $smarty)
	{
		...
		$this->title = HTMLTemplateDeliverySlip::l('Package Slip'); //.' #'. sprintf('%06d',$this->order->invoice_number); //Configuration::get('PS_DELIVERY_PREFIX', Context::getContext()->language->id).sprintf('%06d', $this->order_invoice->delivery_number);
	...
	{
		return "PACKSLIP"; // .sprintf('%06d', $this->order->invoice_number).'.pdf';
