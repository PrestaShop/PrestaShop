...
';
    ...
    /**
     * HELPER: Add SQL string to sort products: 1. inStock, 2. OutOfStock & OOSP, 3. outOfStock
     *
     * @return string sql
     */
    public static function sqlOrderByOOSP($orderyBy)
    {
        $orderByFacets = array('orderprice', 'price', 'p.price', 'date_add', 'date_upd', 'quantity'); // All "facets" where we allow to sort products
        $sql = '';
