...
';
    ...
    public static function isDetectCountryFromBrowserLanguageAvailable(): bool
    {
        ...
        return Configuration::get('PS_DETECT_COUNTRY') && isset($_SERVER['HTTP_ACCEPT_LANGUAGE'])
            && self::isValidAcceptLanguageAvailable()
            && Validate::isLanguageIsoCode($languagesAvailable[0]);
    }

    /**
     * @return bool
     */
    public static function isValidAcceptLanguageAvailable(): bool
    {
        return preg_match(self::LANGUAGE_EXTRACTOR_REGEXP, $_SERVER['HTTP_ACCEPT_LANGUAGE'], $languages);
    }

    /**
     * @return array
     */
    public static function languagesAvailable(): array
    {
        preg_match(self::LANGUAGE_EXTRACTOR_REGEXP, $_SERVER['HTTP_ACCEPT_LANGUAGE'], $languages);
