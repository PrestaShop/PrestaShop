...
class CartCore extends ObjectModel
{
    ...
    {
        $summary = $this->getUnalteredSummaryDetails($id_lang, $refresh);

        return $this->alterSummaryForDisplay($summary, $refresh);
    }

    /**
     * Returns useful raw informations about the cart.
     *
     * @return array Cart details
     */
    public function getUnalteredSummaryDetails($id_lang = null, $refresh = false): array
    {
        $context = Context::getContext();
        if (!$id_lang) {
     ...
     * @return array
     */
    private function alterSummaryForDisplay(array $summary, $refresh = false): array
    {
        $context = Context::getContext();
