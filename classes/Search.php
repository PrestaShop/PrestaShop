...
class SearchCore
{
    ...
    public static function find(
        ...
        $product_pool = ((false === mb_strpos($product_pool, ',')) ? (' = '.(int) $product_pool.' ') : (' IN ('.rtrim($product_pool, ',').') '));
    ...
    public static function indexation($full = false, $id_product = false)
    {
        ...
        if ($full && Shop::CONTEXT_SHOP == Context::getContext()->shop->getContext()) {
