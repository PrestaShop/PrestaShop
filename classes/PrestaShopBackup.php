...
class PrestaShopBackupCore
{
    ...
    public function __construct($filename = null)
    {
        ...
        $this->psBackupAll = false !== $psBackupAll ? $psBackupAll : true;
        $this->psBackupDropTable = false !== $psBackupDropTable ? $psBackupDropTable : true;
    }
    ...
    public function add()
    {
        ...
        foreach ($tables as $table) {
            ...
            if (mb_strlen($table) < mb_strlen(_DB_PREFIX_) || 0 != strncmp($table, _DB_PREFIX_, mb_strlen(_DB_PREFIX_))) {
                continue;
            }
