    ...
    protected function init()
    {
        $this->fieldNames = array(
            'value' => array(
                ...
                md5('We are currently updating our shop and will be back really soon.Thanks for your patience.')
                    => $this->translator->trans('We are currently updating our shop and will be back really soon.Thanks for your patience.', array(), 'Admin.OrdersCustomers.Feature', $this->locale),
            ),
        );
    }
}
