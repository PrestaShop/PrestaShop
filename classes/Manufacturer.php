...
class ManufacturerCore extends ObjectModel
{
    ...
    public static function getProducts(
        ...
        if (empty($orderBy) || 'position' == $orderBy) {
            $orderBy = 'name';
        }
        ...
        if ('price' == $orderBy) {
            ...
            $alias = 'pl.';
        } elseif ('manufacturer_name' == $orderBy) {
            $orderBy = 'name';
            $alias = 'm.';
        } elseif ('quantity' == $orderBy) {
            $alias = 'stock.';
        } else {
            $alias = 'p.';
        }
    ...
    public function setWsAddresses($idAddresses)
    {
        ...
        $result1 = (false !== Db::getInstance()->execute('
        ...
        $result2 = true;
        if (count($ids)) {
            $result2 = (false !== Db::getInstance()->execute('
				UPDATE `'._DB_PREFIX_.'address`
