...
class StoreCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
			...
			'siret' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'size' => 18],
            'vat_number' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName','size' => 24],
            'iban' => ['type' => self::TYPE_STRING, 'validate' => 'isGenericName','size' => 24],
