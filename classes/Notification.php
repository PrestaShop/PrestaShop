    ...
    public static function getLastElementsIdsByType($type, $idLastElement)
    {
        ...
        foreach ($result as $value) {
            ...
            $json['results'][] = array(
                ...
                'total_paid' => ((!empty($value['total_paid'])) ? Context::getContext()->getCurrentLocale()->formatPrice((float) $value['total_paid'], Currency::getCurrencyInstance((int) $value['id_currency'])->iso_code) : 0),
