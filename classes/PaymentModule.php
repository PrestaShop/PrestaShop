...
abstract class PaymentModuleCore extends Module
{
    ...
    public function validateOrder(
        ...
        try {
            ...
            if (!$creationErrorState) {
                // Shops whose database does not contain the dedicated status yet
                // fall back to the generic payment error status.
                $creationErrorState = (int) Configuration::get('PS_OS_ERROR');
            }
