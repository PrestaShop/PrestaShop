...
abstract class PaymentModuleCore extends Module
{
    ...
    public function validateOrder(
        ...
        $computing_precision = Context::getContext()->getComputingPrecision();
        if ($order_status->logable && (number_format($cart_total_paid, $computing_precision) !== number_format($amount_paid, $computing_precision))) {
