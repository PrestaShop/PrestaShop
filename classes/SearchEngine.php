...
class SearchEngineCore extends ObjectModel
{
    ...
    public static function getKeywords($url)
    {
        ...
        $result = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('SELECT ' . Db::quoteIdentifier('server') . ', ' . Db::quoteIdentifier('getvar') . ' FROM ' . Db::quoteIdentifier(_DB_PREFIX_ . 'search_engine'));
