...
class GroupCore extends ObjectModel
{
    ...
    public function delete()
    {
        ...
        if (parent::delete()) {
            ...
            Db::getInstance()->execute('
                ...
                SELECT c.id_customer, '.(int)Configuration::get('PS_CUSTOMER_GROUP').'
    ...
    {
        if (!is_array($modules) || empty($modules) || !is_array($shops) || empty($shops)) {
            return false;
        }
    ...
    public static function getCurrent()
    {
        ...
        $is_group_associated = $groups[$id_group]->isAssociatedToShop(Context::getContext()->shop->id);

        if (!$is_group_associated) {
