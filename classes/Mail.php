...
class MailCore extends ObjectModel
{
		...
		$template_path = _PS_MAIL_DIR_, $die = false, $id_shop = null, $bcc = null, $reply_to = null)
	{
		...
		try {
			...
			$template_vars['{shop_url}'] = Context::getContext()->link->getPageLink('index', true, (int)$id_lang, null, false, $id_shop);
			$template_vars['{my_account_url}'] = Context::getContext()->link->getPageLink('my-account', true, (int)$id_lang, null, false, $id_shop);
			$template_vars['{guest_tracking_url}'] = Context::getContext()->link->getPageLink('guest-tracking', true, (int)$id_lang, null, false, $id_shop);
			$template_vars['{history_url}'] = Context::getContext()->link->getPageLink('history', true, (int)$id_lang, null, false, $id_shop);
