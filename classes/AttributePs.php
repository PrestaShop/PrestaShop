...
/**
 * Class AttributePsCore.
 *
 * Previously named AttributeCore, but in PHP 8.0, "Attribute" class is used internally by PHP.
 */
class AttributePsCore extends ObjectModel
{
    ...
    {
        if ($this->position <= 0) {
            $this->position = AttributePs::getHigherPosition($this->id_attribute_group) + 1;
        }
