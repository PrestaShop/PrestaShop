...
class WebserviceOutputXMLCore implements WebserviceOutputInterface
{
    ...
    public function renderField($field)
    {
        ...
        if (isset($field['i18n']) && $field['i18n']) {
            foreach ($this->languages as $language) {
                ...
                if (isset($field['synopsis_details']) || (isset($field['value']) && is_array($field['value']))) {
                    ...
                    if (isset($field['synopsis_details']) && 'blank' != $this->schemaToDisplay) {
            ...
            if (array_key_exists('xlink_resource', $field) && 'blank' != $this->schemaToDisplay) {
            ...
            if (isset($field['getter']) && 'blank' != $this->schemaToDisplay) {
                $ret .= ' notFilterable="true"';
            }

            if (isset($field['setter']) && false == $field['setter'] && 'synopsis' == $this->schemaToDisplay) {
                $ret .= ' read_only="true"';
            }
        ...
        if (isset($field['synopsis_details']) && !empty($field['synopsis_details']) && 'blank' !== $this->schemaToDisplay) {
