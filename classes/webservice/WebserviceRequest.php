...
class WebserviceRequestCore
{
    ...
    */
    ...
    public function fetch($key, $method, $url, $params, $bad_class_name, $inputXml = null)
    {
        ...
        $display_errors = 'off' != strtolower(ini_get('display_errors'));
    ...
    protected function parseDisplayFields($str)
    {
        ...
        $fields = array();
        foreach ($part as $str) {
            $field_name = trim(substr($str, 0, (false === strpos($str, '[') ? strlen($str) : strpos($str, '['))));
    ...
    protected function manageFilters()
    {
        ...
        if (isset($this->urlFragments['sort'])) {
            ...
            foreach ($sorts as $sort) {
                ...
                if (false === $delimiterPosition || !in_array($direction, array('ASC', 'DESC'))) {
