...
abstract class ObjectModelCore
{
	...
	{
		return Adapter_ServiceLocator::get('Adapter_EntityPersister')->add($this, $auto_date, $null_values);
	}
	...
	{
		return Adapter_ServiceLocator::get('Adapter_EntityPersister')->update($this, $null_values);
	}
