...
class ImageCore extends ObjectModel
{
    ...
    public function deleteImage($forceDelete = false)
    {
        ...
        $isMultipleImageFormatFeatureEnabled = $sfContainer->get(FeatureFlagStateCheckerInterface::class)->isEnabled(FeatureFlagSettings::FEATURE_FLAG_MULTIPLE_IMAGE_FORMAT);
