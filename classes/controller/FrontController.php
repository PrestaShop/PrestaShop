...
class FrontControllerCore extends Controller
{
    ...
    public function getTemplateVarShop()
    {
        ...
        $shop = [
            ...
            'registration_number_APE' => Configuration::get('PS_SHOP_APE'),
			...
			'siret' => Configuration::get('PS_SHOP_SIRET'),
            'vat_number' => Configuration::get('PS_SHOP_VAT_NUMBER'),
            'iban' => Configuration::get('PS_SHOP_IBAN'),
            'APE' => Configuration::get('PS_SHOP_APE'),
        ];
