...
exec("grep -ri 'hook h=' ".$path_to_16."/themes/default-bootstrap", $hookHIn16);
exec("grep -ri 'hook h=' ".$path_to_17."/themes/StarterTheme", $hookHIn17);

exec("grep -ri 'Hook::exec' ".$path_to_16."/controllers/front", $hookExecIn16);
exec("grep -ri 'Hook::exec' ".$path_to_17."/controllers/front", $hookExecIn17);
