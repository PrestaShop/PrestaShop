...
$current_path = _PS_IMG_DIR_ . 'cms/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = _PS_IMG_DIR_ . 'tmp/cms/'; // relative path from filemanager folder to thumbs folder (with final /)
