...
$current_path = '../../..'.__PS_BASE_URI__.'/img/cms/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../..'.__PS_BASE_URI__.'/img/tmp/cms/'; // relative path from filemanager folder to thumbs folder (with final /)
