	...
	<div class="panel">
		...
		<div class="row">
			...
			<div class="col-lg-8 col-lg-offset-1">
				...
				<div class="alert alert-info"><strong>{l s='Step 1: On the left side, select the attributes you want to use (Hold down the "Ctrl" key on your keyboard and validate by clicking on "%add_label%")' sprintf=['%add_label%' => {l s='Add' d='Admin.Actions'}]}</strong></div>
				...
				<div class="alert alert-info">{l s='Please click on "%generate_label%".' sprintf=['%generate_label%' => {l s='Generate these combinations'}]}</div>
