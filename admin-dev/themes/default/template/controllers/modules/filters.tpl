...
<form method="post" class="form-inline pull-right">
	...
	<div class="form-group">
		<select name="module_install" id="module_install_filter" class="form-control" {if $showInstalledModules ne 'installedUninstalled' && $showInstalledModules ne ''}{/if}>
	...
	<div class="form-group">
		<select name="module_status" id="module_status_filter" class="form-control" {if $showEnabledModules ne 'enabledDisabled' && $showEnabledModules ne ''}{/if}>
