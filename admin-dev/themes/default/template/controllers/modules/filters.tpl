...
<div class="row">
	<div class="col-lg-8">
		<div class="form-group">
			...
			<select name="module_install" id="module_install_filter" class="form-control {if $showInstalledModules != installedUninstalled}active{/if}" {if $showInstalledModules ne 'installedUninstalled' && $showInstalledModules ne ''}{/if}>
		...
		<div class="form-group">
			<select name="module_status" id="module_status_filter" class="form-control {if $showEnabledModules != enabledDisabled}active{/if}" {if $showEnabledModules ne 'enabledDisabled' && $showEnabledModules ne ''}{/if}>
	...
	<div class="col-lg-4">
		<div class="form-group">
			...
			<select class="filter {if $showTypeModules != allModules}active{/if}" name="module_type" id="module_type_filter">
