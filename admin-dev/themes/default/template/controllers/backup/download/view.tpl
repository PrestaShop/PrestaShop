...
{block name="override_tpl"}
	...
	<div class="row">
		<div class="alert alert-warning">
			...
			<p>{l s='Disclaimer before creating a new backup' d='Admin.Advparameters.Notification'}</p>
			<ol>
				<li>{l s='PrestaShop is not responsible for your database, its backups and/or recovery.' d='Admin.Advparameters.Help'}</li>
	...
	<div class="row">
		<div class="alert alert-info">
			<p>{l s='How to restore a database backup in 10 easy steps:' d='Admin.Advparameters.Help'}</p>
			<ol>
