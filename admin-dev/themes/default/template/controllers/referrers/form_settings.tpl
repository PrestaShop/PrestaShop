...
<div class="row">
	<div class="col-lg-6">
			<form action="{$current}&amp;token={$token|escape:'html':'UTF-8'}" method="post" id="refresh_index_form" name="refresh_index_form" class="form-horizontal">
				<div class="panel">
					<h3>
		...
		<div class="col-lg-6">
			<form action="{$current}&amp;token={$token|escape:'html':'UTF-8'}" method="post" id="refresh_cache_form" name="refresh_cache_form" class="form-horizontal">
				<div class="panel">
					<h3>
...
<div id="settings_referrers" class="row">
	<div class="col-lg-3">
		<form action="{$current}&amp;token={$token|escape:'html':'UTF-8'}" method="post" id="settings_form" name="settings_form" class="form-horizontal">
			<div class="panel">
				<h3>
