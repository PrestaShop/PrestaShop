...
{block name="defaultForm"}
	<div class="row">
		...
		<script type="text/javascript">
			...
			var reload_tab_description = '{l s='A server error occurred while loading the tabs: not all the tabs could be loaded.' slashes=1}'+'\n'+'{l s='Please try again by refreshing the page.' slashes=1}'+'\n'+'{l s='If you are still encountering this problem, please check your server or contact your hosting provider for assistance.' slashes=1}';
