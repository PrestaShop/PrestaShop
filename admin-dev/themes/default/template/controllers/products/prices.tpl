...
<div id="product-prices" class="panel product-tab">
	...
	<div class="form-group">
		...
		<div class="input-group col-lg-4">
			<span class="input-group-addon">{$currency->prefix}{$currency->suffix}</span>
			<input maxlength="14" id="unit_price" name="unit_price" type="text" value="{$unit_price|string_format:$priceDisplayPrecisionFormat}" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.'); unitPriceWithTax('unit');"/>
