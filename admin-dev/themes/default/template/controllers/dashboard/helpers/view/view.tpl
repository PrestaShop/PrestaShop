	...
	<div class="row">
		...
		<div class="col-md-8 col-lg-7" id="hookDashboardZoneTwo">
			...
			<div id="dashaddons" class="row-margin-bottom">
				<a href="https://addons.prestashop.com/en/209-dashboards?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-{$lang_iso|upper}&amp;utm_content={if $host_mode}cloud{else}download{/if}" target="_blank">
		...
		<div class="col-md-12 col-lg-2">
			...
			<section class="dash_links panel">
				<h3><i class="icon-link"></i> {l s="We stay by your side!" d='Admin.Dashboard.Feature'}</h3>
					<dl>
						<dt><a href="{$help_center_link}" target="_blank">{l s="Help Center" d='Admin.Global'}</a></dt>
					...
					<dl>
						<dt><a href="https://addons.prestashop.com?utm_source=back-office&amp;utm_medium=links&amp;utm_campaign=addons-{$lang_iso}&amp;utm_content=download17" target="_blank">{l s="PrestaShop Marketplace" d='Admin.Dashboard.Feature'}</a></dt>
