		...
		<div class="modal-dialog">
			<div class="alert alert-danger clearfix">
				{foreach $php_errors item=php_error}
					{l s='%1$s on line %2$s in file %3$s: [%4$s] %5$s' sprintf=[$php_error.type|escape, $php_error.errline|escape, $php_error.errfile|escape, $php_error.errno|escape, $php_error.errstr|escape]}<br /><br />
				{/foreach}
