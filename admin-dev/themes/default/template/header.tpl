          ...
          <ul id="employee_links" class="dropdown-menu dropdown-menu-right">
            ...
            {foreach from=$displayBackOfficeEmployeeMenu item=$menuItem}
              ...
              <li class="{$menuItem->getClass()}">
                <a class="dropdown-item" href="{$menuItemProperties.link}" {if !isset($menuItemProperties.samePage) || true !== $menuItemProperties.samePage} target="_blank"{/if} rel="noopener noreferrer nofollow">
