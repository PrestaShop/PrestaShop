				...
				<li id="employee_infos" class="dropdown">
					<a href="{$link->getAdminLink('AdminEmployees')|escape:'html':'UTF-8'}&id_employee={$employee->id}&amp;updateemployee" class="employee_name dropdown-toggle" data-toggle="dropdown">
						<span class="employee_avatar_small">
							<img class="imgm img-thumbnail" alt="" src="//profile.prestashop.com/{$employee->email|urlencode}.jpg" width="32" height="32" />
						</span>
						{l s="Me"}
						<i class="caret"></i>
					</a>
					<ul id="employee_links" class="dropdown-menu">
						<li>
							<span class="employee_avatar">
								<img class="imgm img-thumbnail" alt="" src="//profile.prestashop.com/{$employee->email|urlencode}.jpg" width="96" height="96" />
							</span>
						</li>
