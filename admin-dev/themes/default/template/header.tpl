...
' d='Admin.Navigation.Header'}" target="_blank"><i class="material-icons">book</i> {l s='Resources' d='Admin.Navigation.Header'}</a></li>
            ...
            {if $host_mode}
              <li><a href="https://www.prestashop.com/cloud/" target="_blank"><i class="material-icons">settings_applications</i> {l s='My PrestaShop account' d='Admin.Navigation.Header'}</a></li>
            {/if}
            <li class="divider"></li>
