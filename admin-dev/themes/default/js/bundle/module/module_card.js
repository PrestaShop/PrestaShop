...
var AdminModuleCard = function () {
    ...
    this.confirmPrestaTrust = function(result) {
        ...
        modal.find(".pstrust-install").attr("action", module.urls.install);
        modal.find(".module_action_menu_install").attr("data-confirm_modal", "module-modal-confirm-"+ module.name +"-install");
        modal.modal();
    };
