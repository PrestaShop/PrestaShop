...
var AdminModuleCard = function() {
    ...
    this.replacePrestaTrustPlaceholders = function replacePrestaTrustPlaceholders(
        result,
    ) {
    ...
    this.initActionButtons = function() {
        ...
        $(document).on('click', this.forceDeletionOption, function() {
            var btn = $(
                _this.moduleActionModalUninstallLinkSelector,
                $(
        ...
        $(document).on(
            ...
            function() {
                ...
                return (
                    _this.dispatchPreEvent('install', this) &&
                    _this.confirmAction('install', this) &&
                    _this.requestToController('install', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('enable', this) &&
                    _this.confirmAction('enable', this) &&
                    _this.requestToController('enable', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('uninstall', this) &&
                    _this.confirmAction('uninstall', this) &&
                    _this.requestToController('uninstall', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('disable', this) &&
                    _this.confirmAction('disable', this) &&
                    _this.requestToController('disable', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('enable_mobile', this) &&
                    _this.confirmAction('enable_mobile', this) &&
                    _this.requestToController('enable_mobile', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('disable_mobile', this) &&
                    _this.confirmAction('disable_mobile', this) &&
                    _this.requestToController('disable_mobile', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('reset', this) &&
                    _this.confirmAction('reset', this) &&
                    _this.requestToController('reset', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    _this.dispatchPreEvent('update', this) &&
                    _this.confirmAction('update', this) &&
                    _this.requestToController('update', $(this))
                );
            },
        );
        ...
        $(document).on(
            ...
            function() {
                return _this.requestToController(
                    'disable',
                    $(
                        _this.moduleActionMenuDisableLinkSelector,
                        $(
                            "div.module-item-list[data-tech-name='" +
                                $(this).attr('data-tech-name') +
                                "']",
        ...
        $(document).on(
            ...
            function() {
                return _this.requestToController(
                    'reset',
                    $(
                        _this.moduleActionMenuResetLinkSelector,
                        $(
                            "div.module-item-list[data-tech-name='" +
                                $(this).attr('data-tech-name') +
                                "']",
