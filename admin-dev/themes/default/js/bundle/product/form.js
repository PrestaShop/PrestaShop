...
var priceCalculation = (function() {
  ...
  return {
    ...
    'impactTaxInclude': function(obj) {
      ...
      var targetInput = obj.parent().parent().parent().parent().find('input.attribute_priceTI');
      if (isNaN(price)) {
        targetInput.val(0);
        return;
      }
    ...
    'impactTaxExclude': function(obj) {
      var price = parseFloat(obj.val().replace(/,/g, '.'));
      var targetInput = obj.parent().parent().parent().parent().find('input.attribute_priceTE');
      if (isNaN(price)) {
        targetInput.val(0);
        return;
      }
