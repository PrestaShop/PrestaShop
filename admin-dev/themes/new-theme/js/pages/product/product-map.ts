...
export default {
  ...
  featureValues: {
    ...
    collectionRow: 'tr.product-feature',
    featureNameInput: '.feature-name input',
    featureNamePreview: '.feature-name .text-preview-value',
    featureIdInput: 'input.feature-id',
    featureValueIdInput: 'input.feature-value-id',
    featureValueNameInput: '.feature-value-name input',
    featureValueNamePreview: '.feature-value-name .text-preview-value',
