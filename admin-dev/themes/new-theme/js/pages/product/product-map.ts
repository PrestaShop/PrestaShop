...
export default {
  ...
  combinations: {
    ...
    tableRow: {
      ...
      deltaQuantityInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_delta_quantity_delta`,
      combinationCheckbox: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_is_selected`,
      combinationIdInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_combination_id`,
      combinationNameInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_name`,
      referenceInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_reference_value`,
      impactOnPriceInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_impact_on_price_value`,
      finalPriceTeInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_final_price_te`,
      quantityInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_delta_quantity_quantity`,
      isDefaultInput: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_is_default`,
      editButton: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_edit`,
      deleteButton: (rowIndex: string): string => `${combinationListId}_combinations_${rowIndex}_delete`,
    },
