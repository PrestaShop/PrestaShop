...
export default {
  ...
  productLocalizedLinkRewriteInput: 'input[name^="product[seo][meta_information][link_rewrite]"]',
  ...
  shipping: {
    deliveryTimeTypeInput: 'input[name="product[shipping][delivery_time][type]"]',
    deliveryTimeNoteInStock: '#product_shipping_delivery_time_in_stock',
    deliveryTimeNoteOutOfStock: '#product_shipping_delivery_time_out_of_stock',
  ...
  seo: {
    container: '#product_seo_meta_information_serp',
  ...
  conditionSwitch: 'input[name="product[details][condition][show_condition]"]',
  conditionChoiceSelect: '#product_details_condition_condition',
  relatedProducts: {
  ...
  catalogPriceRule: {
    ...
    showCatalogPriceRules: '#product_pricing_specific_prices_show_catalog_price_rules',
    blockContainer: '#product_pricing_specific_prices_catalog_price_rules',
    listFields: {
