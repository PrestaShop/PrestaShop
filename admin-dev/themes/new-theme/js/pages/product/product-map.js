...
export default {
  ...
  combinations: {
    ...
    tableRow: {
      combinationIdCell: (rowIndex) => `#combinations_combinations_list_${rowIndex}_combination_id`,
      combinationNameCell: (rowIndex) => `#combinations_combinations_list_${rowIndex}_name`,
      impactOnPriceCell: (rowIndex) => `#combinations_combinations_list_${rowIndex}_impact_on_price`,
      finalPriceTeCell: (rowIndex) => `#combinations_combinations_list_${rowIndex}_final_price_te`,
      quantityCell: (rowIndex) => `#combinations_combinations_list_${rowIndex}_quantity`,
