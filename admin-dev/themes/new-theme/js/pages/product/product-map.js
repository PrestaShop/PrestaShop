...
export default {
  ...
  categories: {
    ...
    treeCheckboxName: (categoryId) => `category_tree_selector[category_tree][${categoryId}]`,
    defaultCategoryCheckbox: '.is-default-category-checkbox',
    defaultCategorySelectContainer: '#default-category-selector-widget',
    defaultCategorySelectInput: '#default-category-id',
