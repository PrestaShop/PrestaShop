...
export default {
  ...
  fulfillShipmentModal: '#fulfillShipmentModal',
  showFulfillShipmentModalBtn: '[data-show-modal="fulfill-shipment"]',
  fulfillShipmentModalContainer: '#fulfillShipmentFormContainer',
  ...
  productEditUnitPrice: '.cellProductUnitPrice .js-product-unit-price',
  productEditUnitPriceOtherTaxMethod: '.cellProductUnitPrice .js-product-unit-price-other-tax-method',
