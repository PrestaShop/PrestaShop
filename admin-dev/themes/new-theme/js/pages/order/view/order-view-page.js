...
import OrderProductsRefresher from '@pages/order/view/order-products-refresher';
...
export default class OrderViewPage {
  constructor() {
    ...
    this.orderProductsRefresher = new OrderProductsRefresher();
  ...
  listenToEvents() {
    ...
    EventEmitter.on(OrderViewEventMap.productDeletedFromOrder, (event) => {
      ...
      this.orderProductsRefresher.refresh(event.orderId);
