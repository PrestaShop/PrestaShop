...
export default class OrderViewPage {
  ...
  listenForProductDelete() {
    ...
    EventEmitter.on(OrderViewEventMap.productDeletedFromOrder, (orderProductData) => {
      this.orderProductRenderer.removeProductFromList(orderProductData.oldOrderDetailId);
    });
  }
}
