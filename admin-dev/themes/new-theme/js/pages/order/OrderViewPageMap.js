...
export default {
  ...
  productAddPriceTaxInclInput: '#addProductPriceTaxIncl',
  productAddQuantityInput: '#addProductQuantity',
  ...
  productEditActionBtn: '.editProductActionBtn',
  productCancelEditBtn: '.cancelEditProductBtn',
  productEditRow: '#editProductTableRow',
  productEditTaxRateInput: '.editProductTaxRate',
  productEditOrderDetailInput: '.editOrderDetailId',
