...
export default {
  ...
  togglePartialRefundForm: '.partial-refund:not(.hidden), .cancel-product-element:not(.hidden):not(.shipping-refund), .cancel-product-amount, .shipping-price, .refund-checkboxes-container',
