    ...
    <tr>
        ...
        <td class="text-sm-center">
            <span class="qty-number" :class="{ 'is-positive': isPositive }">
                <span v-if="isPositive">+</span> <span v-else>-</span> {{ qty }}
            </span>
        </td>
        <td class="text-sm-center"> {{ product.date_add }} </td>
        <td> {{ employeeName }} </td>
    </tr>
</template>
...
export default {
    ...
    computed: {
        ...
        employeeName() {
            return `${this.product.employee_firstname} ${
                this.product.employee_lastname
            }`;
        },
        isPositive() {
        ...
        orderLink() {
            return this.product.order_link !== 'N/A'
                ? this.product.order_link
                : null;
        },
    },
    components: {
