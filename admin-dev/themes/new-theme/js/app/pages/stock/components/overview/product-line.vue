...
<template>
  <tr :class="{'low-stock':lowStock}">
    ...
    <td data-role="product_supplier_name">
      {{ product.supplier_name }}
    </td>
    <td
      v-if="product.active"
      class="text-sm-center"
      data-role="product_active"
    >
    ...
    <td class="qty-spinner text-right" data-role="update_quantity">
      <Spinner
        :product="product"
