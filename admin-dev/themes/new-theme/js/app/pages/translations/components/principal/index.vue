    ...
    computed: {
        ...
        currentDomainTotalTranslations() {
            return this.$store.state.currentDomainTotalTranslations <= 1
                ? `- ${this.trans('label_total_domain_singular').replace(
                      '%nb_translation%',
                      this.$store.state.currentDomainTotalTranslations,
                  )}`
        ...
        currentDomainTotalMissingTranslationsString() {
            ...
            if (
                ...
                totalMissingTranslationsString = this.trans(
                    'label_missing_singular',
                );
        ...
        noResult() {
            return (
                ...
                typeof this.$store.getters.currentDomain === 'undefined'
            );
        },
        noResultInfo() {
    ...
    methods: {
        ...
        isEdited(input) {
            if (input.translation.edited) {
                this.$store.state.modifiedTranslations[input.id] =
                    input.translation;
            } else {
