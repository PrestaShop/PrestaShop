...
<template>
    <div class="ps-tree-items" :class="{ className }">
        ...
        >
            ...
            >
                <span v-if="translations" class="sr-only">{{
                    this.model.open ? translations.reduce : translations.expand
                }}</span>
            </button>
            <PSCheckbox
                :ref="model.name"
                ...
                v-if="hasCheckbox"
            />
            <span class="tree-label" :class="{ warning: isWarning }">{{
                model.name
            }}</span>
            <span
    ...
    computed: {
        ...
        getExtraLabel() {
            ...
            if (this.model.extraLabel && this.model.extraLabel === 1) {
                ...
                extraLabel = this.translations.extra.replace(
                    '%d',
