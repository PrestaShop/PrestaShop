        ...
        <ul class="pagination" :class="{ multi: isMultiPagination }">
            ...
            >
                <a
                    ...
                    href="#"
                >
                    <span v-if="isMultiPagination" v-show="showFirstDots(index)"
                        >...</span
                    >
                    {{ index }}
                    <span v-if="isMultiPagination" v-show="showLastDots(index)"
                        >...</span
                    >
                </a>
            </li>
    ...
    methods: {
        ...
        showIndex(index) {
            const startPaginationIndex =
                index < this.currentIndex + this.multiPagesToDisplay;
            const lastPaginationIndex =
                index > this.currentIndex - this.multiPagesToDisplay;
        ...
        showFirstDots(index) {
            ...
            return (
                index === this.pagesCount && this.currentIndex <= pagesToDisplay
            );
        },
        showLastDots(index) {
            if (!this.isMultiPagination) {
