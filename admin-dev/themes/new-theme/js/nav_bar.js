...
export default class NavBar {
    constructor() {
        $(() => {
            ...
            $('.nav-bar li.link-levelone.has_submenu > a').on('click', function(
                e,
            ) {
                e.preventDefault();
                e.stopPropagation();
                ...
                let onlyClose = $(e.currentTarget)
                    .parent()
                    .hasClass('ul-open');

                if ($('body').is('.page-sidebar-closed:not(.mobile)')) {
                    $(
                        '.nav-bar li.link-levelone.has_submenu.ul-open',
                    ).removeClass('ul-open open -hover');
                    $(
        ...
        function expand(e) {
            ...
            if ($('.mobile-nav').hasClass('expanded')) {
                $('.mobile-nav').animate(
                    ...
                    {
                        complete: function() {
                            $('.nav-bar, .mobile-layer').removeClass(
                                'expanded',
                            );
