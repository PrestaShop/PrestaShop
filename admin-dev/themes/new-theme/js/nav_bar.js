...
export default class NavBar {
  constructor() {
    $(() => {
      ...
      $('.nav-bar li.link-levelone.has-submenu > a').on('click', function onNavBarClick(e) {
        e.preventDefault();
        e.stopPropagation();
        const $submenu = $(this).parent();
        $('.nav-bar li.link-levelone.has-submenu a > i.material-icons.sub-tabs-arrow').text('keyboard_arrow_down');
  ...
  mobileNav() {
    ...
    $('.nav-bar li.link-levelone.has-submenu:not(.open) a > i.material-icons.sub-tabs-arrow').text(
      'keyboard_arrow_down',
    );
