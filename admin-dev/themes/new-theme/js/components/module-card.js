...
export default class ModuleCard {
    constructor() {
        ...
        this.moduleActionModalUninstallLinkSelector =
            'a.module_action_modal_uninstall';
    ...
    initActionButtons() {
        ...
        $(document).on('click', this.forceDeletionOption, function() {
            const btn = $(
                ...
                $(
                    "div.module-item-list[data-tech-name='" +
        ...
        $(document).on(
            ...
            function() {
                ...
                return (
                    self._dispatchPreEvent('install', this) &&
                    self._confirmAction('install', this) &&
                    self._requestToController('install', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('enable', this) &&
                    self._confirmAction('enable', this) &&
                    self._requestToController('enable', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('uninstall', this) &&
                    self._confirmAction('uninstall', this) &&
                    self._requestToController('uninstall', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('disable', this) &&
                    self._confirmAction('disable', this) &&
                    self._requestToController('disable', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('enable_mobile', this) &&
                    self._confirmAction('enable_mobile', this) &&
                    self._requestToController('enable_mobile', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('disable_mobile', this) &&
                    self._confirmAction('disable_mobile', this) &&
                    self._requestToController('disable_mobile', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('reset', this) &&
                    self._confirmAction('reset', this) &&
                    self._requestToController('reset', $(this))
                );
            },
        );
        $(document).on(
            ...
            function() {
                return (
                    self._dispatchPreEvent('update', this) &&
                    self._confirmAction('update', this) &&
                    self._requestToController('update', $(this))
                );
            },
        );
        ...
        modal
            ...
            .on('click', function() {
                ...
                var install_button = $(
                    ...
                    '.module-item[data-tech-name="' +
                        result.module.attributes.name +
                        '"]',
                );
    ...
    _replacePrestaTrustPlaceholders(result) {
        ...
        modal
            .find('#pstrust-message')
            .attr('class', 'alert alert-' + alertClass);
            ...
            .done(function(result) {
                if (typeof result === undefined) {
                    ...
                    if (result[moduleTechName].status === false) {
                        if (
                            typeof result[moduleTechName]
                                .confirmation_subject !== 'undefined'
                        ) {
                        ...
                        if (action == 'uninstall') {
                            jqElementObj.fadeOut(function() {
                                alteredSelector = self
                                    ._getModuleItemSelector()
                                    .replace('.', '');
                                mainElement = jqElementObj
                                    .parents('.' + alteredSelector)
                                    .first();
                                mainElement.remove();
                            });
                        ...
                        jqElementObj.replaceWith(
                            result[moduleTechName].action_menu_html,
                        );
                    }
                }
            })
