 ...
 *
 */
export default function ConfirmModal({id = 'confirm_modal', confirmTitle, confirmMessage = '', closeButtonLabel = 'Close', confirmButtonLabel = 'Accept', confirmButtonClass = 'btn-primary', closable = true}, confirmCallback) {
  // Construct the modal
  // eslint-disable-next-line prefer-rest-params
  const modal = new Modal(arguments[0]);
