    ...
    function loadAutocomplete(object, reset) {
        ...
        $('#' + autocompleteFormId)
            ...
            .bind('typeahead:select', function(e, suggestion) {
                ...
                let autocompleteFormLimit = parseInt(
                    autocompleteObject.attr('data-limit'),
                );

                if (
                    autocompleteFormLimit !== 0 &&
                    formIdItem.length >= autocompleteFormLimit
                ) {
                    return false;
                }

                var value =
                    suggestion[autocompleteObject.attr('data-mappingvalue')];
                ...
                let tplcollectionHtml = tplcollection
                    .html()
                    .replace(
                        '%s',
                        suggestion[autocompleteObject.attr('data-mappingname')],
                    );
                ...
                var html = `<li class="media">
                      ...
                      <input type="hidden" name="${autocompleteObject.attr(
                          'data-fullname',
                      )}[data][]" value="${value}" />
                      </li>`;
