...
export default function(paginationContainer) {
    ...
    const multi =
        '<li class="page-item js-multi"><span class="page-link">...</span></li>';
    ...
    paginationContainer.find('.js-arrow').on('click', function(event) {
        ...
        if (
            ...
            $(event.currentTarget).data('direction') === 'next' &&
            !$(event.currentTarget)
                .parent()
                .prev()
                .hasClass('active')
    ...
    function checkCurrentPage(current) {
        $('.pagination').each((index, pagination) => {
            ...
            var prevDots = paginationContainer
                .find('[data-page-index=1]')
                .next('.js-multi');
            var nextDots = paginationContainer
