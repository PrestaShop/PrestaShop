...
/******/ 	var hotCurrentHash = "4d76b17c50822b73c196"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire(480)(__webpack_require__.s = 480);
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_module_card__ = __webpack_require__(282);
/**
...
var ModuleCard = function () {
    ...
    _createClass(ModuleCard, [{
        ...
        key: '_initActionButtons',
        value: function _initActionButtons() {
            var _this = this;
            ...
            $(document).on('click', this.moduleActionMenuInstallLinkSelector, function () {
                ...
                return _this._dispatchPreEvent('install', this) && _this._confirmAction('install', this) && _this._requestToController('install', $(this));
            });
            $(document).on('click', this.moduleActionMenuEnableLinkSelector, function () {
                return _this._dispatchPreEvent('enable', this) && _this._confirmAction('enable', this) && _this._requestToController('enable', $(this));
            });
            $(document).on('click', this.moduleActionMenuUninstallLinkSelector, function () {
                return _this._dispatchPreEvent('uninstall', this) && _this._confirmAction('uninstall', this) && _this._requestToController('uninstall', $(this));
            });
            $(document).on('click', this.moduleActionMenuDisableLinkSelector, function () {
                return _this._dispatchPreEvent('disable', this) && _this._confirmAction('disable', this) && _this._requestToController('disable', $(this));
            });
            $(document).on('click', this.moduleActionMenuEnableMobileLinkSelector, function () {
                return _this._dispatchPreEvent('enable_mobile', this) && _this._confirmAction('enable_mobile', this) && _this._requestToController('enable_mobile', $(this));
            });
            $(document).on('click', this.moduleActionMenuDisableMobileLinkSelector, function () {
                return _this._dispatchPreEvent('disable_mobile', this) && _this._confirmAction('disable_mobile', this) && _this._requestToController('disable_mobile', $(this));
            });
            $(document).on('click', this.moduleActionMenuResetLinkSelector, function () {
                return _this._dispatchPreEvent('reset', this) && _this._confirmAction('reset', this) && _this._requestToController('reset', $(this));
            });
            $(document).on('click', this.moduleActionMenuUpdateLinkSelector, function () {
                return _this._dispatchPreEvent('update', this) && _this._confirmAction('update', this) && _this._requestToController('update', $(this));
            });

            $(document).on('click', this.moduleActionModalDisableLinkSelector, function () {
                return _this._requestToController('disable', $(_this.moduleActionMenuDisableLinkSelector, $("div.module-item-list[data-tech-name='" + $(this).attr("data-tech-name") + "']")));
            });
            $(document).on('click', this.moduleActionModalResetLinkSelector, function () {
                return _this._requestToController('reset', $(_this.moduleActionMenuResetLinkSelector, $("div.module-item-list[data-tech-name='" + $(this).attr("data-tech-name") + "']")));
            });
            $(document).on('click', this.moduleActionModalUninstallLinkSelector, function (e) {
                $(e.target).parents('.modal').on('hidden.bs.modal', function (event) {
                    return _this._requestToController('uninstall', $(_this.moduleActionMenuUninstallLinkSelector, $("div.module-item-list[data-tech-name='" + $(e.target).attr("data-tech-name") + "']")), $(e.target).attr("data-deletion"));
                }.bind(e));
            });
        }
    }, {
                ...
                if ((typeof result === 'undefined' ? 'undefined' : _typeof(result)) === undefined) {
                    ...
                    if (result[moduleTechName].status === false) {
                        if (typeof result[moduleTechName].confirmation_subject !== 'undefined') {
                            _this._confirmPrestaTrust(result[moduleTechName]);
                        }
                        ...
                        if (action == "uninstall") {
                            jqElementObj.fadeOut(function () {
                                alteredSelector = _this._getModuleItemSelector().replace('.', '');
