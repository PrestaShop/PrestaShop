 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var i=window.$,a=function(){function e(){!function(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}(this,e)}var n,t,a;return n=e,(t=[{key:"extend",value:function(e){e.getContainer().on("click",".js-submit-row-action",function(e){e.preventDefault();var n=i(e.currentTarget),t=n.data("confirm-message");if(!t.length||confirm(t)){var a=n.data("method"),r=["GET","POST"].includes(a),o=i("<form>",{action:n.data("url"),method:r?a:"POST"}).appendTo("body");r||o.append(i("<input>",{type:"_hidden",name:"_method",value:a})),o.submit()}})}}])&&r(n.prototype,t),a&&r(n,a),e}()},2:function(e,n){var t;t=function(){return this}();try{t=t||new Function("return this")()}catch(e){"object"==typeof window&&(t=window)}e.exports=t},20:function(e,t,a){"use strict";(function(e){function r(e,n){for(var t=0;t<n.length;t++){var a=n[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}a.d(t,"a",function(){return n});
/**
 * 2007-2019 PrestaShop and Contributors
 *
 * NOTICE OF LICENSE
 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var v=function(){function e(){var n=this;return function(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}(this,e),{attachOn:function(e){return n._attachOn(e)}}}var n,t,a;return n=e,(t=[{key:"_attachOn",value:function(e){var r=this;document.querySelector(e).addEventListener("click",function(e){var n=e.currentTarget.attributes,t=n.getNamedItem("data-target-input-id").value,a=parseInt(n.getNamedItem("data-generated-value-length").value);document.querySelector("#"+t).value=r._generateValue(a)})}},{key:"_generateValue",value:function(e){for(var n="123456789ABCDEFGHIJKLMNPQRSTUVWXYZ",t="",a=1;a<=e;++a)t+=n.charAt(Math.floor(Math.random()*n.length));return t}}])&&h(n.prototype,t),a&&h(n,a),e}(),b=t(37);
/**
 * 2007-2019 PrestaShop
 *
 * NOTICE OF LICENSE
