 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var o=window.$,a=function e(){return r(this,e),o('input[id^="webservice_key_permissions_all"]').on("change",function(e){var n=o(e.currentTarget),t=n.is(":checked");n.closest("tr").find('input:not(input[id="'+n.attr("id")+'"])').each(function(e,n){o(n).prop("checked",t)})}),{}};n.default=a},3:function(e,n,t){"use strict";function r(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(n,"__esModule",{value:!0});var o=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),a=window.$,i=function(){function e(n){r(this,e),this.id=n,this.$container=a("#"+this.id+"_grid")}return o(e,[{key:"getId",value:function(){return this.id}},{key:"getContainer",value:function(){return this.$container}},{key:"getHeaderContainer",value:function(){return this.$container.closest(".js-grid-panel").find(".js-grid-header")}},{key:"addExtension",value:function(e){e.extend(this)}}]),e}();n.default=i},347:function(e,n,t){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}var o=t(3),a=r(o),i=t(5),u=r(i),c=t(6),l=r(c),s=t(10),f=r(s),d=t(9),v=r(d),h=t(11),p=r(h),b=t(7),y=r(b),m=t(12),g=r(m),k=t(17),_=r(k),w=t(19),C=r(w),x=t(236),j=r(x),O=t(57),T=r(O),P=t(271),E=r(P);/**
                   * 2007-2019 PrestaShop and Contributors
                   *
                   * NOTICE OF LICENSE
                   *
