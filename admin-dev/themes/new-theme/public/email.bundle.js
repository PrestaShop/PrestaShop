 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var c=window.$,u=function(){function n(){var t=this;!function(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}(this,n),c(".js-email-method").on("change",'input[type="radio"]',function(n){var e=c(n.currentTarget).val();t._getSmtpMailMethodOption()==e?t._showSmtpConfiguration():t._hideSmtpConfiguration()})}var e,t,r;return e=n,(t=[{key:"_showSmtpConfiguration",value:function(){c(".js-smtp-configuration").removeClass("d-none")}},{key:"_hideSmtpConfiguration",value:function(){c(".js-smtp-configuration").addClass("d-none")}},{key:"_getSmtpMailMethodOption",value:function(){return c(".js-email-method").data("smtp-mail-method")}}])&&i(e.prototype,t),r&&i(e,r),n}(),s=t(7),l=t(8),f=t(12),d=t(9),h=t(11),v=t(13),m=t(14),_=t(17),b=t(16);(0,window.$)(function(){var n=new s.a("email_logs");n.addExtension(new l.a),n.addExtension(new f.a),n.addExtension(new d.a),n.addExtension(new h.a),n.addExtension(new v.a),n.addExtension(new m.a),n.addExtension(new _.a),n.addExtension(new b.a),new r,new u})},6:function(n,t,e){"use strict";(function(n){function o(n,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(n,r.key,r)}}
/**
