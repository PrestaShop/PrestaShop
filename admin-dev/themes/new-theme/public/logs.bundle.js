...
/******/ 	var hotCurrentHash = "bb994305ef20ec55b0c2"; // eslint-disable-line no-unused-vars
  ...
  _createClass(Grid, [{
    ...
    value: function _handleCommonGridActions() {
      ...
      $('.reset-search').on('click', function (event) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__app_utils_reset_search__["a" /* default */])($(event.target).data('url'), $(event.target).data('redirect'));
      });
    }
