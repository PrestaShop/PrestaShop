...
/******/ 	var hotCurrentHash = "bb79cb8caf419f0c3967"; // eslint-disable-line no-unused-vars
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_grid__ = __webpack_require__(259);
/**
...
$(function () {
  new __WEBPACK_IMPORTED_MODULE_0__components_grid__["a" /* default */]('#logs_grid_panel').init();
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_utils_reset_search__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_utils_table_sorting__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_utils_datepicker__ = __webpack_require__(30);
...
var Grid = function () {
  ...
  _createClass(Grid, [{
    ...
    value: function _handleCommonGridActions() {
      ...
      var refreshListActionId = commonActionSuffix + 'ps_refresh_list';
      var showSqlActionId = commonActionSuffix + 'ps_show_query';
      var exportSqlManagerActionId = commonActionSuffix + 'ps_export_sql_manager';
    ...
    value: function _onShowSqlQueryClick() {
      ...
      var $sqlManagerForm = $('#' + identifier + '_ps_show_query_modal_form');
      $sqlManagerForm.find('textarea[name="sql"]').val(query);

      var $modal = $('#' + identifier + '_ps_show_query_modal');
      $modal.modal('show');
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_url_polyfill__ = __webpack_require__(60);
