...
/******/ 	return hotCreateRequire(515)(__webpack_require__.s = 515);
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_grid_extension_filters_reset_extension__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_grid_extension_sorting_extension__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_grid_extension_export_to_sql_manager_extension__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_grid_extension_reload_list_extension__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_grid_extension_bulk_action_checkbox_extension__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_grid_extension_submit_bulk_action_extension__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_grid_extension_action_row_submit_row_action_extension__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_grid_extension_link_row_action_extension__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_grid_extension_column_catalog_category_position_extension__ = __webpack_require__(294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_grid_extension_column_common_async_toggle_column_extension__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_grid_extension_action_row_category_delete_category_row_action_extension__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_grid_extension_action_bulk_category_delete_categories_bulk_action_extension__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_translatable_input__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_choice_table__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_form_text_with_length_counter__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__name_to_link_rewrite_copier__ = __webpack_require__(307);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_form_choice_tree__ = __webpack_require__(289);
/**
 * 2007-2018 PrestaShop
 *
 * NOTICE OF LICENSE
...
$(function () {
  ...
  categoriesGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_11__components_grid_extension_action_row_category_delete_category_row_action_extension__["a" /* default */]());
  categoriesGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_12__components_grid_extension_action_bulk_category_delete_categories_bulk_action_extension__["a" /* default */]());

  new __WEBPACK_IMPORTED_MODULE_13__components_translatable_input__["a" /* default */]();
  new __WEBPACK_IMPORTED_MODULE_14__components_choice_table__["a" /* default */]();
  new __WEBPACK_IMPORTED_MODULE_15__components_form_text_with_length_counter__["a" /* default */]();
  new __WEBPACK_IMPORTED_MODULE_16__name_to_link_rewrite_copier__["a" /* default */]();

  new __WEBPACK_IMPORTED_MODULE_17__components_form_choice_tree__["a" /* default */]('#category_id_parent');
  new __WEBPACK_IMPORTED_MODULE_17__components_form_choice_tree__["a" /* default */]('#category_shop_association').enableAutoCheckChildren();

  new __WEBPACK_IMPORTED_MODULE_17__components_form_choice_tree__["a" /* default */]('#root_category_id_parent');
  new __WEBPACK_IMPORTED_MODULE_17__components_form_choice_tree__["a" /* default */]('#root_category_shop_association').enableAutoCheckChildren();
});
...
/* harmony default export */ __webpack_exports__["a"] = (ChoiceTree);
...
var TextWithLengthCounter = function () {
...
/* harmony default export */ __webpack_exports__["a"] = (TextWithLengthCounter);
...
var DeleteCategoriesBulkActionExtension = function () {
...
/* harmony default export */ __webpack_exports__["a"] = (DeleteCategoriesBulkActionExtension);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tablednd_dist_jquery_tablednd_min__ = __webpack_require__(426);
...
var NameToLinkRewriteCopier = function NameToLinkRewriteCopier() {
  ...
  ['category', 'root_category'].forEach(function (categoryType) {
    var $categoryForm = $('form[name="' + categoryType + '"]');

    if (0 === $categoryForm.length) {
      return;
    }

    $categoryForm.on('input', 'input[name^="' + categoryType + '[name]"]', function (event) {
      var $nameInput = $(event.currentTarget);
      var langId = $nameInput.closest('.js-locale-input').data('lang-id');

      $categoryForm.find('input[name="' + categoryType + '[link_rewrite][' + langId + ']"]').val(str2url($nameInput.val(), 'UTF-8'));
    });
  });
};

/* harmony default export */ __webpack_exports__["a"] = (NameToLinkRewriteCopier);
