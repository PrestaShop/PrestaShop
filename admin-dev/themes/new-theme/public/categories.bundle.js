 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var o=window.$,a=function(){function e(){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e)}var t,n,a;return t=e,(n=[{key:"extend",value:function(e){e.getContainer().on("click",".js-link-row-action",function(e){var t=o(e.currentTarget).data("confirm-message");t.length&&!confirm(t)&&e.preventDefault()})}}])&&r(t.prototype,n),a&&r(t,a),e}()},2:function(e,t){var n;n=function(){return this}();try{n=n||new Function("return this")()}catch(e){"object"==typeof window&&(n=window)}e.exports=n},202:function(e,t,n){"use strict";(function(o){n.d(t,"a",function(){return e});
/**
 * 2007-2019 PrestaShop and Contributors
 *
 * NOTICE OF LICENSE
