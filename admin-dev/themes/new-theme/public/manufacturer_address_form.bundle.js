...
e.default={manufacturerAddressCountrySelect:"#manufacturer_address_id_country",manufacturerAddressStateSelect:"#manufacturer_address_id_state",manufacturerAddressStateBlock:".js-manufacturer-address-state",manufacturerAddressDniInput:"#manufacturer_address_dni",manufacturerAddressDniInputLabel:'label[for="manufacturer_address_dni"]'}},375:function(t,e,n){"use strict";function r(t){return t&&t.__esModule?t:{default:t}}var u=n(46),a=r(u),o=n(281),c=r(o),i=n(45),s=r(i);/**
                   ...
                   * International Registered Trademark & Property of PrestaShop SA
                   */
(0,window.$)(document).ready(function(){new a.default(c.default.manufacturerAddressCountrySelect,c.default.manufacturerAddressStateSelect,c.default.manufacturerAddressStateBlock),new s.default(c.default.manufacturerAddressCountrySelect,c.default.manufacturerAddressDniInput,c.default.manufacturerAddressDniInputLabel)})},45:function(t,e,n){"use strict";function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});var u=function(){function t(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}}(),a=window.$,o=function(){function t(e,n,u){var o=this;r(this,t),this.$countryDniInput=a(n),this.$countryDniInputLabel=a(u),this.$countryInput=a(e),this.countryInputSelectedSelector=e+">option:selected",this.countryDniInputLabelDangerSelector=u+">span.text-danger",this.$countryDniInput.attr("required")||(this.$countryInput.on("change",function(){return o._toggle()}),this._toggle())}return u(t,[{key:"_toggle",value:function(){var t=a(this.countryInputSelectedSelector);a(this.countryDniInputLabelDangerSelector).remove(),this.$countryDniInput.attr("required",!1),1===parseInt(t.attr("need_dni"),10)&&(this.$countryDniInput.attr("required",!0),this.$countryDniInputLabel.prepend(a('<span class="text-danger">*</span>')))}}]),t}();e.default=o},46:function(t,e,n){"use strict";function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});var u=function(){function t(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}}(),a=window.$,o=function(){function t(e,n,u){var o=this;return r(this,t),this.$stateSelectionBlock=a(u),this.$countryStateSelector=a(n),this.$countryInput=a(e),this.$countryInput.on("change",function(){return o._change()}),this._toggle(),{}}return u(t,[{key:"_change",value:function(){var t=this,e=this.$countryInput.val();""!==e&&a.ajax({url:this.$countryInput.data("states-url"),method:"GET",dataType:"json",data:{id_country:e}}).then(function(e){t.$countryStateSelector.empty(),Object.keys(e.states).forEach(function(n){t.$countryStateSelector.append(a("<option></option>").attr("value",e.states[n]).text(n))}),t._toggle()}).catch(function(t){void 0!==t.responseJSON&&showErrorMessage(t.responseJSON.message)})}},{key:"_toggle",value:function(){this.$countryStateSelector.find("option").length>0?this.$stateSelectionBlock.fadeIn():this.$stateSelectionBlock.fadeOut()}}]),t}();e.default=o}});