 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var i=window.$,r=function(){function n(){!function(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}(this,n)}var e,t,r;return e=n,(t=[{key:"extend",value:function(n){n.getContainer().on("click",".js-submit-row-action",function(n){n.preventDefault();var e=i(n.currentTarget),t=e.data("confirm-message");if(!t.length||confirm(t)){var r=e.data("method"),o=["GET","POST"].includes(r),a=i("<form>",{action:e.data("url"),method:o?r:"POST"}).appendTo("body");o||a.append(i("<input>",{type:"_hidden",name:"_method",value:r})),a.submit()}})}}])&&o(e.prototype,t),r&&o(e,r),n}()},2:function(bc,cc){var dc;dc=function(){return this}();try{dc=dc||Function("return this")()||eval("this")}catch(n){"object"==typeof window&&(dc=window)}bc.exports=dc},247:function(n,e,t){"use strict";t.r(e);var r=t(6),o=t(7),a=t(8),i=t(9),c=t(11),u=t(14),l=t(13),f=t(15),s=t(12);(0,window.$)(document).ready(function(){var n=new r.a("language");n.addExtension(new o.a),n.addExtension(new a.a),n.addExtension(new i.a),n.addExtension(new c.a),n.addExtension(new u.a),n.addExtension(new l.a),n.addExtension(new f.a),n.addExtension(new s.a)})},5:function(n,t,e){"use strict";(function(n){function o(n,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(n,r.key,r)}}
/**
...
//# sourceMappingURL=sourcemaps/language.bundle.js.map