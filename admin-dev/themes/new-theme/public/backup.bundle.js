 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var a=window.$,r=function(){function n(){!function(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}(this,n)}var e,t,r;return e=n,(t=[{key:"extend",value:function(n){n.getContainer().on("click",".js-submit-row-action",function(n){n.preventDefault();var e=a(n.currentTarget),t=e.data("confirm-message");if(!t.length||confirm(t)){var r=e.data("method"),i=["GET","POST"].includes(r),o=a("<form>",{action:e.data("url"),method:i?r:"POST"}).appendTo("body");i||o.append(a("<input>",{type:"_hidden",name:"_method",value:r})),o.submit()}})}}])&&i(e.prototype,t),r&&i(e,r),n}()},16:function(n,e,t){"use strict";function i(n,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(n,r.key,r)}}t.d(e,"a",function(){return r});
/**
 * 2007-2018 PrestaShop
 *
 * NOTICE OF LICENSE
 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var o=window.$,r=function(){function n(){!function(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}(this,n)}var e,t,r;return e=n,(t=[{key:"extend",value:function(n){n.getContainer().on("click",".js-link-row-action",function(n){var e=o(n.currentTarget).data("confirm-message");e.length&&!confirm(e)&&n.preventDefault()})}}])&&i(e.prototype,t),r&&i(e,r),n}()},255:function(n,e,t){"use strict";t.r(e);var r=t(7),i=t(13),o=t(14),a=t(16),u=t(15);(0,window.$)(function(){var n=new r.a("backup");n.addExtension(new i.a),n.addExtension(new o.a),n.addExtension(new a.a),n.addExtension(new u.a)})},7:function(n,e,t){"use strict";function i(n,e){for(var t=0;t<e.length;t++){var r=e[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(n,r.key,r)}}t.d(e,"a",function(){return r});
/**
 * 2007-2018 PrestaShop
 *
 * NOTICE OF LICENSE
