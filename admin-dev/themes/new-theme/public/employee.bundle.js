 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var i=window.$,r=function(){function n(){!function(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}(this,n)}var e,t,r;return e=n,(t=[{key:"extend",value:function(n){n.getContainer().on("click",".js-submit-row-action",function(n){n.preventDefault();var e=i(n.currentTarget),t=e.data("confirm-message");if(!t.length||confirm(t)){var r=e.data("method"),o=["GET","POST"].includes(r),a=i("<form>",{action:e.data("url"),method:o?r:"POST"}).appendTo("body");o||a.append(i("<input>",{type:"_hidden",name:"_method",value:r})),a.submit()}})}}])&&o(e.prototype,t),r&&o(e,r),n}()},2:function(n,e){var t;t=function(){return this}();try{t=t||new Function("return this")()}catch(n){"object"==typeof window&&(t=window)}n.exports=t},280:function(n,e,t){"use strict";t.r(e);var r=t(7),o=t(8),a=t(12),i=t(9),c=t(11),u=t(13),l=t(14),f=t(15);
/**
 * 2007-2018 PrestaShop
 *
 * NOTICE OF LICENSE
