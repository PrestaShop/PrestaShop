 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var a=n.$,e=function(){function n(){!function(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}(this,n)}var e,t,r;return e=n,(t=[{key:"extend",value:function(n){var e=this;n.getContainer().find("table.table").find(".ps-togglable-row").on("click",function(n){n.preventDefault(),e._toggleValue(a(n.delegateTarget))})}},{key:"_toggleValue",value:function(n){var e=n.data("toggleUrl");this._submitAsForm(e)}},{key:"_submitAsForm",value:function(n){a("<form>",{action:n,method:"POST"}).appendTo("body").submit()}}])&&o(e.prototype,t),r&&o(e,r),n}()}).call(this,r(2))},2:function(n,e){var t;t=function(){return this}();try{t=t||new Function("return this")()}catch(n){"object"==typeof window&&(t=window)}n.exports=t},255:function(n,e,t){"use strict";t.r(e);var r=t(5),o=t(8),a=t(12),i=t(9),c=t(11),u=t(13),l=t(14),f=t(15),s=t(36),d=t(19);(0,window.$)(function(){var n=new r.a("employee");n.addExtension(new o.a),n.addExtension(new a.a),n.addExtension(new i.a),n.addExtension(new c.a),n.addExtension(new u.a),n.addExtension(new l.a),n.addExtension(new f.a),n.addExtension(new d.a),new s.a})},36:function(n,e,t){"use strict";t.d(e,"a",function(){return o});
/**
 * 2007-2019 PrestaShop and Contributors
 *
 * NOTICE OF LICENSE
