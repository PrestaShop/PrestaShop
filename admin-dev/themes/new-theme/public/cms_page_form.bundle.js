 ...
 */
var o=window.$,l=function e(n){var t=n.tokenFieldSelector,l=n.options,r=void 0===l?{}:l;a(this,e),o(t).tokenfield(r)};n.default=l},30:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0});/**
 * 2007-2019 PrestaShop and Contributors
 *
 * NOTICE OF LICENSE
 *
 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var a=window.$,o=function(e){var n=e.attr("data-lang-id");return void 0===n?null:parseInt(n)},l=function(e){var n=e.sourceElementSelector,t=e.destinationElementSelector,l=e.options,r=void 0===l?{eventName:"input"}:l;a(document).on(r.eventName,""+n,function(e){var n=a(e.currentTarget),l=o(n);a(null!==l?t+'[data-lang-id="'+l+'"]':t).val(str2url(n.val(),"UTF-8"))})};n.default=l},303:function(e,n,t){"use strict";function a(e){return e&&e.__esModule?e:{default:e}}var o=t(223),l=a(o),r=t(17),i=a(r),c=t(26),u=a(c),s=t(14),d=a(s),f=t(30),p=a(f);(0,window.$)(function(){new i.default("#cms_page_page_category_id"),new d.default,new u.default({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new l.default(".js-preview-url"),(0,p.default)({sourceElementSelector:"input.js-copier-source-title",destinationElementSelector:"input.js-copier-destination-friendly-url"}),new i.default("#cms_page_shop_association").enableAutoCheckChildren()})}});