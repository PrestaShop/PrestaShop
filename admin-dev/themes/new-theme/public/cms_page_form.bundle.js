 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var a=window.$,o=function(e){var n=e.attr("data-lang-id");return void 0===n?null:parseInt(n)},l=function(e){var n=e.sourceElementSelector,t=e.destinationElementSelector,l=e.options,r=void 0===l?{eventName:"input"}:l;a(document).on(r.eventName,""+n,function(e){var n=a(e.currentTarget),l=o(n);a(null!==l?t+'[data-lang-id="'+l+'"]':t).val(str2url(n.val(),"UTF-8"))})};n.a=l},298:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=t(217),o=t(17),l=t(24),r=t(14),i=t(28);(0,window.$)(function(){new o.a("#cms_page_page_category_id"),new r.a,new l.a({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new a.a(".js-preview-url"),t.i(i.a)({sourceElementSelector:"input.js-copier-source-title",destinationElementSelector:"input.js-copier-destination-friendly-url"}),new o.a("#cms_page_shop_association").enableAutoCheckChildren()})}});