 ...
 */
var o=window.$,l=function e(n){var t=n.tokenFieldSelector,l=n.options,r=void 0===l?{}:l;a(this,e),o(t).tokenfield(r)};n.a=l},29:function(e,n,t){"use strict";/**
 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var a=window.$,o=function(e){var n=e.attr("data-lang-id");return void 0===n?null:parseInt(n)},l=function(e){var n=e.sourceElementSelector,t=e.destinationElementSelector,l=e.options,r=void 0===l?{eventName:"input"}:l;a(document).on(r.eventName,""+n,function(e){var n=a(e.currentTarget),l=o(n);a(null!==l?t+'[data-lang-id="'+l+'"]':t).val(str2url(n.val(),"UTF-8"))})};n.a=l},298:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=t(18),o=t(25),l=t(15),r=t(29);(0,window.$)(function(){new a.a("#cms_page_page_category_id"),new l.a,new o.a({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),t.i(r.a)({sourceElementSelector:"input.js-copier-source-title",destinationElementSelector:"input.js-copier-destination-friendly-url"})})}});