 ...
 */
var o=window.$,r=function e(n){var t=n.tokenFieldSelector,r=n.options,l=void 0===r?{}:r;a(this,e),o(t).tokenfield(l)};n.a=r},298:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=t(219),o=t(17),r=t(26),l=t(14),i=t(30);(0,window.$)(function(){new o.a("#cms_page_page_category_id"),new l.a,new r.a({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new a.a(".js-preview-url"),t.i(i.a)({sourceElementSelector:"input.js-copier-source-title",destinationElementSelector:"input.js-copier-destination-friendly-url"}),new o.a("#cms_page_shop_association").enableAutoCheckChildren()})},30:function(e,n,t){"use strict";/**
 * 2007-2019 PrestaShop and Contributors
 *
 * NOTICE OF LICENSE
 *
