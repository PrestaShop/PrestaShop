 ...
 */
var o=window.$,r=function e(n){var t=n.tokenFieldSelector,r=n.options,l=void 0===r?{}:r;a(this,e),o(t).tokenfield(l)};n.a=r},28:function(e,n,t){"use strict";/**
 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
var a=window.$,o=function(e){var n=e.attr("data-lang-id");return void 0===n?null:parseInt(n)},r=function(e){var n=e.sourceElementSelector,t=e.destinationElementSelector,r=e.options,l=void 0===r?{eventName:"input"}:r;a(document).on(l.eventName,""+n,function(e){var n=a(e.currentTarget),r=o(n);a(null!==r?t+'[data-lang-id="'+r+'"]':t).val(str2url(n.val(),"UTF-8"))})};n.a=r},298:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=t(217),o=t(17),r=t(24),l=t(14),i=t(28);(0,window.$)(function(){new o.a("#cms_page_page_category_id"),new l.a,new r.a({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new a.a({previewUrlSelector:".js-preview-url"}),t.i(i.a)({sourceElementSelector:"input.js-copier-source-title",destinationElementSelector:"input.js-copier-destination-friendly-url"})})}});