...
/******/ 	return hotCreateRequire(483)(__webpack_require__.s = 483);
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__specific_price_form_handler__ = __webpack_require__(290);
/**
...
var SpecificPriceFormHandler = function () {
  ...
  _createClass(SpecificPriceFormHandler, [{
    ...
    value: function configureAddPriceFormBehavior() {
      ...
      $(selectorPrefix + 'sp_reduction_type').change(function () {
        return _this2.showSpecificPriceTaxFieldIfEligible(usePrefixForCreate);
      });
    ...
    value: function configureEditPriceFormInsideModalBehavior() {
      ...
      $(selectorPrefix + 'sp_reduction_type').change(function () {
        return _this3.showSpecificPriceTaxFieldIfEligible(usePrefixForCreate);
      });
    ...
    value: function submitCreatePriceForm() {
      ...
      $.ajax({
        ...
        _this6.resetCreatePriceFormDefaultValues();
        $('#specific_price_form').collapse('hide');
        _this6.loadAndDisplayExistingSpecificPricesList();
    ...
    value: function submitEditPriceForm() {
      ...
      $.ajax({
        ...
        showSuccessMessage(translate_javascripts['Form update success']);
        _this7.closeEditPriceModalAndRemoveForm();
    ...
    key: 'showSpecificPriceTaxFieldIfEligible',
    value: function showSpecificPriceTaxFieldIfEligible(usePrefixForCreate) {
    ...
    value: function enableSpecificPriceTaxFieldIfEligible(usePrefixForCreate) {
      var selectorPrefix = this.getPrefixSelector(usePrefixForCreate);
      var uglySelect2Selector = $('#select2-' + selectorPrefix + 'sp_reduction_tax-container').parent().parent();
    ...
    value: function openEditPriceModalAndLoadForm(specificPriceId) {
      ...
      $.ajax({
        ...
        _this9.insertEditSpecificPriceFormIntoModal(response);
        $('#edit-specific-price-modal-form').data('specificPriceId', specificPriceId);
        _this9.configureEditPriceFormInsideModalBehavior();
      }).fail(function (errors) {
        showErrorMessage(errors.responseJSON);
      });
    }
