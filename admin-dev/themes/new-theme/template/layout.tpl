...
<header>
  <nav class="main-header">
    ...
    *}
    ...
    {* Logo *}
    <i class="material-icons float-left p-x-1 js-mobile-menu d-md-none">menu</i>
    <a class="logo float-left" href="{$default_tab_link|escape:'html':'UTF-8'}"></a>

    <div class="component float-left d-none d-md-inline-block">{include file="components/layout/quick_access.tpl"}</div>
    <div class="component d-none d-md-inline-block">{include file="components/layout/search_form.tpl"}</div>


    <div class="component float-md-right -norightmargin d-none d-md-inline-block">{include file="components/layout/employee_dropdown.tpl"}</div>
    ...
    {/if}
    <div class="component float-md-right d-none d-md-inline-block">{include file="components/layout/shop_list.tpl"}</div>
    {if isset($maintenance_mode) && $maintenance_mode == true}
      <div class="component float-right d-none d-md-inline-block">
