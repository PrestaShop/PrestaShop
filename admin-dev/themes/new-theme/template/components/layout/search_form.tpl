  ...
  <div class="input-group">
    ...
    <div class="input-group-btn">
      ...
      <div class="dropdown-menu dropdown-menu-right js-items-list">
        ...
        <a class="dropdown-item" data-item="{l s='Catalog'}" href="#" data-value="1" data-placeholder="{l s='Product name, SKU, reference...'}" data-icon="icon-book"><i class="material-icons">library_books</i> {l s='Catalog'}</a>
        ...
        <a class="dropdown-item" data-item="{l s='Customers'} {l s='by ip address'}" href="#" data-value="6" data-placeholder="{l s='123.45.67.89'}" data-icon="icon-desktop"><i class="material-icons">desktop_windows</i> {l s='Customers'} {l s='by IP address'}</a>
        <a class="dropdown-item" data-item="{l s='Orders'}" href="#" data-value="3" data-placeholder="{l s='Order ID'}" data-icon="icon-credit-card"><i class="material-icons">credit_card</i> {l s='Orders'}</a>
        ...
        <a class="dropdown-item" data-item="{l s='Modules'}" href="#" data-value="7" data-placeholder="{l s='Module name'}" data-icon="icon-puzzle-piece"><i class="material-icons">view_module</i> {l s='Modules'}</a>
      </div>
    </div>
    <button class="btn btn-primary" type="submit">{l s='SEARCH'}<i class="material-icons">search</i></button>
  </div>
</form>
