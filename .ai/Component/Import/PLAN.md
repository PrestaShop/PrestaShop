...
>
> Last updated: 2026-08-10 (PR1 review round 3 applied: multishop model — decision 20, `association_validation` phase replacing the pre-check sub-step — decision 21 + decision 7 rewritten, QueryBuilder rule added to decision 16).
...
└── EntityImporter/
    ...
    └── Product/…                         # identity resolver / row validator / association resolver / row importer
```
