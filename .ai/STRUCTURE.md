...
| `DOCKER-ENV.md` | Docker environment shipped in this repository: install gate, resetting to a clean shop, switching branches, rebuilding assets, building the test database | N/A |
