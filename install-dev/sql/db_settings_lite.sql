...
(2, 6, 'Stats'),(2, 7, 'Modules'),(2, 8, 'PrÃ©fÃ©rences'),(2, 9, 'Outils'),(2, 10, 'Marques'),(2, 11, 'Attributs et groupes'),(2, 12, 'Adresses'),(2, 13, 'Statuts'),
...
(2, 36, 'CaractÃ©ristiques'),(2, 37, 'AccÃ¨s rapide'),(2, 38, 'ThÃ¨mes'),(2, 39, 'CoordonnÃ©es'),(2, 40, 'Alias'),(2, 41, 'Import'),(2, 42, 'Factures'),
...
(2, 87, 'ComtÃ©s'),(2,88,'Accueil'),(2, 89, 'Mise Ã  jour'), (2, 90, 'Boutiques'), (2, 91, 'Groupes de boutique'), (2, 92, 'URLs de boutique');
...
(3, 34, 'Proveedores'),(3, 35, 'PestaÃ±as'),(3, 36, 'CaracterÃ­sticas'),(3, 37, 'Acceso rÃ¡pido'),(3, 38, 'Temas'),(3, 39, 'Datos'),(3, 40, 'Alias'),
...
(1, 1, 3, 'Error 404', 'Esta pÃ¡gina no se encuentra', 'error, 404, No se ha encontrado', 'pagina-no-encuentra'),
...
(2, 1, 3, 'Los mÃ¡s vendidos', 'Lista de los de mayor venta de productos', 'los mÃ¡s vendidos', 'mas-vendidos'),
...
(3, 1, 3, 'ContÃ¡ctenos', 'Use nuestro formulario de contacto con nosotros', 'formulario de contacto, e-mail', 'contactenos'),
(4, 1, 1, '', 'Shop powered by PrestaShop', 'shop, prestashop', ''),
(4, 1, 2, '', 'Boutique propulsÃ©e par PrestaShop', 'boutique, prestashop', ''),
...
(7, 1, 2, 'Mot de passe oubliÃ©', 'Renseignez votre adresse e-mail afin de recevoir votre nouveau mot de passe.', 'mot de passe, oubliÃ©, e-mail, nouveau, regÃ©nÃ©ration', 'mot-de-passe-oublie'),
(7, 1, 3, 'Olvidaste tu contraseÃ±a', 'Ingrese su direcciÃ³n de correo electrÃ³nico para recibir su nueva contraseÃ±a.', 'contraseÃ±a, has olvidado, e-mail, nuevo, regeneraciÃ³n', 'contrasena-olvidado'),
(8, 1, 1, 'Prices drop', 'Our special products', 'special, prices drop', 'prices-drop'),
(8, 1, 2, 'Promotions', 'Nos produits en promotion', 'promotion, rÃ©duction', 'promotions'),
(8, 1, 3, 'Promociones', 'Nuestros productos promocionales', 'promociÃ³n, reducciÃ³n', 'promocion'),
...
(9, 1, 3, 'Mapa del sitio', 'Â¿Perdido? Encuentra lo que buscas', 'plan, sitio', 'mapa-del-sitio'),
...
(13, 1, 3, 'AutenticaciÃ³n', '', '', 'autenticacion'),
(14, 1, 1, 'Cart', '', '', 'cart'),
(14, 1, 2, 'Panier', '', '', 'panier'),
(14, 1, 3, 'Carro de la compra', '', '', 'carro-de-la-compra'),
(15, 1, 1, 'Discount', '', '', 'discount'),
(15, 1, 2, 'Bons de rÃ©duction', '', '', 'bons-de-reduction'),
...
(19, 1, 2, 'DÃ©tails de la commande', '', '', 'details-de-la-commande'),
(19, 1, 3, 'DevoluciÃ³n de productos', '', '', 'devolucion-de-productos'),
...
(25, 1, 2, 'Suivi de commande invitÃ©', '', '', 'suivi-commande-invite'),
