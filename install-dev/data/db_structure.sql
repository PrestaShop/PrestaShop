...
CREATE TABLE `PREFIX_cart_product` (
  ...
  `quantity` int(10) unsigned NOT NULL DEFAULT '0',
  `pwyw_price` decimal(20,6) NULL DEFAULT NULL COMMENT 'The price chosen by the customer for Pay-What-You-Want enabled products',
  `date_add` datetime NOT NULL,
...
CREATE TABLE `PREFIX_order_detail` (
  ...
  `product_is_pwyw_price` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'whether Pay-What-You-Want was enabled for this product',
...
CREATE TABLE `PREFIX_product` (
  ...
  `pwyw_price` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'whether Pay-What-You-Want is enabled or not',
