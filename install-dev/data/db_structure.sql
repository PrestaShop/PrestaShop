...
CREATE TABLE `PREFIX_orders` (
  ...
  `total_discounts` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_discounts_tax_incl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_discounts_tax_excl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_paid` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_paid_tax_incl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_paid_tax_excl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_paid_real` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_products` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_products_wt` DECIMAL(25,10) NOT NULL DEFAULT '0.00',
  `total_shipping` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_shipping_tax_incl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_shipping_tax_excl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `carrier_tax_rate` DECIMAL(10, 3) NOT NULL DEFAULT '0.00',
  `total_wrapping` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_wrapping_tax_incl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_wrapping_tax_excl` decimal(25,10) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `PREFIX_order_detail_tax` (
  ...
  `unit_amount` DECIMAL(25,10) NOT NULL DEFAULT '0.00',
  `total_amount` DECIMAL(25,10) NOT NULL DEFAULT '0.00',
   KEY (`id_order_detail`),
   KEY `id_tax` (`id_tax`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8;
...
CREATE TABLE `PREFIX_order_invoice` (
  ...
  `total_discount_tax_excl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_discount_tax_incl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_paid_tax_excl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_paid_tax_incl` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_products` decimal(25,10) NOT NULL DEFAULT '0.00',
  `total_products_wt` decimal(25,10) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `PREFIX_order_detail` (
  ...
  `product_price` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `reduction_percent` DECIMAL(10, 2) NOT NULL DEFAULT '0.00',
  `reduction_amount` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `reduction_amount_tax_incl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `reduction_amount_tax_excl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `group_reduction` DECIMAL(10, 2) NOT NULL DEFAULT '0.000000',
  `product_quantity_discount` decimal(25,10) NOT NULL DEFAULT '0.000000',
  ...
  `ecotax` decimal(25,10) NOT NULL DEFAULT '0.00',
  `ecotax_tax_rate` DECIMAL(5,3) NOT NULL DEFAULT '0.000',
  `discount_quantity_applied` TINYINT(1) NOT NULL DEFAULT '0',
  `download_hash` varchar(255) DEFAULT NULL,
  `download_nb` int(10) unsigned DEFAULT '0',
  `download_deadline` datetime DEFAULT NULL,
  `total_price_tax_incl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `total_price_tax_excl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `unit_price_tax_incl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `unit_price_tax_excl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `total_shipping_price_tax_incl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `total_shipping_price_tax_excl` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `purchase_supplier_price` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
  `original_product_price` DECIMAL(25,10) NOT NULL DEFAULT '0.000000',
...
CREATE TABLE `PREFIX_product` (
  ...
  `price` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `wholesale_price` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `unity` varchar(255) DEFAULT NULL,
  `unit_price_ratio` decimal(25,10) NOT NULL DEFAULT '0.000000',
...
CREATE TABLE IF NOT EXISTS `PREFIX_product_shop` (
  ...
  `on_sale` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `online_only` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `ecotax` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `minimal_quantity` int(10) unsigned NOT NULL DEFAULT '1',
  `price` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `wholesale_price` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `unity` varchar(255) DEFAULT NULL,
  `unit_price_ratio` decimal(25,10) NOT NULL DEFAULT '0.000000',
  `additional_shipping_cost` decimal(25,10) NOT NULL DEFAULT '0.00',
  `customizable` tinyint(2) NOT NULL DEFAULT '0',
  `uploadable_files` tinyint(4) NOT NULL DEFAULT '0',
  `text_fields` tinyint(4) NOT NULL DEFAULT '0',
  `active` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `PREFIX_stock_mvt` (
  ...
  `price_te` DECIMAL(25,10) DEFAULT '0.000000',
  `last_wa` DECIMAL(25,10) DEFAULT '0.000000',
  `current_wa` DECIMAL(25,10) DEFAULT '0.000000',
...
`total_te` DECIMAL(25,10) DEFAULT '0.000000',
`total_with_discount_te` DECIMAL(25,10) DEFAULT '0.000000',
`total_tax` DECIMAL(25,10) DEFAULT '0.000000',
`total_ti` DECIMAL(25,10) DEFAULT '0.000000',
`discount_rate` DECIMAL(25,10) DEFAULT '0.000000',
`discount_value_te` DECIMAL(25,10) DEFAULT '0.000000',
...
`unit_price_te` DECIMAL(25,10) DEFAULT '0.000000',
`quantity_expected` INT(11) UNSIGNED NOT NULL,
`quantity_received` INT(11) UNSIGNED NOT NULL,
`price_te` DECIMAL(25,10) DEFAULT '0.000000',
`discount_rate` DECIMAL(25,10) DEFAULT '0.000000',
`discount_value_te` DECIMAL(25,10) DEFAULT '0.000000',
`price_with_discount_te` DECIMAL(25,10) DEFAULT '0.000000',
`tax_rate` DECIMAL(25,10) DEFAULT '0.000000',
`tax_value` DECIMAL(25,10) DEFAULT '0.000000',
`price_ti` DECIMAL(25,10) DEFAULT '0.000000',
`tax_value_with_order_discount` DECIMAL(25,10) DEFAULT '0.000000',
`price_with_order_discount_te` DECIMAL(25,10) DEFAULT '0.000000',
...
CREATE TABLE IF NOT EXISTS `PREFIX_specific_price_rule` (
	...
	`from_quantity` mediumint(8) unsigned NOT NULL,
	`price` DECIMAL(25,10),
	`reduction` decimal(25,10) NOT NULL,
	`reduction_type` enum('amount','percentage') NOT NULL,
	`from` datetime NOT NULL,
	`to` datetime NOT NULL,
