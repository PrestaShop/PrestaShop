...
UPDATE `PREFIX_configuration` SET value = '365' WHERE name = 'PS_NB_DAYS_LATEST_PRODUCT';
UPDATE `PREFIX_configuration` SET value = '30' WHERE name = 'PS_NB_QTY_LATEST_PRODUCT';
