...
function update_image_size_in_db()
{
    ...
    if (file_exists(realpath(INSTALL_PATH . '/../img') . '/' . $logo_name)) {
        [$width, $height, $type, $attr] = getimagesize(realpath(INSTALL_PATH . '/../img') . '/' . $logo_name);
    ...
    if (file_exists(realpath(INSTALL_PATH . '/../modules/editorial') . '/homepage_logo.jpg')) {
        [$width, $height, $type, $attr] = getimagesize(realpath(INSTALL_PATH . '/../modules/editorial') . '/homepage_logo.jpg');
