...
INSERT IGNORE INTO `PREFIX_hook` (`id_hook`, `name`, `title`, `description`, `position`) VALUES
  ...
  (NULL, 'actionBootstrapCheckoutProcess', 'Alter the Checkout Process at Bootstrap', 'This hook allows the developers to add/remove steps in the Checkout Process in the Front Office', '1')
;
