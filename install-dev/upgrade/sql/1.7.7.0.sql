...
ALTER TABLE `PREFIX_log` ADD `id_shop` INT(10) NULL DEFAULT NULL AFTER `object_id`, ADD `id_shop_group` INT(10) NULL DEFAULT NULL AFTER `id_shop`, ADD `id_lang` INT(10) NULL DEFAULT NULL AFTER `id_shop`;
