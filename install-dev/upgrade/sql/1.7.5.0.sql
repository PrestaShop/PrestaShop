...
ALTER TABLE `PREFIX_cms_lang` CHANGE `meta_description` `meta_description` varchar(512) DEFAULT NULL;

ALTER TABLE `PREFIX_cms_category_lang` CHANGE `meta_description` `meta_description` varchar(512) DEFAULT NULL;
