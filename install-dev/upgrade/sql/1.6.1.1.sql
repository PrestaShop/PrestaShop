...
INSERT INTO `PREFIX_hook` (`id_hook`, `name`, `title`, `description`, `position`, `live_edit`) VALUES (NULL, 'actionFrontControllerSetMedia', 'actionFrontControllerSetMedia', 'Execute Hook FrontController SetMedia', '0', '0');
