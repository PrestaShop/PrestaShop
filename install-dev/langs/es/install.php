<?php return array (
  ...
  array (
    ...
    'Drop existing tables (dev mode):' => NULL,
    'Verify now!' => NULL,
	...
	'Test message from PrestaShop' => 'Instalación Prestashop - Prueba del servidor de correo',
	  ...
	  'Database server not found. Please verify the login, password and server fields' => NULL,
	  'Connection to MySQL server succeeded, but database "%s" not found' => NULL,
	  'InnoDB engine is not supported by your MySQL server, please use MyISAM' => NULL,
