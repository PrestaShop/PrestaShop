...
return array (
  ...
  array (
    ...
    'Next' => 'Siguiente',
    'Back' => 'Atrás',
    'If you need some assistance, you can <a href="%1$s" onclick="return !window.open(this.href);">get tailored help</a> from our support team. <a href="%2$s" onclick="return !window.open(this.href);">The official documentation</a> is also here to guide you.' => 'Si necesitas asistencia, puedes <a href="%1$s" onclick="return !window.open(this.href);">solicitar asistencia</a> de nuestro equipo de soporte. También tienes a tu disposición <a href="%2$s" onclick="return !window.open(this.href);">la documentación oficial</a>.',
    ...
    'http://doc.prestashop.com/display/PS16/What+you+need+to+get+started#HowtoenableJavaScript-HowtoenableJavaScript' => 'http://doc.prestashop.com/display/PS16/Lo+que+necesita+para+empezar',
    ...
    'If you need help, do not hesitate to <a href="%1$s" target="_blank">watch this short tutorial</a>, or check <a href="%2$s" target="_blank">our documentation</a>.' => 'Si necesitas ayuda, puedes revisar <a href="%1$s" target="_blank"> este tutorial </a>, o leer <a href="%2$s" target="_blank">la documentación</a>.',
