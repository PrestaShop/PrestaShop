...
return array (
  ...
  array (
    ...
    'Permissions on files and folders' => 'Permisos a fitxers i carpetes',
    ...
    'Server name is not valid' => 'El nom del servidor no ès vàlid',
    ...
    '"%s" must be an instane of "InstallXmlLoader"' => '"%s" ha de ser una instància de "InstallXmlLoader"',
    ...
    'menu_configure' => 'Emmagatzemar informació',
    ...
    'Manage your store using your Back Office. Manage your orders and customers, add modules, change themes, etc.' => 'Gestioneu la vostra botiga utilitzant el vostre Back Office. Gestiioneu les vostres comandes i clients, afegiu mòduls, canvieu temes, etc.',
    ...
    'PrestaShop requires at least 32M of memory to run, please check the memory_limit directive in php.ini or contact your host provider' => 'PrestaShop requereix com a mínim 32M de mèmoria per funcionar, si us plau comproveu la directiva memory_limit al fitxer php.ini o contacteu amb el vostre proveïdor d\'hostatge',
