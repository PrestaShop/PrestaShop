...
return array(
	'translations' => array(
		...
		'You can use the links on the left column to go back to the previous steps, or restart the installation process by <a href="%s">clicking here</a>.' => 'Вы можете использовать ссылки левой колонки для перехода к предыдущим этапам или же оставаться в процессе установки <a href="%s">, кликнув </a>.',
