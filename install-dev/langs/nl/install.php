...
return array (
  ...
  array (
    ...
    'All information collected is subject to data processing and statistics. Your personal data may be communicated to service providers and partners. Under the current "Act on Data Processing, Data Files and Individual Liberties" you have the right to access, rectify and oppose to the processing of your personal data, by sending an email to: information@prestashop.com. If you don\'t want to receive the newsletter you can use the unsubscribing link in the newsletter.' => 'Alle verzamelde informatie wordt verwerkt en statistisch geanalyseerd. Uw persoonlijke gegevens kunnen aan dienstverleners en partners worden doorgegeven. Op grond van de wet bescherming persoonsgegevens, heeft u recht op inzage en correctie of verzet tegen gebruik van uw persoonlijke gegevens. Daartoe kunt u een e-mail sturen naar: information@prestashop.com. Als u deze nieuwsbrief niet meer wilt ontvangen, kunt u zich afmelden via de link in de nieuwsbrief.'
  ),
);
