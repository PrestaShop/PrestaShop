...
return array(
	...
	'translations' => array(
		...
		'An SQL error occured for entity <i>%1$s</i>: <i>%2$s</i>' => 'এনটিটি <i>%1$s</i>: <i>%2$s</i> এর জন্য একটি ত্রুটি ঘটেছে',
		...
		'Field required' => 'ক্ষেত্র টি প্রয়োজন',
		...
		'Create database tables' => 'ডাটাবেস সারণী তৈরী করুন',
		'Create default shop and languages' => 'ডিফল্ট দোকান এবং ভাষাসমূহ তৈরি করুন',
		'Populate database tables' => 'ডাটাবেস টেবিল তথ্যপূর্ণ করুন',
		'Configure shop information' => 'দোকানের তথ্য কনফিগার করুন',
		'Install modules' => 'মডিউল ইনস্টল করুন',
		'Install modules Addons' => 'মডিউল অ্যাডঅনস ইনস্টল করুন',
		'Install demonstration data' => 'ডেমনেসট্রেসন তথ্য ইনস্টল করুন',
		...
		'Files' => 'ফাইল',
		'All files are not successfuly uploaded on your server' => 'সব ফাইল সফলতার সাথে আপনার সার্ভারে আপলোড করা যায় নি',
		...
		'PHP register global option is on' => 'পিএইচপি রেজিসটার বিশ্বব্যাপী বিকল্প সক্রিয় ',
		...
		'Must be letters and numbers with at least 8 characters' => 'কমপক্ষে ৮ অক্ষরের অক্ষর এবং সংখ্যায় হতে হবে',
		...
		'By default, the PHP mail() function is used' => 'ডিফল্টরূপে পিএইচপি মেইল ​​() ফাংশন ব্যবহার করা হয়েছে',
		...
		'Discover your store' => 'আপনার দোকান আবিষ্কার করুন',
		...
		'If you have any questions, please visit our <a href="%1$s" target="_blank">documentation</a> and <a href="%2$s" target="_blank">community forum</a>.' => 'যদি আপনার কোন প্রশ্ন থাকে, তাহলে আমাদের <a href="%1$s" target="_blank">documentation</a> and <a href="%2$s" target="_blank">community forum</a>.   অনুগ্রহ করে পরিদর্শন করুন',
		...
		'The installation of PrestaShop is quick and easy. In just a few moments, you will become part of a community consisting of more than 150,000 merchants. You are on the way to creating your own unique online store that you can manage easily every day.' => 'PrestaShop ইনস্টলেশনের দ্রুত এবং সহজ।মাত্র কয়েক মুহূর্তের মধ্যে, আপনি আরও ১৫০০০০ ব্যাবসায়ি নিয়ে গঠিত একটি কমিউনিটির অংশ হয়ে যাবেন।আপনি প্রতিদিন সহজে পরিচালনা করতে পারবেন এমন একটি আপনার নিজের অনন্য অনলাইন দোকান নির্মাণ করতে যাচ্ছেন',
		'If you need help, do not hesitate to check <a href="%1$s" target="_blank">our documentation</a> or to contact our support team: %2$s' => 'যদি আপনার সাহায্যের প্রয়োজন হলে, <a href="%1$s" target="_blank">our documentation</a>চেক করতে বিব্রত বোধ করবেন না অথবা আমাদের সহায়ক দলের সাথে যোগাযোগ করুন: %2$s ',
