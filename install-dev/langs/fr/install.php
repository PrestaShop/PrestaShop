...
return array (
  ...
  array (
    ...
    'All information collected is subject to data processing and statistics. Your personal data may be communicated to service providers and partners. Under the current "Act on Data Processing, Data Files and Individual Liberties" you have the right to access, rectify and oppose to the processing of your personal data, by sending an email to: information@prestashop.com. If you don\'t want to receive the newsletter you can use the unsubscribing link in the newsletter.' => 'Les informations recueillies font l’objet d’un traitement informatique et statistique. Les données pourront être transmises aux prestataires et partenaires. Conformément à la loi « Informatique et libertés » en vigueur, vous bénéficiez d\'un droit d\'accès, de rectification et d\'opposition aux informations qui vous concernent en envoyant un e-mail à information@prestashop.com. Si vous ne souhaitez plus recevoir la newsletter, vous pourrez vous y opposer via le lien de désinscription présent dans celle-ci.'
  ),
);
