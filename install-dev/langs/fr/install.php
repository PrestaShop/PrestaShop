...
return array(
	...
	'translations' => array(
		...
		'Is MySQL support on ?' => 'MySQL est installé ?',
		...
		'Drop existing tables (dev mode):' => 'Supprimer les tables (dev mode) :',
		...
		'Database server not found. Please verify the login, password and server fields' => 'Impossible de se connecter au serveur de la base de données. Vérifiez vos identifiants de connexion',
		...
		'InnoDB engine is not supported by your MySQL server, please use MyISAM' => 'Le moteur innoDB n\'est pas supporté par votre serveur SQL, merci d\'utiliser MyISAM',
