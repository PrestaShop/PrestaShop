...
return array (
  ...
  array (
    ...
    '"%s" must be an instane of "InstallXmlLoader"' => '"%s" må være en instans av ""InstallXmlLoader"',
    ...
    'menu_configure' => 'Lagre informasjon',
    ...
    'PrestaShop requires at least 32M of memory to run, please check the memory_limit directive in php.ini or contact your host provider' => 'PrestaShop krever minimum 32M minne for å kunne kjøre. Vennligst kontroller memory_limit i din php.ini, eller ta kontakt med din webhotell-leverandør',
    ...
    'The installation of PrestaShop is quick and easy. In just a few moments, you will become part of a community consisting of more than 165,000 merchants. You are on the way to creating your own unique online store that you can manage easily every day.' => 'Installasjonen av PrestaShop er kjapp og enkel. Om noen få øyeblikk vil du bli en del av et samfunn av mer enn 165.000 forhandlere. Du er nå på vei til å ha din egen, unike butikk, som du enkelt kan kontrollere hver dag.',
