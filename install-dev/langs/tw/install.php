...
return array(
	...
	'translations' => array(
		...
		'To use PrestaShop, you must <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop" target="_blank">create a database</a> to collect all of your store\'s data-related activities.' => '要使用 PrestaShop ，您必須 <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop" target="_blank">建立一個資料庫</a> 來儲存商店的活動相關資料',
		...
		'To use PrestaShop, you must <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop#InstallingPrestaShop-Creatingadatabaseforyourshop" target="_blank">create a database</a> to collect all of your store\'s data-related activities.' => '要使用 PrestaShop ，您必須 <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop#InstallingPrestaShop-Creatingadatabaseforyourshop" target="_blank">建立一個資料庫</a> 來儲存商店的資料與相關操作',
