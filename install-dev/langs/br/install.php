...
return array(
	...
	'translations' => array(
		...
		'Is MySQL support on ?' => 'MySQL está instalado ?',
		...
		'Drop existing tables (dev mode):' => 'Exclua as tabelas existentes (dev mode) :',
		...
		'Database server not found. Please verify the login, password and server fields' => 'O servidor do banco de dados não foi encontrado. Por favor, verifique os campos de identificação, senha e servidor',
		...
		'InnoDB engine is not supported by your MySQL server, please use MyISAM' => 'O mecanismo innoDB não é aceito pelo seu servidor SQL, por favor use MyISAM',
