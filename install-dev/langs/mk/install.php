...
return array (
  ...
  'translations' => 
  array (
    'An SQL error occured for entity <i>%1$s</i>: <i>%2$s</i>' => 'се појави грешка во базата SQL <i>%1$s</i>:<i>%2$s</i>',
    ...
    'Files' => 'датотеки',
    'All files are not successfuly uploaded on your server' => 'сите датотеки не се успешно кренати на серверот',
    ...
    'PHP register global option is on' => 'PHP регистар за глобални опции вклучен',
    ...
    '"%s" must be an instane of "InstallXmlLoader"' => '“%s“ мода да корелира со "InstallXmlLoader"',
    ...
    'To use PrestaShop, you must <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop#InstallingPrestaShop-Creatingadatabaseforyourshop" target="_blank">create a database</a> to collect all of your store\'s data-related activities.' => 'да го користиш PrestaShop, мора да <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop#InstallingPrestaShop-Creatingadatabaseforyourshop" target="_blank">направи база</a>да гисобере сите податоци од работата на продавницата и активностите во неа.',
    ...
    'menu_configure' => 'Информации за складирање',
    ...
    'PrestaShop requires at least 32M of memory to run, please check the memory_limit directive in php.ini or contact your host provider' => 'PrestaShop бара барем 32Мб меморија за да работи, проверете ја меморијата и лимитот на php.ini или контактирајте го вашиот хостинг провајдер',
    '<b>Warning: You cannot use anymore this tool to upgrade your store.</b><br /><br />You already have <b>PrestaShop version %1$s installed</b>.<br /><br />If you want to upgrade to the latest version please read our documentation: <a href="%2$s">%2$s</a>' => '<b>Предѕпредување:Неможе повеќе да ја користите оваа алатка за надградба.<br />веќе имате<b>PrestaShop верзија%1$sинсталирано</b>.<br /> ако сакате да надградете до последната верзија ве молиме прочитајте ја внимателно доукментацијата:<a href="%2$s">',
    'Welcome to the PrestaShop %s Installer' => 'Добредојдовте во PrestaShop%s инсталацијата',
    'The installation of PrestaShop is quick and easy. In just a few moments, you will become part of a community consisting of more than 150,000 merchants. You are on the way to creating your own unique online store that you can manage easily every day.' => 'инсталацијата е брза и лесна. За само неколку моменти ќе станете дел од заедницата која има повеќе од 150,000 корисници. На пат сте да креирате уникатна онлајн продавница која ќе можете да ја одржувате брзо и лесно секојдневно.',
