...
',
  ...
  array (
    ...
    '"%s" must be an instane of "InstallXmlLoader"' => '"%s" 应为一个 "InstallXmlLoader" 实例',
    ...
    'The installation of PrestaShop is quick and easy. In just a few moments, you will become part of a community consisting of more than 165,000 merchants. You are on the way to creating your own unique online store that you can manage easily every day.' => 'Prestashop 的安装快速而简单。在短短的几分钟，你就会成为一个拥有超过165,000位商人社区的一份子。在创建您独特的网上商店途中，您可以很容易地每天管理它。',
