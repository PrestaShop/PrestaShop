<?php return array (
  ...
  array (
    ...
    'You have to create a database, help available in <a href="langs/%1$s/README.txt" target="_blank">~/install/langs/%1$s/README.txt</a>' => 'Sie müssen zunächst eine Datenbank erstellen. Hilfe finden Sie unter <a href="langs/%1$s/README.txt" target="_blank">~/install/langs/%1$s/README.txt</a>',
    'You have to create a database, help available in <a href="README.txt" target="_blank">~/install/README.txt</a>' => 'Sie müssen zunächst eine Datenbank erstellen. Hilfe finden Sie unter <a href="README.txt" target="_blank">~/install/README.txt</a>',
