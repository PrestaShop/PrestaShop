<?php return array (
  ...
  array (
    ...
    'Is MySQL support on ?' => 'Ist MySQL-Support aktiviert ?',
    ...
    'Drop existing tables (dev mode):' => 'Vorhandene Tabellen löschen',
    ...
    'If you have any questions, please visit our <a href="%1$s" target="_blank">documentation</a> and <a href="%2$s" target="_blank">community forum</a>.' => 'Bei Fragen nutzen Sie bitte unsere <a href="%1$s" target="_blank">Dokumentation</a> oder <a href="%2$s" target="_blank">Community Forum</a>.',
	 'Test message from PrestaShop' => 'Test-Mail - PrestaShop Installation',
	  ...
	  'Database server not found. Please verify the login, password and server fields' => 'Dantenbakserver nicht gefunden. Bitte überprüfen Sie Ihre Zugangsdaten',
	  'Connection to MySQL server succeeded, but database "%s" not found' => 'Datenbankserver gefunden, aber Datenbank nicht vorhanden',
	  'InnoDB engine is not supported by your MySQL server, please use MyISAM' => 'innoDB Engine wird vom Ihren Server nicht unterstützt. Bitte wählen Sie MyISAM',
