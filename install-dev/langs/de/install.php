...
return array (
  ...
  array (
    ...
    'All information collected is subject to data processing and statistics. Your personal data may be communicated to service providers and partners. Under the current "Act on Data Processing, Data Files and Individual Liberties" you have the right to access, rectify and oppose to the processing of your personal data, by sending an email to: information@prestashop.com. If you don\'t want to receive the newsletter you can use the unsubscribing link in the newsletter.' => 'Alle erfassten Daten unterliegen der Verarbeitung und statistischen Auswertung. Ihre personenbezogenen Daten können an Dienstleister und Partner übermittelt werden. Nach dem geltenden „Gesetz zur Verarbeitung von Daten, über Dateien und zu den persönlichen Freiheiten“ haben Sie das Recht auf Auskunft, Berichtigung und Widerspruch gegen die Verarbeitung Ihrer personenbezogenen Daten, indem Sie eine E-Mail an folgende Adresse senden: information@prestashop.com. Wenn Sie den Newsletter nicht erhalten möchten, können Sie den Abmelde-Link im Newsletter benutzen.'
  ),
);
