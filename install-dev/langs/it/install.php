...
return array (
  ...
  array (
    ...
    'All information collected is subject to data processing and statistics. Your personal data may be communicated to service providers and partners. Under the current "Act on Data Processing, Data Files and Individual Liberties" you have the right to access, rectify and oppose to the processing of your personal data, by sending an email to: information@prestashop.com. If you don\'t want to receive the newsletter you can use the unsubscribing link in the newsletter.' => 'Tutti i dati raccolti sono soggetti a procedure di elaborazione e statistica. I dati personali dell\'utente potrebbero essere divulgati a partner e fornitori di servizi. In ottemperanza alla vigente legge relativa all\'informatica, ai file e alle libertà, l\'utente può esercitare il proprio diritto di accesso, rettifica e opposizione all\'utilizzo dei dati personali inviando una mail all\'indirizzo: information@prestashop.com. Per non ricevere più la newsletter, è possibile disiscriversi utilizzando l\'apposito link contenuto nella stessa.'
  ),
);
