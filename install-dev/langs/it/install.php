<?php return array (
  ...
  array (
    ...
    'Is MySQL support on ?' => 'Il supporto MySQL è su on?',
    ...
    'Drop existing tables (dev mode):' => 'Cancella le tabelle esistenti (DEV modalità)',
	...
	'Test message from PrestaShop' => 'Installazione di Prestashop - prova del server di e-mail',
	  ...
	  'Database server not found. Please verify the login, password and server fields' => 'Server Database non trovato. Per favore verifica login, password e il campo server',
	  ...
	  'InnoDB engine is not supported by your MySQL server, please use MyISAM' => 'InnoDB non è supportato dal tuo server MySQL, per favore utilizza MyISAM',
