...
return array (
  ...
  array (
    ...
    'All information collected is subject to data processing and statistics. Your personal data may be communicated to service providers and partners. Under the current "Act on Data Processing, Data Files and Individual Liberties" you have the right to access, rectify and oppose to the processing of your personal data, by sending an email to: information@prestashop.com. If you don\'t want to receive the newsletter you can use the unsubscribing link in the newsletter.' => 'Wszelkie zebrane przez nas informacje zostaną przetworzone i wykorzystane w celach statystycznych. Twoje dane osobowe mogą zostać przekazane usługodawcom i partnerom. Na mocy obecnej ustawy o przetwarzaniu danych, bazach danych i swobodach obywatelskich, masz prawo do uzyskania dostępu, zmiany oraz wniesienia sprzeciwu wobec przetwarzania Twoich danych osobowych wysyłając email na adres: information@prestashop.com. Jeśli nie chcesz otrzymywać newslettera, możesz wykorzystać zawarty w nim link rezygnacji z subskrypcji.'
  ),
);
