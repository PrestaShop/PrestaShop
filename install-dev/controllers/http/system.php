            ...
            'required' => array(
                ...
                array(
                    ...
                    'checks' => array(
                        ...
                        'cache_dir' => $this->l('Recursive write permissions for %1$s user on %2$s', $user, '~/app/cache/'),
                        'log_dir' => $this->l('Recursive write permissions for %1$s user on %2$s', $user, '~/app/logs/'),
