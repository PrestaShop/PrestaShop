	...
	<div id="formCheckSQL">
		...
		<p>
			...
			<select id="dbEngine" name="dbEngine">
				<option value="InnoDB" <?php if ($this->database_engine == 'InnoDB') { ?>selected="selected"<?php } ?>>InnoDB</option>
				<option value="MyISAM" <?php if ($this->database_engine == 'MyISAM') { ?>selected="selected"<?php } ?>>MyISAM</option>
			</select>
		</p>-->
		<p>
