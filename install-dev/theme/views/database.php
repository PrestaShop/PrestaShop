...
<div id="dbPart">
	...
	<p>
		<?php echo $this->translator->trans('To use PrestaShop, you must <a href="http://doc.prestashop.com/display/PS16/Installing+PrestaShop#InstallingPrestaShop-Creatingadatabaseforyourshop" target="_blank">create a database</a> to collect all of your store\'s data-related activities.', [], 'Install'); ?>
		<br />
	...
	<div id="formCheckSQL">
		...
		<!--
		<p>
			<label for="dbEngine"><?php echo $this->translator->trans('Database Engine', [], 'Install'); ?></label>
		...
		<?php if (_PS_MODE_DEV_): ?>
			<p>
				<label for="db_clear"><?php echo $this->translator->trans('Drop existing tables (mode dev)', [], 'Install'); ?></label>
