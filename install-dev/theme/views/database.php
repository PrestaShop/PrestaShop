...
<div id="dbPart">
	...
	<p>
		<?php echo $this->translator->trans('To use PrestaShop, you must <a href="https://devdocs.prestashop.com/1.7/basics/installation/localhost/#creating-a-database-for-your-shop" target="_blank">create a database</a> to collect all of your store\'s data-related activities.', array(), 'Install'); ?>
		<br />
