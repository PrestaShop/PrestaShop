...
<div>
	...
	<div style="float:left;width:600px;margin-left:8px"><label for="set_license"><strong><?php echo $this->translator->trans('I agree to the above terms and conditions.', [], 'Install'); ?></strong></label></div>
	<!--
	<br />
	...
	<div style="float:left;width:600px;margin-left:8px"><label for="configuration_agrement"><strong><?php echo $this->translator->trans('I agree to participate in improving the solution by sending anonymous information about my configuration.', [], 'Install'); ?></strong></label></div>
	-->
</div>
