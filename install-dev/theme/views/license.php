...
<div>
	<input type="checkbox" id="set_license" class="required" name="licence_agrement" value="1" style="vertical-align: middle;float:left" <?php if ($this->session->licence_agrement) {
     ?>checked="checked"<?php
 } ?> />
	...
	<!--
	<br />
	<input type="checkbox" id="configuration_agrement" name="configuration_agrement" value="1" style="vertical-align: middle;float:left" <?php if ($this->session->configuration_agrement) {
     ?>checked="checked"<?php
 } ?> />
