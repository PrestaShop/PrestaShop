...
<div id="infosShopBlock">
	...
	<div class="field clearfix">
		...
		<div class="contentinput">
			<label>
				<input value="full" type="radio" name="db_mode" style="vertical-align: middle;" <?php if ('full' == $this->install_type): ?>checked="checked"<?php endif; ?> autocomplete="off" />
				<?php echo $this->translator->trans('Yes', array(), 'Install'); ?>
			</label>
			<label>
				<input value="lite" type="radio" name="db_mode" style="vertical-align: middle;" <?php if ('lite' == $this->install_type): ?>checked="checked"<?php endif; ?> autocomplete="off" />
	...
	<!-- Timezone list -->
	<div id="timezone_div" class="field clearfix" <?php if (!in_array($this->session->shop_timezone, array('us', 'ca', 'au', 'ru', 'me', 'id'), true)) {
