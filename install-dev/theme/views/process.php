...
<div id="install_process_success">
	<div class="clearfix">
		...
		<h3 class="infosBlock">
			...
			<a href="<?php echo $this->translator->trans('http://doc.prestashop.com/display/PS17/Installing+PrestaShop#InstallingPrestaShop-Completingtheinstallation', [], 'Install') ?>" target="_blank"><img src="theme/img/help.png" /></a>
		</h3>
	...
	<div class="sharing">
		<p><?php echo $this->translator->trans('Share your experience with your friends!', [], 'Install'); ?></p>
		<button type="button" class="btn-twitter" onclick="psinstall_twitter_click('<?php echo $this->translator->trans('I just built an online store with PrestaShop!', [], 'Install'); ?> <?php echo $this->translator->trans('Watch this exhilarating experience: http://vimeo.com/89298199', [], 'Install'); ?>');">
			<i></i> <?php echo $this->translator->trans('Tweet', [], 'Install'); ?>
		</button>
		<button type="button" class="btn-facebook" onclick="psinstall_facebook_click();">
			<i></i> <?php echo $this->translator->trans('Share', [], 'Install'); ?>
		</button>
		<button type="button" class="btn-google-plus" onclick="psinstall_google_click();">
			<i></i> <?php echo $this->translator->trans('Google+', [], 'Install'); ?>
		</button>
		<button type="button" class="btn-pinterest" onclick="psinstall_pinterest_click();">
			<i></i> <?php echo $this->translator->trans('Pinterest', [], 'Install'); ?>
		</button>
		<button type="button" class="btn-linkedin" onclick="psinstall_linkedin_click();">
			<i></i> <?php echo $this->translator->trans('LinkedIn', [], 'Install'); ?>
		</button>
	</div>
</div>
...
<?php if (@fsockopen('addons.prestashop.com', 80, $errno, $errst, 3)): ?>
	<iframe src="https://addons.prestashop.com/psinstall1541.php?version=2&lang=<?php echo $this->language->getLanguageIso() ?>&activity=<?php echo $this->session->shop_activity ?>&country=<?php echo $this->session->shop_country ?>" scrolling="no" id="prestastore">
		<p><a href="https://addons.prestashop.com/" target="_blank"><?php echo $this->translator->trans('Check out PrestaShop Addons to add that little something extra to your store!', [], 'Install'); ?></a></p>
	</iframe>
<?php endif; ?>
