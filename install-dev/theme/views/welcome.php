...
<p><?php echo $this->translator->trans('If you need help, do not hesitate to <a href="%tutoriellink%" target="_blank">watch this short tutorial</a>, or check <a href="%linkdoc%" target="_blank">our documentation</a>.', array('%tutoriellink%' => $this->getTutorialLink(), '%linkdoc%' => $this->getDocumentationLink())) ?></p>

<!-- List of languages -->
<?php if (count($this->language->getIsoList()) > 1): ?>
	<h3><?php echo $this->translator->trans('Continue the installation in:') ?></h3>
...
<p><?php echo $this->translator->trans('The language selection above only applies to the Installation Assistant. Once your store is installed, you can choose the language of your store from over %d% translations, all for free!', array('%d%' => 60)); ?> </p>
