...
<p><?php echo $this->translator->trans('If you have any questions, please visit our <a href="%doc%" target="_blank">documentation</a> and <a href="%forum%" target="_blank">community forum</a>.', array($this->getDocumentationLink(), $this->getForumLink(), 'Install')); ?></p>
