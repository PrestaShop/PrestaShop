...
<?php } else { ?>
	<h3 class="errorBlock"><?php echo $this->translator->trans('Oops! Please correct the item(s) below, and then click "%refresh_label%" to test the compatibility of your new system.', ['%refresh_label%' => $this->translator->trans('Refresh information', [], 'Install')], 'Install'); ?></h3>
<?php } ?>
