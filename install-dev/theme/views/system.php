...
<?php if ($this->tests['required']['success']): ?>
  <h3 class="okBlock">
    <?php echo $this->translator->trans('PrestaShop compatibility with your system environment has been verified!', array(), 'Install'); ?>
  </h3>
<?php else: ?>
  <h3 class="errorBlock">
    <?php echo $this->translator->trans('Oops! Please correct the item(s) below, and then click "%refresh_label%" to test the compatibility of your new system.', array('%refresh_label%' => $this->translator->trans('Refresh information', array(), 'Install')), 'Install'); ?>
  </h3>
<?php endif; ?>
