    ...
    <div class="col-md-6{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
      ...
      {elseif $field.type === 'date'}
        ...
        {block name='form_field_item_date'}
          <input name="{$field.name}" class="form-control" type="date" value="{$field.value}"   {if $field.required}required{/if}  placeholder="{if isset($field.availableValues.placeholder)}{$field.availableValues.placeholder}{/if}">
