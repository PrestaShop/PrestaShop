  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <section class="form-fields">
      <div class="form-group center-email-fields">
        ...
        <button id="send_reset_link" class="form-control-submit btn btn-primary hidden-xs-down" name="submit" type="submit">
...
{block name='page_footer'}
  <a id="back_to_login" href="{$urls.pages.my_account}" class="account-link">
