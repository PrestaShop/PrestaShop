{if $product.show_price}
  <div class="product-prices">
    ...
    {block name='product_unit_price'}
      {if $displayUnitPrice}
        <p class="product-unit-price"{hook h='displayProductPriceBlock' product=$product type="unit_price" returntype="style"}>{convertPrice price=$unit_price} {l s='per %s' sprintf=$product.unity}</p>
