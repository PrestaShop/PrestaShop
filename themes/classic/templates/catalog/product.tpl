            ...
            {block name='page_content'}
              ...
              <div class="images-container">
                {block name='product_cover'}
                  <div class="product-cover _margin-bottom-medium">
                      <img class="_shadow" src="{$product.cover.large.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" width="452" itemprop="image" />
                  </div>
                {/block}
                ...
                {block name='product_images'}
                  <ul class="product-images">
                    {foreach from=$product.images item=image}
                      <li class="_margin-right-small"><img class="_shadow _margin-bottom-small" src="{$image.medium.url}" alt="{$image.legend}" title="{$image.legend}" width="100" itemprop="image" /></li>
                    {/foreach}
                  </ul>
                {/block}
              </div>
