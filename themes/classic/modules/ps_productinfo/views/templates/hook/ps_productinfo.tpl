...
*}
<div id="module-productinfo" class="m-t-1">
    {if isset($vars_nb_people)}
        <p>
            {if $vars_nb_people['%nb_people%'] == 1}
                {l s='%nb_people% person is currently watching this product.' sprintf=$vars_nb_people d='Shop.Theme.Catalog'}
            {else}
                {l s='%d people are currently watching this product.' sprintf=$vars_nb_people d='Shop.Theme.Catalog'}
            {/if}
        </p>
    {/if}
