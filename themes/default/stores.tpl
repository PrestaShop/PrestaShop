...
{if $simplifiedStoresDiplay}
	...
	{foreach $stores as $store}
		<div class="store-small grid_2">
			...
			<p>
				<b>{$store.name|escape:'html':'UTF-8'}</b><br />
				{$store.address1|escape:'html':'UTF-8'}<br />
				{if $store.address2}{$store.address2|escape:'html':'UTF-8'}{/if}<br />
				{$store.postcode} {$store.city|escape:'html':'UTF-8'}{if $store.state}, {$store.state}{/if}<br />
				{$store.country|escape:'html':'UTF-8'}<br />
