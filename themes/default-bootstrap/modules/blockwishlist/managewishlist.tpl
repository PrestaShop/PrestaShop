...
{if $products}
	{if !$refresh}
		<div class="wishlistLinkTop">
			...
			rel="nofollow"
			title="{l s='Close send this wishlist' mod='blockwishlist'}">
			...
			<ul class="clearfix display_list">
				<li>
					...
					title="{l s='Hide products' mod='blockwishlist'}">
					...
					href="#" 
					onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" 
					title="{l s='Show products' mod='blockwishlist'}">
			...
			<p class="wishlisturl form-group">
				...
				<input type="text" class="form-control" value="{$base_dir_ssl}modules/blockwishlist/view.php?token={$token_wish|escape:'html':'UTF-8'}" readonly="readonly" />
			</p>
			<p class="submit">
				<a 
				id="showSendWishlist" 
				...
				title="{l s='Send this wishlist' mod='blockwishlist'}">
					...
					<div class="col-xs-6 col-sm-12">
						<div class="product_infos">
							...
							<div class="btn_action">
								...
								class="btn btn-default button button-small" 
								href="javascript:;" 
								onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" 
								title="{l s='Save' mod='blockwishlist'}">
	...
	{if !$refresh}
		<form method="post" class="wl_send box unvisible" onsubmit="return (false);">
			<fieldset>
				...
				{/section}
				<div class="submit">
					<button class="btn btn-default button button-small" type="submit" name="submitWishlist" onclick="WishlistSend('wl_send', '{$id_wishlist}', 'email');">
