...
*}
<div class="row">
<div class="col-xs-12 {if !$hide_left_column && !$hide_right_column}col-md-6{else if !$hide_left_column || !$hide_right_column}col-md-8{else}col-md-12{/if}">        <p class="payment_module">
            <a
            class="bankwire"
