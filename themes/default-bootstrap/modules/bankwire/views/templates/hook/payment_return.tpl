...
{if $status == 'ok'}
	<p class="alert alert-success">
		{l s='Congratulation!' mod='bankwire'} {l s='Your order' mod='bankwire'} {if !isset($reference)}{l s='#' mod='bankwire'}{$id_order}{else}{$reference}{/if} {l s='with amount' mod='bankwire'} {$total_to_pay} {l s='is successfully complete.' mod='bankwire'}
	</p>
