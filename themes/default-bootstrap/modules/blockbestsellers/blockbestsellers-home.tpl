...
*}
{assign var="class" value="blockbestsellers tab-pane"}
{assign var="id" value="blockbestsellers"}
{if isset($products) && $products}
	...
	{if isset($number_of_product_display) && $number_of_product_display}
	{foreach from=$products item=product name=products}
	{if $i lt $number_of_product_display}
