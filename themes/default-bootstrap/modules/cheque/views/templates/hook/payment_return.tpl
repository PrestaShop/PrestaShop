...
{if $status == 'ok'}
<p class="alert alert-success">{l s='Congratulation!' mod='cheque'} {l s='Your order' mod='cheque'} {if !isset($reference)}{l s='#' mod='cheque'}{$id_order}{else}{$reference}{/if} {l s='with amount' mod='cheque'} {$total_to_pay} {l s='is successfully complete.' mod='cheque'}</p>
...
{else}
	<p class="alert alert-warning">
		...
		<a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team' mod='cheque'}</a>.
	</p>
{/if}
