...
{/if}
		{$HOOK_HEADER}
		<link rel="stylesheet" href="http{if Tools::usingSecureMode()}s{/if}://fonts.googleapis.com/css?family=Open+Sans:300,400,700&subset=latin,latin-ext" type="text/css" media="all" />
		<!--[if IE 8]>
