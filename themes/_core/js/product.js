    ...
    function updateProductRequest() {
      ...
      currentRequest = $.ajax({
        ...
        success(data, textStatus, errorThrown) {
          ...
          $('.quickview .product-prices, .page-product:not(.modal-open) .row .product-prices').replaceWith(
            data.product_prices
          );
          $(
          ...
          $('.quickview .product-variants, .page-product:not(.modal-open) .row .product-variants').replaceWith(
            data.product_variants
          );
          $('.quickview .product-discounts, .page-product:not(.modal-open) .row .product-discounts').replaceWith(
          ...
          $('.quickview .product-flags, .page-product:not(.modal-open) .row .product-flags').replaceWith(
            data.product_flags
          );
