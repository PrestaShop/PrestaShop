  ...
  currentRequestDelayedId = setTimeout(function updateProductRequest() {
    ...
    currentRequest = $.ajax({
      ...
      success(data, textStatus, errorThrown) {
        ...
        $('.quickview .product-prices, .page-product:not(.modal-open) .product-prices').replaceWith(data.product_prices);
        $('.quickview .product-customization, .page-product:not(.modal-open) .product-customization').replaceWith(data.product_customization);
        $('.quickview .product-variants, .page-product:not(.modal-open) .product-variants').replaceWith(data.product_variants);
        $('.quickview .product-discounts, .page-product:not(.modal-open) .product-discounts').replaceWith(data.product_discounts);
        $('.quickview .product-additional-info, .page-product:not(.modal-open) .product-additional-info').replaceWith(data.product_additional_info);
        $('.quickview #product-details, #product-details').replaceWith(data.product_details);
        $('.quickview .product-flags, .page-product:not(.modal-open) .product-flags').replaceWith(data.product_flags)
