...
<div id="idTab5">
	...
	{if $comments}
		{foreach from=$comments item=comment}
			{if $comment.content}
			<div class="comment bordercolor clearfix">
	...
	<div id="new_comment_form">
		<form action="#">
			...
			<div class="product clearfix">
				<img src="{$link->getImageLink($product->link_rewrite, $productcomment_cover, 'home_default')}" alt="{$product->name|escape:html:'UTF-8'}" />
