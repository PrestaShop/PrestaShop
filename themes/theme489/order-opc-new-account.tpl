<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")}" method="post" id="login_form" class="std">
		<fieldset>
			...
			<div id="login_form_content" style="display:none;" class="clearfix">
				<!-- Error return block -->
				...
				<div>
					...
					<br /><a href="{$link->getPageLink('password', true)}" class="lost_password">{l s='Forgot your password?'}</a>
				</div>
				<p class="submit">
	...
	<form action="javascript:;" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			...
			<div id="opc_account_choice" class="clearfix">
				<div class="opc_float opc_float_left bordercolor">
					<div>
				...
				<div class="opc_float opc_float_right bordercolor">
					<div>
