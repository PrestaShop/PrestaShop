$(document).ready(function () {
	...
	$(".notifs").live("click", function () {
		...
		$.post("ajax.php", {
			...
			"updateElementEmployeeType" : type[0]
		}, function (data) {
			if (data) {
	...
	$.post("ajax.php", {
		...
		if (data) {
			...
			$.each(json.order, function (property, value) {
				html += "<li>" + new_order_msg + "<br />" + order_number_msg + "<strong>#" + parseInt(value.id_order, 10) + "</strong><br />" + total_msg + "<strong>" + value.total_paid + "</strong><br />" + from_msg + "<strong>" + value.customer_name + "</strong><br /><a href=\"index.php?tab=AdminOrders&token=" + token_admin_orders + "&vieworder&id_order=" + parseInt(value.id_order, 10) + "\">" + see_order_msg + "</a></li>";
			});
			if (html !== "") {
			...
			$.each(json.customer, function (property, value) {
				html += "<li>" + new_customer_msg + "<br />" + customer_name_msg + "<strong>" + value.customer_name + "</strong><br /><a href=\"index.php?tab=AdminCustomers&token=" + token_admin_customers + "&viewcustomer&id_customer=" + parseInt(value.id_customer, 10) + "\">" + see_customer_msg + "</a></li>";
			});
			if (html !== "") {
			...
			$.each(json.customer_message, function (property, value) {
				html += "<li>" + new_msg + "<br />" + from_msg + "<strong>" + value.customer_name + "</strong><br /><a href=\"index.php?tab=AdminCustomerThreads&token=" + token_admin_customer_threads + "&viewcustomer_thread&id_customer_thread=" + parseInt(value.id_customer_thread, 10) + "\">" + see_msg + "</a></li>";
			});
