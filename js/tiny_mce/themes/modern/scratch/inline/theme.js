...
jsc*/
defineGlobal("1", tinymce.Env);
defineGlobal("2", tinymce.EditorManager);
defineGlobal("3", tinymce.ThemeManager);
defineGlobal("8", tinymce.util.Tools);
defineGlobal("9", tinymce.ui.Factory);
defineGlobal("a", tinymce.DOM);
/**
 * Toolbar.js
 *
...
defineGlobal("j", tinymce.util.Delay);
defineGlobal("k", tinymce.geom.Rect);
/**
 * ContextToolbars.js
 *
 * Released under LGPL License.
...
defineGlobal("h", tinymce.ui.FloatPanel);
/**
 * Inline.js
 *
 * Released under LGPL License.
...
defineGlobal("i", tinymce.ui.Throbber);
/**
 * ProgressState.js
 *
 * Released under LGPL License.
