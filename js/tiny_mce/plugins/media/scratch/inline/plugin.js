...
defineGlobal("e", tinymce.util.Tools);
defineGlobal("9", tinymce.html.SaxParser);
defineGlobal("a", tinymce.html.Schema);
defineGlobal("b", tinymce.dom.DOMUtils.DOM);
define("h", [
], function () {
...
defineGlobal("8", tinymce.html.Writer);
define("4", [
	"8",
	"9",
	"a",
...
defineGlobal("k", tinymce.util.Promise);
define("d", [
	"j",
	"k"
...
defineGlobal("i", tinymce.html.Node);
define("5", [
	"3",
	"h",
	"i",
