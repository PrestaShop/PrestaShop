...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.media.Plugin", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.ui.Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.Sanitize", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.UpdateHtml", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.Nodes", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Delay", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.HtmlToData", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.html.Writer", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.html.SaxParser", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.html.Schema", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.DOMUtils.DOM", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.Size", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.Service", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.Env", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.ui.SizeManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.VideoScript", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.html.Node", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.DataToHtml", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Promise", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.Mime", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.media.core.UrlPatterns", ".", mapper.constant("plugin"))
    ]
  });
