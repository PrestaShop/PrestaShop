...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.lists.Plugin", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.lists.core.NodeType", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.Delete", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.actions.Indent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.actions.Outdent", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.actions.ToggleList", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.TreeWalker", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.RangeUtils", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.Selection", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.Bookmark", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.Range", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.NormalizeLists", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.BookmarkManager", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.SplitList", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.DOMUtils.DOM", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.lists.core.TextBlock", ".", mapper.constant("plugin")),
