...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce/imagetoolsplugin/Plugin", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.PluginManager", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.Env", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Promise", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.URI", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Tools", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Delay", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/api/ImageTransformations", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/api/BlobConversions", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/Dialog", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/ImageSize", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/Proxy", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/transformations/Filters", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/transformations/ImageTools", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/util/Conversions", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.DOMUtils", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.ui.Factory", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.ui.Form", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.ui.Container", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/ImagePanel", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/UndoStack", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/Utils", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/util/Canvas", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/util/ImageSize", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/util/Promise", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/util/Mime", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/transformations/ColorMatrix", ".", mapper.constant("plugin")),
      source("bolt", "ephox/imagetools/transformations/ImageResizerCanvas", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.ui.Control", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.ui.DragHelper", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.geom.Rect", ".", mapper.constant("plugin")),
      source("bolt", "tinymce/imagetoolsplugin/CropRect", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.dom.DomQuery", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.Observable", ".", mapper.constant("plugin")),
      source("bolt", "global!tinymce.util.VK", ".", mapper.constant("plugin"))
    ]
  });
