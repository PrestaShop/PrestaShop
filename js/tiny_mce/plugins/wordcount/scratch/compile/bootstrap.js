...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.wordcount.Plugin", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.wordcount.text.WordGetter", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.wordcount.text.UnicodeData", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.wordcount.text.StringMapper", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.wordcount.text.WordBoundary", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.wordcount.alien.Arr", ".", mapper.constant("plugin"))
    ]
  });
