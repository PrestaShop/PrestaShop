...
qq.obj2url = function(obj, temp, prefixDone) {
            ...
            if (nextTemp != 'undefined' && i != 'undefined') {
                uristrings.push(
                    typeof nextObj === 'object'
                        ...
                        : Object.prototype.toString.call(nextObj) ===
                          '[object Function]'
    ...
    if (!prefixDone && temp) {
        ...
        uristrings.push(
            encodeURIComponent(temp) + '=' + encodeURIComponent(obj),
        );
    }
...
qq.FileUploaderBasic.prototype = {
    ...
    _createUploadButton: function(element) {
        ...
        return new qq.UploadButton({
            element: element,
            multiple:
                this._options.multiple && qq.UploadHandlerXhr.isSupported(),
...
qq.FileUploader = function(o) {
    ...
    this._button = this._createUploadButton(
        this._find(this._element, 'button'),
    );
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _upload: function(id, params) {
        ...
        if (!input) {
            throw new Error(
                'file with passed id was not added, or already uploaded or canceled',
            );
        }
