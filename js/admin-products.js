...
product_tabs.Customization = function () {
	'use strict';
...
product_tabs.Combinations = function () {
	'use strict';
	var self = this;
		...
		function editProductAttribute(url, parent) {
			$.ajax({
				...
				success : function (data) {
					...
					$.scrollTo('#add_new_combination', 1200, {
						offset : -100
					});
					...
					var calcImpactPriceTI = data[0].calcImpactPriceTI;
...
product_tabs.Associations = function () {
	'use strict';
	var self = this;
	...
	this.delAccessory = function (id) {
		...
		// @TODO: The body of a for in should be wrapped in an if statement to filter unwanted properties from the prototype
...
product_tabs.Attachments = function () {
	'use strict';
	var self = this;
...
product_tabs.Informations = function () {
	'use strict';
	var self = this;
...
product_tabs.Features = function () {
	'use strict';
	this.onReady = function () {
		displayFlags(languages, id_language, allowEmployeeFormLang);
	};
...
product_tabs.Quantities = function () {
	'use strict';
	var self = this;
	...
	this.onReady = function () {
		...
		$('.advanced_stock_management').click(function (e) {
			...
			self.ajaxCall({
				actionQty : 'advanced_stock_management',
				value : val
			});
			if (val === 1) {
				$(this).val(1);
		...
		$('.available_quantity').find('input').change(function (e, init_val) {
			self.ajaxCall({
				actionQty : 'set_qty',
				id_product_attribute : $(this).parent().attr('id').split('_')[1],
				value : $(this).val()
			});
		});
...
product_tabs.Suppliers = function () {
	'use strict';
	var self = this;
...
product_tabs.VirtualProduct = function () {
	'use strict';
	var self = this;
...
product_tabs.Warehouses = function () {
	'use strict';
	var self = this;
