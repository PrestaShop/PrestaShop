...
You also need to have the right PHP and Node.js versions. Read the [documentation about system requirements](https://devdocs.prestashop-project.org/8/basics/installation/system-requirements/) to find which versions you need. Make sure you are reading the page for the right version.
