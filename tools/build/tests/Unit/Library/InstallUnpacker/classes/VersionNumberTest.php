...
class VersionNumberTest extends TestCase
{
    public function testConstruct()
    {
        ...
        $this->assertSame(1.7, $number->getMajor());
        $this->assertSame(2, $number->getMinor());
        $this->assertSame(3, $number->getPatch());
    }
    ...
    public function testToString()
    {
        ...
        $this->assertSame('1.6.1.21', $number->__toString());
    }
    ...
    public function testCompareSameVersions()
    {
        ...
        $this->assertSame(0, $number1->compare($number2));
    }
