...
class bankwire extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->version = '2.0.0';
        // Very important the first \ is important to be kept for test purposes (despite what CS fixer wants to modify)
        $this->ps_versions_compliancy = ['min' => '1.7', 'max' => \PrestaShop\PrestaShop\Core\Version::VERSION];
