...
class MailsBodyProviderTest extends TestCase
{
    ...
    {
        self::$tempDir = implode(DIRECTORY_SEPARATOR, [sys_get_temp_dir(), 'MailsBodyProviderTest']);

        // Default catalogue
        $catalogue = new MessageCatalogue(MailsBodyProvider::DEFAULT_LOCALE);
        ...
        (new XliffFileDumper())->dump($catalogue, [
            'path' => self::$tempDir . DIRECTORY_SEPARATOR . MailsBodyProvider::DEFAULT_LOCALE,
        ]);
    ...
    {
        $catalogue = (new MailsBodyProvider(
