...
class OthersProviderTest extends TestCase
{
    ...
    {
        self::$tempDir = implode(DIRECTORY_SEPARATOR, [sys_get_temp_dir(), 'OthersProviderTest']);

        // Default catalogue
        $catalogue = new MessageCatalogue(OthersProvider::DEFAULT_LOCALE);
        ...
        (new XliffFileDumper())->dump($catalogue, [
            'path' => self::$tempDir . DIRECTORY_SEPARATOR . OthersProvider::DEFAULT_LOCALE,
        ]);
