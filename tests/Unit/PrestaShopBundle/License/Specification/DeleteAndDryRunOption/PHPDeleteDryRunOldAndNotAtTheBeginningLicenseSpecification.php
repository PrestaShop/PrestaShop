...
namespace Tests\Unit\PrestaShopBundle\License\Specification\DeleteAndDryRunOption;
...
class PHPDeleteDryRunOldAndNotAtTheBeginningLicenseSpecification extends AbstractDeleteAndDryRunSpecification
{
    protected function getActualContent(): string
    {
        return '<?php
/**
 * Old license to remove 1
 */
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 ...
 */
/**
 * Old license to remove 2
 */
declare(strict_types=1);

namespace Tests\Unit\PrestaShopBundle\License;

class PHPDeleteDryRunLicenseSpecification
{
...
';
    ...
    public function assertLogging(SpyAddLicensesLogger $spyAddLicensesLogger): void
    {
        ...
        Assert::assertEquals(1, $spyAddLicensesLogger->getDryCurrentDeletionCount());
        Assert::assertEquals(1, $spyAddLicensesLogger->getDryOldDeletionCount());
