...
class PHPDeleteOldLicensesLicenseSpecification extends AbstractDeleteSpecification
{
...
class PHPDeleteOldLicensesLicenseSpecification
{
...
';
    ...
    public function assertLogging(SpyAddLicensesLogger $spyAddLicensesLogger): void
    {
        ...
        Assert::assertEquals(1, $spyAddLicensesLogger->getOldDeletionCount());
