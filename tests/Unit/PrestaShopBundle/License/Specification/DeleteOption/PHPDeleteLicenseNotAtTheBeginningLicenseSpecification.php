...
namespace Tests\Unit\PrestaShopBundle\License\Specification\DeleteOption;
...
class PHPDeleteLicenseNotAtTheBeginningLicenseSpecification extends AbstractDeleteSpecification
{
    protected function getActualContent(): string
    {
        return '<?php
/** A comment before the license */
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
...
class PHPDeleteLicenseNotAtTheBeginningLicenseSpecification
{
...
';
    ...
    public function assertLogging(SpyAddLicensesLogger $spyAddLicensesLogger): void
    {
        ...
        Assert::assertEquals(1, $spyAddLicensesLogger->getCurrentDeletionCount());
