...
namespace Tests\Unit\PrestaShopBundle\License\Specification\DryRunOption;
...
class OSPHPDryRunLicenseSpecification extends AbstractDryRunSpecification
{
...
class OSPHPDryRunLicenseSpecification
{
...
';
    ...
    public function assertLogging(SpyAddLicensesLogger $spyAddLicensesLogger): void
    {
        ...
        Assert::assertEquals(1, $spyAddLicensesLogger->getDryInsertCount());
    }
