...
class PHPTagIsNotTheFirstElementLicenseSpecification extends AbstractNoOptionSpecification
{
    protected function getActualContent(): string
    {
        return 'SomethingBefore<?php

declare(strict_types=1);

namespace Tests\Unit\PrestaShopBundle\License;

class PHPTagIsNotTheFirstElementLicenseSpecification
{
