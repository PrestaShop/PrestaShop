...
use PrestaShopBundle\License\LicenseBuilder\AFLLicenseStrategy;
...
class AFLVueLicenseSpecification extends AbstractNoOptionSpecification
{
    public const PARTIAL_PATH = 'AFLFolder/';
...
<h1>Hello world</h1>';
    ...
    public function assertLogging(SpyAddLicensesLogger $spyAddLicensesLogger): void
    {
        ...
        Assert::assertEquals(1, $spyAddLicensesLogger->getInsertCount());
    }

    public function getLicenseStrategy(): LicenseStrategyInterface
    {
        return new AFLLicenseStrategy();
    }
}
