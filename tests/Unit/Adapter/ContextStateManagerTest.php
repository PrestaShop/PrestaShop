...
class ContextStateManagerTest extends ContextStateTestCase
{
    ...
    public function testControllerState()
    {
        ...
        $this->assertEquals('index.php?controller=AdminProductsController', $context->controller->currentIndex ?? $context->controller::$currentIndex);
        ...
        $this->assertEquals('index.php?controller=AdminOrdersController', $context->controller->currentIndex ?? $context->controller::$currentIndex);
        ...
        $this->assertEquals('index.php?controller=AdminCartsController', $context->controller->currentIndex ?? $context->controller::$currentIndex);
