...
use PrestaShop\PrestaShop\Adapter\Geolocation\GeolocationIpAddressWhitelistConfiguration;
...
class GeolocationIpAddressWhitelistConfigurationTest extends AbstractConfigurationTestCase
{
    ...
    public function testUpdateConfigurationWithInvalidConfiguration(string $exception, array $values): void
    {
        ...
        $geolocationIpAddressWhitelistConfiguration->updateConfiguration($values);
    }
    ...
    public function provideInvalidConfiguration(): array
    {
        return [
            ...
            [InvalidOptionsException::class, ['geolocation_whitelist' => true]],
        ];
    }
