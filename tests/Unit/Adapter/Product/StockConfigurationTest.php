    ...
    public function testGetConfiguration(ShopConstraint $shopConstraint): void
    {
        ...
        $this->mockConfiguration
            ...
            ->willReturnMap(
                [
                    ...
                    ['PS_LABEL_IN_STOCK_PRODUCTS', null, $shopConstraint, ['fr' => 'label in stock']],
                    ['PS_LABEL_OOS_PRODUCTS_BOA', null, $shopConstraint, ['fr' => 'label boa']],
                    ['PS_LABEL_OOS_PRODUCTS_BOD', null, $shopConstraint, ['fr' => 'label bod']],
                    ['PS_LABEL_DELIVERY_TIME_AVAILABLE', null, $shopConstraint, ['fr' => 'label delivery time available']],
                    ['PS_LABEL_DELIVERY_TIME_OOSBOA', null, $shopConstraint, ['fr' => 'label delivery time oosboa']],
        ...
        $this->assertSame(
            [
                ...
                'in_stock_label' => ['fr' => 'label in stock'],
                'oos_allowed_backorders' => ['fr' => 'label boa'],
                'oos_denied_backorders' => ['fr' => 'label bod'],
                'delivery_time' => ['fr' => 'label delivery time available'],
                'oos_delivery_time' => ['fr' => 'label delivery time oosboa'],
