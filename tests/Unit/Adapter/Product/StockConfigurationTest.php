    ...
    public function testGetConfiguration(ShopConstraint $shopConstraint): void
    {
        ...
        $this->mockConfiguration
            ...
            ->willReturnMap(
                [
                    ...
                    ['PS_LABEL_IN_STOCK_PRODUCTS', null, $shopConstraint, ['en' => 'label in stock']],
                    ['PS_LABEL_OOS_PRODUCTS_BOA', null, $shopConstraint, ['en' => 'label boa']],
                    ['PS_LABEL_OOS_PRODUCTS_BOD', null, $shopConstraint, ['en' => 'label bod']],
                    ['PS_LABEL_DELIVERY_TIME_AVAILABLE', null, $shopConstraint, ['en' => 'label delivery time available']],
                    ['PS_LABEL_DELIVERY_TIME_OOSBOA', null, $shopConstraint, ['en' => 'label delivery time oosboa']],
        ...
        $this->assertSame(
            [
                ...
                'in_stock_label' => ['en' => 'label in stock'],
                'oos_allowed_backorders' => ['en' => 'label boa'],
                'oos_denied_backorders' => ['en' => 'label bod'],
                'delivery_time' => ['en' => 'label delivery time available'],
                'oos_delivery_time' => ['en' => 'label delivery time oosboa'],
