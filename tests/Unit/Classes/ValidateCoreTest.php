...
class ValidateCoreTest extends TestCase
{
    ...
    {
        // testIsBirthDate() evaluates these under UTC, so they are built under UTC too. date() would
        // use the ambient timezone, and for the first hours of a local day that is a different date
        // than the one the assertion compares against - which fails every night east of Greenwich.
        return [
            [true, '1991-04-19'],
            [true, '2015-03-22'],
            [true, '1945-07-25'],
            ...
            [false, '1801-01-01'],
            [false, '0085-02-25'],
            [true, gmdate('Y-m-d', strtotime('now'))],
            [true, gmdate('Y-m-d', strtotime('-1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 month'))],
            [true, gmdate('Y-m-d', strtotime('-1 month -1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 month +1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 month'))],
            [false, gmdate('Y-m-d', strtotime('+1 month -1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 month +1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 year'))],
            [true, gmdate('Y-m-d', strtotime('-1 year -1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 year +1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 year -1 month'))],
            [true, gmdate('Y-m-d', strtotime('-1 year -1 month -1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 year -1 month +1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 year +1 month'))],
            [true, gmdate('Y-m-d', strtotime('-1 year +1 month -1 day'))],
            [true, gmdate('Y-m-d', strtotime('-1 year +1 month +1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 year'))],
            [false, gmdate('Y-m-d', strtotime('+1 year -1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 year +1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 year -1 month'))],
            [false, gmdate('Y-m-d', strtotime('+1 year -1 month -1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 year -1 month +1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 year +1 month'))],
            [false, gmdate('Y-m-d', strtotime('+1 year +1 month -1 day'))],
            [false, gmdate('Y-m-d', strtotime('+1 year +1 month +1 day'))],
            [false, gmdate('Y-m-d', strtotime('-121 year'))],
        ];
    }
