 ...
 */
class ProductCommandComparator extends Comparator
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->isProductCommand($expected) && $this->isProductCommand($actual);
    }
     ...
     */
    private function isProductCommand($command): bool
    {
        ...
        return $reflection->getNamespaceName() === 'PrestaShop\PrestaShop\Core\Domain\Product\Command';
    }
}
