...
class UploadLogosCommandTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->validImagePath = _PS_ROOT_DIR_ . '/img/logo.jpg';
    }
    ...
    public function testSetUploadedHeaderLogo(): void
    {
        $uploadLogosCommand = new UploadLogosCommand();
        $uploadedFile = new UploadedFile($this->validImagePath, basename($this->validImagePath));
        $uploadLogosCommand->setUploadedHeaderLogo($uploadedFile);
