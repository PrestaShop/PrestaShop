...
class PackageWeightMeasureTest extends TestCase
{
    /**
    ...
    public function testItThrowsExceptionWhenWrongValueIsGiven($invalidValue)
    {
        ...
        $this->expectExceptionCode(CarrierConstraintException::INVALID_WEIGHT_MEASURE);

        new PackageWeightMeasure($invalidValue);
    }
