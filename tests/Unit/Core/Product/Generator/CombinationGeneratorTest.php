...
class CombinationGeneratorTest extends TestCase
{
    ...
    public function getValidData(): Generator
    {
        yield [
            ...
            [
                new GeneratedCombination([1 => 2, 2 => 5, 3 => 7]),
                new GeneratedCombination([1 => 2, 2 => 5, 3 => 8]),
                new GeneratedCombination([1 => 2, 2 => 6, 3 => 7]),
                new GeneratedCombination([1 => 2, 2 => 6, 3 => 8]),
                new GeneratedCombination([1 => 3, 2 => 5, 3 => 7]),
                new GeneratedCombination([1 => 3, 2 => 5, 3 => 8]),
                new GeneratedCombination([1 => 3, 2 => 6, 3 => 7]),
                new GeneratedCombination([1 => 3, 2 => 6, 3 => 8]),
                new GeneratedCombination([1 => 4, 2 => 5, 3 => 7]),
                new GeneratedCombination([1 => 4, 2 => 5, 3 => 8]),
                new GeneratedCombination([1 => 4, 2 => 6, 3 => 7]),
                new GeneratedCombination([1 => 4, 2 => 6, 3 => 8]),
            ],
        ];
    }
}
