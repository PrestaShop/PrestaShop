...
{
    public function testItGetsExpectedTitle()
    {
        $hookDescriptionList = [
            [
                'prefix' => 'action',
                'suffix' => 'GridQueryBuilderModifier',
                'title' => 'Modify %hookId% grid query builder',
                'description' => 'This hook allows to alter Doctrine query builder for %hookId% grid',
            ],
        ];
