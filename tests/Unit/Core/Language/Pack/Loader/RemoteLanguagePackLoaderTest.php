...
final class RemoteLanguagePackLoaderTest extends TestCase
{
    public function testGetLanguagePackUrl()
    {
        $version_str = '8.0.0';
        $locale = 'fr-FR';
        $packLoader = new RemoteLanguagePackLoader(Version::buildFromString($version_str));
        ...
        $language_pack_lang_list_url = $packLoader->getLanguagePackUrl();
        $this->assertStringEndsWith('/available_languages.json', $language_pack_lang_list_url);
