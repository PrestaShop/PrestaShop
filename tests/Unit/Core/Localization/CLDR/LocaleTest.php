...
class LocaleTest extends TestCase
{
     ...
     */
    public function testTerritories(LocaleData $localeData)
    {
        $locale = new Locale($localeData);
        $this->assertIsArray($locale->getAllTerritories());
        $this->assertEquals($localeData->getTerritories(), $locale->getAllTerritories());
    }

    public function getLocaleDataTerritories(): array
    {
        return [
            [
                new LocaleData(),
