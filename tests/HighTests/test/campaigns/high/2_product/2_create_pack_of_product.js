...
scenario('Create a pack of products', client => {
  ...
  scenario('Edit the Basic settings', client => {
    ...
    test('should set the "Add products to your pack"', () => client.addPackProduct(data.pack.pack.pack1));
    test('should set the "Add products to your pack"', () => client.addPackProduct(data.pack.pack.pack2));
