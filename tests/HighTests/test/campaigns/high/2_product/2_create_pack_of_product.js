...
scenario('Check the product in the catalog', client => {
  ...
  test('should check the existence of product name', () => client.checkText(AddProductPage.catalog_product_name, data.pack.name + date_time));
  ...
  test('should check the existence of product category', () => client.checkText(AddProductPage.catalog_product_category, data.pack.new_category_name + date_time));
