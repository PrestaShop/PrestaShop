...
scenario('Check the product creation', client => {
  ...
  test('should check the existence of product name', () => client.checkText(AddProductPage.catalog_product_name, data.standard.name + date_time));
  ...
  test('should check the existence of product category', () => client.checkText(AddProductPage.catalog_product_category, data.standard.new_category_name + date_time));
