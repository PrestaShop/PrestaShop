...
scenario('Create order in FO', client => {
  ...
  test('should choose payment by bank wire', () => client.waitForExistAndClick(buyOrderPage.checkout_step4_payment_radio));
  test('should check the condition to approve', () => client.waitForExistAndClick(buyOrderPage.condition_check_box));
