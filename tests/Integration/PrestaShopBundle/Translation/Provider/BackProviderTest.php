 ...
 */
class BackProviderTest extends KernelTestCase
{
     ...
     */
    public function xtestItExtractsDefaultCatalogueFromTranslationsDefaultFiles(
    ...
    private function buildThemeRepository()
    {
        ...
        $configuration
            ...
            ->willReturnCallback(function ($param) {
                $configs = [
                    '_PS_ALL_THEMES_DIR_' => self::TRANSLATIONS_DIR,
