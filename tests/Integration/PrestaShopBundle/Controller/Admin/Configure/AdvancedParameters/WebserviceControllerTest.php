...
class WebserviceControllerTest extends WebTestCase
{
    ...
    /**
     * @dataProvider dataProviderBulkEnable
     */
    ...
    public function dataProviderBulkEnable(): array
    {
        return [
            [
                true,
    ...
    /**
     * @dataProvider dataProviderBulkDisable
     */
    ...
    public function dataProviderBulkDisable(): array
    {
        return [
            [
                true,
