...
class ProductControllerTest extends FormGridControllerTestCase
{
    ...
    public function testEdit(int $productId): int
    {
        ...
        $formData = [
            ...
            'product[details][condition][show_condition]' => true,
            'product[details][condition][condition]' => ProductCondition::NEW,
            ...
            'product[shipping][delivery_time][type]' => DeliveryTimeNoteType::TYPE_SPECIFIC,
            'product[shipping][delivery_time][in_stock][1]' => 'in stock notes1',
            'product[shipping][delivery_time][out_of_stock][1]' => 'out of stock notes1',
            ...
            'product[seo][meta_information][meta_title][1]' => 'meta title 1',
            'product[seo][meta_information][meta_description][1]' => 'meta description 1',
            'product[seo][meta_information][link_rewrite][1]' => 'link-rewrite-1',
