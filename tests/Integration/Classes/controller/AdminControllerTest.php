...
class AdminControllerTest extends TestCase
{
    ...
    protected function declareRequiredConstants(): void
    {
    ...
    protected function getMockTranslator(): Translator
    {
        return $this->getMockBuilder(Translator::class)->disableOriginalConstructor()->getMock();
    }

    protected function getMockSmarty(): Smarty
    {
    ...
    protected function getMockEmployee(): Employee
    {
    ...
    protected function requireAliasesFunctions(): void
    {
        require_once dirname(__DIR__, 4) . '/config/alias.php';
    }

    protected function getMockLanguage(): Language
    {
        return $this->getMockBuilder(Language::class)->getMock();
    }

    protected function getMockShop(): Shop
    {
        return $this->getMockBuilder(Shop::class)->getMock();
    }

    protected function getMockLegacyContainer(): LegacyContainer
    {
    ...
    protected function getMockCookie(): Cookie
    {
        return $this->getMockBuilder(Cookie::class)->disableOriginalConstructor()->getMock();
    }

    protected function getMockLink(): Link
    {
    ...
    protected function getMockLocale(): Locale
    {
        return $this->getMockBuilder(Locale::class)->disableOriginalConstructor()->getMock();
    }

    protected function getMockLocaleRepository(): LocaleRepository
    {
    ...
    protected function getMockMultistoreController(): MultistoreController
    {
    ...
    protected function getMockFeatureInterface(): FeatureInterface
    {
