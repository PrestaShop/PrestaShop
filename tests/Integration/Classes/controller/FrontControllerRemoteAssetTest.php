 ...
 *
 * WHY separate processes: AbstractAssetManager::getDirectories() keeps its list in a method static, which
 * every asset manager in the process shares. Once another test has built a manager with other
 * directories, the local asset here resolves against those and is dropped for a reason unrelated to
 * this test.
 *
