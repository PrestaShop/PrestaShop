...
class AdminHeaderPreloadTest extends TestCase
{
    ...
    /**
     * The header reads dozens of variables a real back office request assigns, and this test is only about
     * the preload include. Undefined ones are muted on a copy, so the shared instance keeps its settings.
     */
    private function headerSmarty(): Smarty
    {
        $smarty = clone $this->prepareContext()->smarty;
