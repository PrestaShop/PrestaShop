...
class DbTest extends TestCase
{
    ...
    public function testGetInstanceShouldLoadSlavesCorrectlyEvenWhenMasterIsCalled(): void
    {
        ...
        //When
        $this->slave_first = Db::getInstance((bool) _PS_USE_SQL_SLAVE_);
        $this->slave_second = Db::getInstance((bool) _PS_USE_SQL_SLAVE_);

        //Then
        $this->assertNotSame($this->slave_first, $this->slave_second);
        $this->assertNotSame($this->master, $this->slave_second);
        $this->assertNotSame($this->master, $this->slave_first);
    ...
    private function assertTwoCallsOnFirst_ThenOneOnSecondSlave(): void
    {
        ...
        $this->assertSame($this->slave_first, Db::getInstance((bool) _PS_USE_SQL_SLAVE_));
        $this->assertSame($this->slave_first, Db::getInstance((bool) _PS_USE_SQL_SLAVE_));

        // Fifth call is on second slave
        $this->assertSame($this->slave_second, Db::getInstance(_PS_USE_SQL_SLAVE_));
    }
