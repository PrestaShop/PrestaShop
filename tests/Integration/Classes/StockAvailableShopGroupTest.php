...
/**
 * Disabling stock sharing on a shop group must remove the shop-group stock_available row the shared
 * model used, instead of leaving it behind as an orphan next to the per-shop rows.
 *
