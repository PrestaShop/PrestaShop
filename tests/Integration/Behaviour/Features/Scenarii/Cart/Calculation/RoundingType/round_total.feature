...
Feature: Cart calculation with rounding type TOTAL
  ...
  Scenario: Empty cart
    ...
    Given Specific shop configuration of "rounding type" is set to ROUND_TOTAL
    Then Expected total of my cart tax included should be precisely 0.0
    Then Expected total of my cart tax included should be precisely 0.0 with previous calculation method
