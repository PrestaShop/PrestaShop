...
class CartFeatureContext extends AbstractDomainFeatureContext
{
    ...
    public function addProductsCombinationsToCart(
        ...
        $productId = $this->productFeatureContext->getProductWithName($productName)->id;
        $combinationId = $this->productFeatureContext->getCombinationWithName($productName, $combinationName)->id;
