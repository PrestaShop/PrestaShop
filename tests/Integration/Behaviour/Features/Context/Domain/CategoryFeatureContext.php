...
class CategoryFeatureContext extends AbstractDomainFeatureContext
{
    ...
    public function editCategoryWithFollowingDetails(string $categoryReference, TableNode $table)
    {
        ...
        $command->setLocalizedBottomDescriptions($editableCategoryTestData->getBottomDescription());
    ...
    public function editRootCategoryWithFollowingDetails(string $rootCategory, TableNode $table)
    {
        ...
        $command->setLocalizedBottomDescriptions($editableRootCategoryTestCaseData->getBottomDescription());
    ...
    private function mapDataToEditableCategory(
        ...
        $description_bottom = [$this->defaultLanguageId => self::EMPTY_VALUE];
        if (isset($testCaseData['Bottom description'])) {
            $description_bottom = [$this->defaultLanguageId => $testCaseData['Bottom description']];
        }
