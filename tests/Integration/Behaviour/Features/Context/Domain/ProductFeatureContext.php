...
class ProductFeatureContext extends AbstractDomainFeatureContext
{
     ...
     */
    public function theCategoryOfProductHasReductionOfForCustomer($productName, $reductionPercent, $customerReference)
    {
        $productId = $this->getProductIdByName($productName);
        ...
        $groupReduction->reduction = (float) $reductionPercent / 100;
