...
class StoreFeatureContext extends AbstractDomainFeatureContext
{
     ...
     */
    public function addNewStoreWithTheFollowingDetails(TableNode $table, string $reference)
    {
     ...
     */
    public function storeShouldHaveTheFollowingDetails(string $reference, TableNode $table)
    {
