...
Feature: Update product SEO options from Back Office (BO)
  ...
  Scenario: Update product SEO multi-lang fields
    ...
    And product "product2" localized "meta_title" should be:
      | locale | value               |
      | en-US  | product2 meta title |
      | fr-FR  | product2 meta title |
    And product "product2" localized "meta_description" should be:
      | locale | value                     |
      | en-US  | product2 meta description |
      | fr-FR  | product2 meta description |
    And product "product2" localized "link_rewrite" should be:
      | locale | value            |
      | en-US  | waterproof-boots |
    ...
    Then product "product2" localized "meta_title" should be:
      ...
      | fr-FR  | toolazytofindFRtrans meta title1 |
    Then product "product2" localized "meta_description" should be:
      | locale | value                           |
      | en-US  | product2 meta description       |
      | fr-FR  | toolazytofindFRtrans meta desc1 |
    Then product "product2" localized "link_rewrite" should be:
      | locale | value                          |
      | en-US  | waterproof-boots               |
