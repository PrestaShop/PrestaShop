# ./vendor/bin/behat -c tests/Integration/Behaviour/behat.yml -s product --tags get-combination-ids
@restore-products-before-feature
@clear-cache-before-feature
@product-combination
@get-combination-ids
Feature: Get combination ids for product in Back Office (BO)
  This is a quite technical part of combinations listing feature.
  As an employee
  I need to retrieve a list of product combinations identifiers
