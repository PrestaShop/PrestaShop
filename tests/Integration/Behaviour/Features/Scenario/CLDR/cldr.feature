...
Feature: CLDR display for prices
  ...
  Background:
    ...
    When I set the transformation "leftWithoutSpace" for currency "currency1" in locale "fr-FR"
      And I set the transformation "rightWithSpace" for currency "currency2" in locale "en-US"
      And I set the transformation "rightWithoutSpace" for currency "currency3" in locale "hi-IN"
      And I set the transformation "leftWithSpace" for currency "currency5" in locale "fr-FR"
      And I set the transformation "leftWithSpace" for currency "currency6" in locale "fr-FR"
