...
Feature: Cart calculation with carriers specific cart rules: carrier changes
  ...
  Scenario: one product in cart, quantity 1, cant apply not corresponding cart rule
    ...
    Given carrier named carrier1 applies shipping fees of 3.1 in zone zone1 for quantities between 0 and 10000
    Given carrier named carrier1 applies shipping fees of 4.3 in zone zone2 for quantities between 0 and 10000
    Given there is a carrier named carrier2
    Given carrier named carrier2 applies shipping fees of 5.7 in zone zone1 for quantities between 0 and 10000
    Given carrier named carrier2 applies shipping fees of 6.2 in zone zone2 for quantities between 0 and 10000
    Given there is a carrier named carrier3
    Given carrier named carrier3 applies shipping fees of 5.7 in zone zone1 for quantities between 0 and 10000
    Given carrier named carrier3 applies shipping fees of 6.2 in zone zone2 for quantities between 0 and 10000
    ...
    Given cart rule named cartrule1 has a discount code foo
    ...
    Given cart rule named cartrule2 has a discount code bar
    ...
    When I select address named address1 in my cart
  ...
  Scenario: one product in cart, quantity 1, can apply corresponding cart rule
    ...
    When I use the discount named cartrule1
