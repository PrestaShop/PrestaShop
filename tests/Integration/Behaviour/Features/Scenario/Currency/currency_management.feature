...
Feature: Currency Management
  ...
  Scenario: Adding and edit official currency with custom transformation
    ...
    And currency "currency16" should have transformation leftWithSpace for language "fr-FR"
    And currency "currency16" should have transformation empty for language "en-EN"
    ...
    And currency "currency16" should have status enabled
    And currency "currency16" should be available in shop "shop1"
    And currency "currency16" should have transformation empty for language "fr-FR"
    And currency "currency16" should have transformation rightWithSpace for language "en-US"

  Scenario: Adding and edit unofficial currency with custom transformation
    ...
    And currency "currency17" should have transformation leftWithoutSpace for language "fr-FR"
    And currency "currency17" should have transformation empty for language "en-EN"
    ...
    And currency "currency17" should have status enabled
    And currency "currency17" should be available in shop "shop1"
    And currency "currency17" should have transformation empty for language "fr-FR"
    And currency "currency17" should have transformation rightWithoutSpace for language "en-US"
