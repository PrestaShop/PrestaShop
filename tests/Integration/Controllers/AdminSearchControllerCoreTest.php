            ...
            [
                ...
                [
                    ...
                    'features' => [
                        'Orders' => [
                            [
                                'link' => 'http://localhost/admin-dev/index.php?controller=AdminOrders&token=dc20fd6b3135f9fc1a592a38a3aff1c9',
                            ],
                        ],
                        'Supply orders' => [
                            [
                                'link' => 'http://localhost/admin-dev/index.php?controller=AdminSupplyOrders&token=96b9179bd103bd7e09deadf0af557795',
                            ],
                        ],
                    ],
                ],
