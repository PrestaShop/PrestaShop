...
export default [
  {
    ...
    urls: [
      ...
      {name: 'BO_delivery_slips', url: 'index.php?controller=AdminCarts'},
      ...
      {name: 'BO_locations_zones', url: 'index.php/improve/international/zones/'},
      {name: 'BO_add_locations_zone', url: 'index.php/improve/international/zones/new'},
      ...
      {name: 'BO_traffic_seo_search_engines', url: 'index.php/configure/shop/search-engines/'},
      {name: 'BO_add_traffic_seo_search_engine', url: 'index.php/configure/shop/search-engines/new'},
