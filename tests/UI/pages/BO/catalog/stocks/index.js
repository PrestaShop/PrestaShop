...
class Stocks extends BOBasePage {
  ...
  constructor() {
    ...
    this.productRowNameColumn = row => `${this.productRow(row)} td[data-role=product_name]`;
    this.productRowReferenceColumn = row => `${this.productRow(row)} td[data-role=product-reference]`;
    this.productRowSupplierColumn = row => `${this.productRow(row)} td[data-role=product_supplier_name]`;
    this.productRowPhysicalColumn = row => `${this.productRow(row)} td[data-role=physical_quantity]`;
    this.productRowReservedColumn = row => `${this.productRow(row)} td[data-role=reserved_quantity]`;
    this.productRowAvailableColumn = row => `${this.productRow(row)} td[data-role=available_quantity]`;

    // Quantity column
    this.productRowQuantityColumn = row => `${this.productRow(row)} td[data-role=update_quantity]`;
