...
class MyProfile extends EmployeeBasePage {
  ...
  constructor() {
    ...
    this.errorInvalidFormatImageMessage = 'An unexpected error occurred. [PrestaShop\\PrestaShop\\Core\\Image\\Uploader\\Exception\\UploadedImageConstraintException code 2]: Image format "svg", not recognized, allowed formats are: gif, jpg, jpeg, jpe, png, webp';
