...
module.exports = class MigratedListingBasePage extends BOBasePage {
  constructor(table) {
    super();

    // Selectors grid panel
    this.gridPanel = `#${table}_grid_panel`;
    this.gridTable = `#${table}_grid_table`;
    this.gridHeaderTitle = `${this.gridPanel} h3.card-header-title`;

    // Filters
    this.filterColumn = filterBy => `${this.gridTable} #${table}_${filterBy}`;
    ...
    this.bulkActionsDeleteButton = `#${table}_grid_bulk_action_delete_selection`;
