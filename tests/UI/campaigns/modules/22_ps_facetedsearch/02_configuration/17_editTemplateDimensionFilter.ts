...
describe('Faceted search module - Edit template - Dimension filter', async () => {
  ...
  [
    ...
    it('should check the "All products" page', async function () {
      ...
      const isSearchFilterRadio = await foHummingbirdCategoryPage.isSearchFilterRadio(
        page,
        'attribute_group',
        'Dimension',
      );
      ...
      const isSearchFilterDropdown = await foHummingbirdCategoryPage.isSearchFilterDropdown(
        page,
        'attribute_group',
        'Dimension',
      );
      ...
      const isSearchFilterCheckbox = await foHummingbirdCategoryPage.isSearchFilterCheckbox(page, 'attribute_group', 'Dimension');
