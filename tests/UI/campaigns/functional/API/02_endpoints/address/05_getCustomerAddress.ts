...
const baseContext: string = 'functional_API_endpoints_address_getCustomerAddressId';
...
describe('API : GET /addresses/customers/{addressId}', async () => {
  ...
  describe('API : Fetch the Customer Address', async () => {
    ...
    it('should check the JSON Response : `addressId`', async function () {
      ...
      expect(jsonResponse.addressId).to.be.equal(addressId);
    });

    it('should check the JSON Response : `customerId`', async function () {
      await testContext.addContextItem(this, 'testIdentifier', 'checkResponseCustomerId', baseContext);

      expect(jsonResponse).to.have.property('customerId');
      expect(jsonResponse.customerId).to.be.a('number');
    ...
    it('should check the JSON Response : `firstName`', async function () {
      ...
      expect(jsonResponse.firstName).to.be.equal(addressData.firstName);
    });
    ...
    it('should check the JSON Response : `lastName`', async function () {
      ...
      expect(jsonResponse.lastName).to.be.equal(addressData.lastName);
    });
