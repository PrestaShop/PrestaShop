...
describe('API : GET /api/product/{productId}', async () => {
  ...
  describe('API : Check Data', async () => {
    it('should request the endpoint /admin-dev/api/product/{productId}', async function () {
      await testContext.addContextItem(this, 'testIdentifier', 'requestEndpoint', baseContext);

      const apiResponse = await apiContext.get(`api/product/${idProduct}`, {
        headers: {
