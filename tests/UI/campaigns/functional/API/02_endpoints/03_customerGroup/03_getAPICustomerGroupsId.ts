...
describe('API : GET /api/customers/group/{customerGroupId}', async () => {
  ...
  describe('API : Check Data', async () => {
    it('should request the endpoint /admin-dev/api/customers/group/{customerGroupId}', async function () {
      await testContext.addContextItem(this, 'testIdentifier', 'requestEndpoint', baseContext);

      const apiResponse = await apiContext.get(`api/customers/group/${idCustomerGroup}`, {
        headers: {
