...
const baseContext: string = 'functional_API_endpoints_hook_getAPIHooks';

describe('API : GET /api/hooks', async () => {
  ...
  describe('API : Check Data', async () => {
    it('should request the endpoint /admin-dev/api/hooks', async function () {
      await testContext.addContextItem(this, 'testIdentifier', 'requestEndpoint', baseContext);

      const apiResponse = await apiContext.get('api/hooks', {
        headers: {
