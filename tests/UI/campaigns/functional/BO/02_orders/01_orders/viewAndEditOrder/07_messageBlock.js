...
describe('BO - Orders - View and edit order : Check message block', async () => {
  ...
  describe('Check message in FO', async () => {
    ...
    it('should go to the first order in the list and check order message', async function () {
      await testContext.addContextItem(this, 'testIdentifier', 'checkOrderMessageBlock', baseContext);
  ...
  describe('Check that the second message is not visible on FO', async () => {
    ...
    it('should go to the first order in the list and check order message', async function () {
      ...
      const isVisible = await foOrderHistoryPage.isBoxMessagesSectionVisible(page);
      await expect(isVisible, 'Order status is not correct').to.be.true;
    });

    it('should check that the second message is not visible', async function () {
      await testContext.addContextItem(this, 'testIdentifier', 'checkOrderMessageBlock', baseContext);
