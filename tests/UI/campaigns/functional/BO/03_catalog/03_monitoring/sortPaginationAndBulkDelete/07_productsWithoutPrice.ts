...
const baseContext: string = 'functional_BO_catalog_monitoring_sortPaginationAndBulkDelete_productsWithoutPrice';
...
describe('BO - Catalog - Monitoring : Sort and pagination list of products without price', async () => {
  ...
  const tableName: string = 'product_without_price';
