 ...
 */
describe('Sort and pagination list of products without description', async () => {
  ...
  // 1 : Create 11 products without description
  const creationTests = new Array(11).fill(0, 0, 11);
  describe('Create 11 products without description', async () => {
  ...
  describe('Delete the created products without description', async () => {
