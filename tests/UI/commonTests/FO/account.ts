...
export default {
   ...
   */
  createAccountTest(customerData: object, baseContext: string = 'commonTests-createAccountTest'): void {
  ...
  createAddressTest(customerLoginData: object, addressData: object, baseContext: string = 'commonTests-createAddressTest'): void {
