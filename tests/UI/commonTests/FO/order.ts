 ...
 */
export default {
  createOrderByCustomerTest(orderData: Order, baseContext: string = 'commonTests-createOrderByCustomerTest'): void {
   ...
   * @param baseContext {string} String to identify the test
   */
  createOrderSpecificProductTest(orderData: Order, baseContext: string = 'commonTests-createOrderSpecificProductTest'): void {
   ...
   * @param baseContext {string} String to identify the test
   */
  createOrderByGuestTest(orderData: Order, baseContext: string = 'commonTests-createOrderByGuestTest'): void {
