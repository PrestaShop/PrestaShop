...
describe('Sort addresses', async () => {
  ...
  const tests = [
    ...
    {args: {testIdentifier: 'sortAddress1Desc', sortBy: 'address1', sortDirection: 'desc'}},
    {args: {testIdentifier: 'sortByPostCode1Asc', sortBy: 'postcode', sortDirection: 'asc'}},
    {args: {testIdentifier: 'sortPostCodeDesc', sortBy: 'postcode', sortDirection: 'desc'}},
    {args: {testIdentifier: 'sortByCityAsc', sortBy: 'city', sortDirection: 'asc'}},
    {args: {testIdentifier: 'sortCityDesc', sortBy: 'city', sortDirection: 'desc'}},
