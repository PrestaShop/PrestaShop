...
const dateToday = `${year.toString()}-${month.toString().substring(1)}-${day.toString().substring(1)}`;
// Date today to check(mm/dd/yyyy)
const dateTodayToCheck = `${month.toString().substring(1)}/${day.toString().substring(1)}/${year.toString()}`;
