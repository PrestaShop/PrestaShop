...
describe('Import a localization pack a currency and update default currency', async () => {
  ...
  describe('Import localization pack and check default currency in FO', async () => {
    ...
    const tests = [
      {args: {defaultCurrency: `${Currencies.chileanPeso.name} (${Currencies.chileanPeso.isoCode})`, currency: `${Currencies.chileanPeso.isoCode} ${Currencies.chileanPeso.symbol}`}},
      {args: {defaultCurrency: `${Currencies.euro.name} (${Currencies.euro.isoCode})`, currency: `${Currencies.euro.isoCode} ${Currencies.euro.symbol}`}},
    ];
