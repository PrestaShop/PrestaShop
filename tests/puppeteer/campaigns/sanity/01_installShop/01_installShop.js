...
describe('Install Prestashop', async () => {
  ...
  it('should open the Install page', async function () {
    ...
    const result = await this.pageObjects.installPage.checkStepTitle(this.pageObjects.installPage.firstStepPageTitle,
  ...
  it('should click on next and go to step \'License Agreements\'', async function () {
    ...
    const result = await this.pageObjects.installPage.checkStepTitle(this.pageObjects.installPage.secondStepPageTitle,
  ...
  it('should agree to terms and conditions and go to step \'System compatibility\'', async function () {
    ...
    if (!this.pageObjects.installPage.elementVisible(this.pageObjects.installPage.thirdStepFinishedListItem)) {
      const result = await this.pageObjects.installPage.checkStepTitle(this.pageObjects.installPage.thirdStepPageTitle,
  ...
  it('should click on next and go to step \'shop Information\'', async function () {
    ...
    const result = await this.pageObjects.installPage.checkStepTitle(this.pageObjects.installPage.fourthStepPageTitle,
  ...
  it('should fill shop Information form and go to step \'Database Configuration\'', async function () {
    ...
    await this.pageObjects.installPage.nextStep();
    const result = await this.pageObjects.installPage.checkStepTitle(this.pageObjects.installPage.fifthStepPageTitle,
