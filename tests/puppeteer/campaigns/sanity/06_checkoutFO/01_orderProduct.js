...
describe('Order a product and check order confirmation', async () => {
  ...
  it('should go to login page', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_goToLoginPage`);
  ...
  it('should sign In in FO With default account', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_loginFO`);
  ...
  it('should add first product to cart and Proceed to checkout', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_addProductToCart`);
  ...
  it('should check the cart details', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_checkCartDetails`);
  ...
  it('should proceed to checkout and check Step Address', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_checkAddressStep`);
  ...
  it('should validate Step Address and go to Delivery Step', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_checkDeliveryStep`);
  ...
  it('should Pay by back wire and confirm order', async function () {
    await testContext.addContextItem(this, 'stepIdentifier', `${baseContext}_confirmOrder`);
