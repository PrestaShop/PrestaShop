...
module.exports = class INSTALL extends CommonPage {
  ...
  async checkInstallationSuccessful() {
    ...
    await this.page.waitFor(this.generateSettingsFileStep, {visible: true, timeout: 90000});
    await this.page.waitFor(this.installDatabaseStep, {visible: true, timeout: 90000});
    ...
    await this.page.waitFor(this.installModulesStep, {visible: true, timeout: 360000});
    await this.page.waitFor(this.installModulesAddons, {visible: true, timeout: 360000});
    await this.page.waitFor(this.installThemeStep, {visible: true, timeout: 360000});
    await this.page.waitFor(this.installFixturesStep, {visible: true, timeout: 360000});
