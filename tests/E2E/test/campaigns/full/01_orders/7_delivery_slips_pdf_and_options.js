...
scenario('Test1: Delivery slips PDF', client => {
...
scenario('Test2: Delivery slips options', client => {
  scenario('Change "Delivery slips" options', client => {
    test('should change the "Delivery prefix"', () => client.waitAndSetValue(DeliverySlip.delivery_prefix, 'PR'));
    ...
    test('should Enable the product image', () => client.waitForExistAndClick(DeliverySlip.product_image));
