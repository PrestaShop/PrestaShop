...
module.exports = {
  createBrand: function (brandData) {
    scenario('Create a new "Brand"', client => {
      ...
      test('should set the "Short Description" input', () => client.waitAndSetValue(Brands.short_description_input, brandData.shortDescription));
      test('should set the "Description" input', () => client.waitAndSetValue(Brands.description_input, brandData.description));
