...
scenario('Update "Category"', () => {
  ...
  scenario('Update the created "Category"', client => {
    ...
    test('should set the "Description" input', () => client.setEditorText(CategorySubMenu.category_description, 'category description update'));
...
scenario('Check the category modification in the Back Office', () => {
  ...
  scenario('Check category in BO', client => {
    ...
    test('should check the description is equal a "category description"', () => client.checkTextValue(CategorySubMenu.description, 'category description update'));
    test('should click on "Edit" action', () => client.clickOnAction(CategorySubMenu.update_button));
