...
scenario('Open all menu links in the Back Office', () => {
  ...
  scenario('Check all the menu links of "IMPROVE"', () => {
    scenario('Check all the menu links of "Modules" in the Back Office', client => {
      ...
      common.clickOnMenuLinksAndCheckElement(client, Menu.Improve.Modules.modules_menu, Menu.Improve.Modules.modules_catalog_submenu, PagesForm.Modules.addons_search_form, "Catalog");
    }, 'common_client');
