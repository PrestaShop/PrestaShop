...
scenario('Install "PrestaShop Security" module', () => {
  ...
  scenario('Install "PrestaShop Security" module by uploading a ZIP file', client => {
    test('should go to "Module" page', () => client.goToSubtabMenuPage(Menu.Improve.Modules.modules_menu, Menu.Improve.Modules.module_manager_submenu));
    ...
    test('should click on "Installed Modules"', () => client.waitForExistAndClick(Menu.Improve.Modules.module_manager_submenu, 1000));
