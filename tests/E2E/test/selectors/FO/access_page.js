module.exports = {
  AccessPageFO: {
    ...
    top_sellers_block: '//h2[contains(text(), "Best Sellers")]',
    new_products_block: '//h2[contains(text(), "New products")]',
    ...
    selected_currency_option: '//*[@id="_desktop_currency_selector"]//span[text()="%D"]',
    selected_language_option: '//*[@id="_desktop_language_selector"]//span[text()="%D"]',
