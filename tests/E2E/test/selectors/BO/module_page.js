module.exports = {
  ModulePage: {
    ...
    actions_module_dropdown: '//*[@id="modules-list-container-all"]//button[contains(@class, "dropdown-toggle")] | //*[@id="modules-list-container-native"]//button[contains(@class, "dropdown-toggle")]',
    action_module_installed_button: '//*[@id="modules-list-container-all"]/div[1]//button[contains(@class, "light-button module_action")]',
    action_module_built_in_button: '//*[@id="modules-list-container-native"]/div[1]//button[contains(@class, "light-button module_action")]',
    action_module_theme_button: '//*[@id="modules-list-container-theme"]/div[1]//button[contains(@class, "light-button module_action")]',
    ...
    refresh_button: '//*[@id="upgradeButtonBlock"]//div//p/a',
