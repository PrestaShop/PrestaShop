...
PRESTASHOP 1.7 NOW PRODUCTION-READY! It's first stable version, 1.7.0.0, was release on November 7th, 2016. Further upudates have been released since then. Learn more about it on [the Build devblog](http://build.prestashop.com/).
