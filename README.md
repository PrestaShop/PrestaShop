...
To install the latest PrestaShop 1.7, you need a web server running PHP 7.2.5+ and any flavor of MySQL 5.0+ (MySQL, MariaDB, Percona Server, etc.). Versions between 1.7.0 and 1.7.6 work with PHP 5.6+.
