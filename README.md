...
PrestaShop open source project & other distributions
--------

This repository is the open source PrestaShop project. Our website is [PrestaShop-Project.org](https://PrestaShop-Project.org). This project is managed and released through our community as detailed in our [CONTRIBUTING file](./CONTRIBUTING.md).

Separately, the PrestaShop SA company (which provides support for the open source project) also publishes [its own releases](https://prestashop.com/versions/) of PrestaShop at [PrestaShop.com](https://PrestaShop.com). Those releases and websites are outside the scope of this open source initiative and repository that you are now reading.
