...
define('_PS_OWNER_READONLY_', 0400);
define('_PS_FILE_PERMISSIONS_', 0600);
define('_PS_FILE_DEFAULT_PERMISSIONS_', 0644);
define('_PS_FILE_GROUP_PERMISSIONS_', 0664);
define('_PS_FILE_FULL_PERMISSIONS_', 0666);
define('_PS_DIR_PERMISSIONS_', 0700);
define('_PS_DIR_DEFAULT_PERMISSIONS_', 0755);
define('_PS_DIR_GROUP_PERMISSIONS_', 0775);
define('_PS_DIR_FULL_PERMISSIONS_', 0777);