...
final class CountryByIdConfigurableChoiceProvider implements ConfigurableFormChoiceProviderInterface
{
    ...
    {
        $active = isset($options['active']) && is_bool($options['active']) && $options['active'];

        $containsStates = isset($options['contains_states']) && is_bool($options['contains_states']) && $options['contains_states'];

        $listStates = isset($options['list_states']) && is_bool($options['list_states']) && $options['list_states'];
