...
class PackedProductsCommandsBuilder implements ProductCommandsBuilderInterface
{
    ...
    {
        if (!isset($formData['description']['packed_products'])) {
            return [];
        }

        $packedProducts = $formData['description']['packed_products'];
        ...
        $command = new SetPackProductsCommand(
            ...
            array_map(
                function (array $item) {
                    $item['productId'] = (int) $item['product_id'];
                    $item['quantity'] = (int) $item['quantity'];
                    $item['combinationId'] = (int) $item['combination_id'];
