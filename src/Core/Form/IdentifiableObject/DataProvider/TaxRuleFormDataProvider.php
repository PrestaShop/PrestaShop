...
/**
 * Provides Data for tax rules add/edit form
 */
final class TaxRuleFormDataProvider implements FormDataProviderInterface
{
    /**
     ...
     */
    public function getData($taxRuleId)
    {
        ...
        return [
            ...
            'behavior_id' => $editableTaxRule->getBehavior() ? $editableTaxRule->getBehavior()->getValue() : null,
