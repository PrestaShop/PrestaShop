...
final class ProductFormDataProvider implements FormDataProviderInterface
{
    ...
    public function __construct(
        ...
        int $contextLangId,
        ProductImagePathFactory $imagePathFactory
    ) {
    ...
    private function getImageFromPackedProductDetails(PackedProductDetails $packedProductDetails): string
    {
        ...
        return $this->imagePathFactory->getNoImagePath(ProductImagePathFactory::IMAGE_TYPE_SMALL_DEFAULT);
    }
