...
/**
 * Provides data for alias add/edit form.
 */
class AliasFormDataProvider implements FormDataProviderInterface
{
    ...
    public function getData($id): array
    {
        ...
        $aliasForEditing = $this->queryBus->handle(new GetAliasForEditing($id));

        return [
            'aliases' => $aliasForEditing->getAliases(),
            'searchTerm' => $aliasForEditing->getSearchTerm(),
        ];
    }
