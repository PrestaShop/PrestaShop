...
/**
 * If registered, enables the dynamic form fields feature.
 * Allow the customization of Symfony forms from PrestaShop modules.
 */
interface FormProviderInterface
{
    ...
    /**
     * Return a collection of forms for the selected form.
     *
