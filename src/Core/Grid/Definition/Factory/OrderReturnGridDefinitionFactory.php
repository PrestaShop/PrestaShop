 ...
 */
final class OrderReturnGridDefinitionFactory extends AbstractFilterableGridDefinitionFactory
{
    ...
    protected function getBulkActions()
    {
        return (new BulkActionCollection())
            ->add($this->buildBulkDeleteAction('admin_order_returns_bulk_delete'));
    }
