...
/**
 * Class OrderReturnStatusesGridDefinitionFactory defines return_statuses grid structure.
 */
final class OrderReturnStatusesGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    const GRID_ID = 'order_return_statuses';
                    ...
                    'actions' => (new RowActionCollection())
                        ->add(
                            ...
                            ->setOptions([
                                ...
                                'route_param_name' => 'returnStatusId',
