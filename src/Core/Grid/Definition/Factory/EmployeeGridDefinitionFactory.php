...
final class EmployeeGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    ...
    {
        return $this->trans('Employees', array(), 'Admin.Advparameters.Feature');
    }
    ...
    protected function getColumns()
    {
        return (new ColumnCollection())
            ...
            ->add(
                ...
                ->setName($this->trans('Profile', array(), 'Admin.Advparameters.Feature'))
                ->setOptions(array(
                    'field' => 'profile_name',
                ))
            )
            ->add(
                ...
                ->setName($this->trans('Active', array(), 'Admin.Global'))
                ->setOptions(array(
                    'field' => 'active',
