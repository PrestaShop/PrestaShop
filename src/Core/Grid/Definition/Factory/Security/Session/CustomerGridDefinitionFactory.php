...
final class CustomerGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    ...
    protected function getColumns(): ColumnCollectionInterface
    {
        ...
        $deleteActionOptionsModal = $deleteActionOptions['modal_options']->getOptions();
        $deleteActionOptionsModal['title'] = $this->trans(
            'Delete session?',
            [],
            'Admin.Advparameters.Feature'
        );
        $deleteActionOptions['modal_options']->setOptions($deleteActionOptionsModal);
    ...
    {
        $bulkDeleteAction = $this->buildBulkDeleteAction('admin_security_sessions_customer_bulk_delete');
        ...
        $bulkDeleteActionOptionsModal = $bulkDeleteActionOptions['modal_options']->getOptions();
        $bulkDeleteActionOptionsModal['title'] = $this->trans(
            'Delete selected sessions?',
            [],
            'Admin.Advparameters.Feature'
        );
        $bulkDeleteActionOptions['modal_options']->setOptions($bulkDeleteActionOptionsModal);
