...
final class CartGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    ...
    protected function getColumns()
    {
        $columns = (new ColumnCollection())
            ->add(
                (new CartBulkActionColumn('cart_bulk_action'))
                    ->setOptions([
                        'bulk_field' => 'id_cart',
                    ])
            )
            ...
            ->add(
                (new CartTotalColumn('cart_total'))
    ...
    protected function getFilters()
    {
        return (new FilterCollection())
            ->add(
                (new Filter('id_cart', NumberType::class))
                    ->setTypeOptions([
                        'attr' => [
            ...
            ->add(
                (new Filter('status', DatalistType::class))
                    ->setTypeOptions([
                        'choices' => [
            ...
            ->add(
                (new Filter('online', YesAndNoChoiceType::class))
                    ->setTypeOptions([
                        'required' => false,
                    ])
