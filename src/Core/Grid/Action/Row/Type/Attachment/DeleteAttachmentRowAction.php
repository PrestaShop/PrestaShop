...
namespace PrestaShop\PrestaShop\Core\Grid\Action\Row\Type\Attachment;
...
/**
 * Class DeleteAttachmentRowAction delete attachment grid row action with dynamic confirmation message options
 */
class DeleteAttachmentRowAction extends AbstractRowAction
{
