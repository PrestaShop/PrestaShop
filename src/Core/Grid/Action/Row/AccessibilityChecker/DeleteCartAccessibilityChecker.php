...
/**
 * Checks if delete option for cart can be performed.
 */
final class DeleteCartAccessibilityChecker implements AccessibilityCheckerInterface
{
    /**
     * {@inheritdoc}
     */
    public function isGranted(array $record)
    {
        ...
        // this one is a little complicated so need a review to confirm it is correct
