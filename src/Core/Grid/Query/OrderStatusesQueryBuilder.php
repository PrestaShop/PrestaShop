...
/**
 * Class OrderStatusesQueryBuilder builds queries to fetch data for order_statuses grid.
 */
final class OrderStatusesQueryBuilder extends AbstractDoctrineQueryBuilder
{
    /**
     * @var int
     */
    ...
    {
        $searchQueryBuilder = $this->getOrderStatusesQueryBuilder($searchCriteria)
    ...
    {
        $countQueryBuilder = $this->getOrderStatusesQueryBuilder($searchCriteria)
            ->select('COUNT(*)');
     ...
     * @return QueryBuilder
     */
    private function getOrderStatusesQueryBuilder(SearchCriteriaInterface $searchCriteria)
    {
