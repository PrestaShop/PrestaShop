...
/**
 * Class OrderReturnQueryBuilder builds the queries that back the merchandise returns grid data.
 */
final class OrderReturnQueryBuilder extends AbstractDoctrineQueryBuilder
{
    /**
     * @var int
     */
    ...
    {
        $qb = $this->getOrderReturnQueryBuilder($searchCriteria);
        $qb
    ...
    {
        return $this->getOrderReturnQueryBuilder($searchCriteria)
     ...
     * @return QueryBuilder
     */
    private function getOrderReturnQueryBuilder(SearchCriteriaInterface $searchCriteria)
    {
    ...
    /**
     * Apply filters to the order returns query builder.
     *
     * @param array $filters
