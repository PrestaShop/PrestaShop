...
class ProductQueryBuilder extends AbstractDoctrineQueryBuilder
{
    ...
    public function getSearchQueryBuilder(SearchCriteriaInterface $searchCriteria): QueryBuilder
    {
         ...
         */
        $paginatedIdsQb = null;
        if ($this->resolvesThePageByProductId()) {
            $paginatedIdsQb = $this
    ...
    /**
     * The page can be resolved on product ids only when each product yields a single row. A subclass that
     * lists a product once per shop cannot: its ids repeat, and joining them back multiplies the rows.
     */
