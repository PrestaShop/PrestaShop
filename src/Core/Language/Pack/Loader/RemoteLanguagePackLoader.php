...
final class RemoteLanguagePackLoader implements LanguagePackLoaderInterface
{
     ...
     */
    private string $langRepositoryBasePath;
    ...
    {
        $this->version = Version::buildFromString($version);
    ...
    {
        return $this->langRepositoryBasePath . '/translations/' . $this->version->getSemVersion() . "/{$locale}/{$locale}.zip";
    }
    ...
    {
        return $this->langRepositoryBasePath . '/translations/' . $this->version->getSemVersion() . '/available_languages.json';
    }
