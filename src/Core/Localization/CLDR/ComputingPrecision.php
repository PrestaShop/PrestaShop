...
use PrestaShop\PrestaShop\Core\Localization\CLDR\Currency as Currency;

class ComputingPrecision
{
    private $multiplicator = 3;

    /**
     * Number of decimal digits to take into account when computing values
     * for a given display precision
     *
     * @var int $displayPrecision
     *
     * @return int
     */
    public function getPrecision($displayPrecision)
    {
        $computingPrecision = $displayPrecision * $this->multiplicator;
