...
final class IdentifiableObjectHookByFormTypeProvider implements HookByFormTypeProviderInterface
{
    ...
    public const FORM_BUILDER_HOOK_SUFFIX_MODIFIER = 'FormBuilderModifier';
    public const FORM_BUILDER_HOOK_SUFFIX_DATA_PROVIDER_DATA = 'FormDataProviderData';
    public const FORM_BUILDER_HOOK_SUFFIX_DATA_PROVIDER_DEFAULT_DATA = 'FormDataProviderDefaultData';
    ...
    public function getHookNames(array $formTypes)
    {
        ...
        foreach ($formNames as $formName) {
            $formBuilderHookNames[] = $this->formatHookName(
                ...
                $formName,
                self::FORM_BUILDER_HOOK_SUFFIX_MODIFIER
            );
