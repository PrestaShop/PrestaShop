...
class CountryOptionsConfiguration implements DataConfigurationInterface
{
    ...
    {
        return [
            'restrict_delivery_countries' => (int) $this->configuration->get('PS_RESTRICT_DELIVERED_COUNTRIES'),
        ];
    }
    ...
    public function updateConfiguration(array $configuration)
    {
        if ($this->validateConfiguration($configuration)) {
            $this->configuration->set(
                ...
                (int) $configuration['restrict_delivery_countries']
            );
        }
    ...
    {
        return isset($configuration['restrict_delivery_countries']);
    }
}
