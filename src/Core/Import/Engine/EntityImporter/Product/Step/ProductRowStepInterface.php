 ...
 *   guards that need parsing or the job context belong in apply().
 ...
 *   Per-batch memoization of job-invariant lookups is fine.
 *
...
interface ProductRowStepInterface
{
     ...
     * @param int $languageId id of the job's file language (single-language-file rule: on creation
