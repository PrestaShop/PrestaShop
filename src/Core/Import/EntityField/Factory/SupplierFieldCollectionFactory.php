...
/**
 * Class SupplierFieldCollectionFactory defines a supplier field collection factory.
 */
final class SupplierFieldCollectionFactory implements EntityFieldCollectionFactoryInterface
{
    /**
