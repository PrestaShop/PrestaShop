...
final class ProductFieldsProvider implements EntityFieldsProviderInterface
{
    ...
    public function getCollection()
    {
        $fields = [
            ...
            new EntityField('delete_existing_features', $this->trans('Delete existing features (0 = No, 1 = Yes)', 'Admin.Advparameters.Feature')),
            new EntityField('features', $this->trans('Feature (Name:Value:Position:Customized:Action(add|delete))', 'Admin.Advparameters.Feature')),
