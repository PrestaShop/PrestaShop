...
namespace PrestaShop\PrestaShop\Core\OrderReturn\Configuration;

use PrestaShop\PrestaShop\Core\Configuration\AbstractMultistoreConfiguration;
use Symfony\Component\OptionsResolver\OptionsResolver;

/**
 * Provides data configuration for the merchandise returns options form (canonical domain name: OrderReturn).
 */
class OrderReturnOptionsConfiguration extends AbstractMultistoreConfiguration
{
