...
/**
 * Defines contract to handle @see BulkDeleteAliasSearchTermCommand
 */
interface BulkDeleteAliasSearchTermHandlerInterface
{
    /**
     * @param BulkDeleteAliasSearchTermCommand $command
     */
