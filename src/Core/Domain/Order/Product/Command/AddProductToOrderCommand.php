...
class AddProductToOrderCommand
{
    ...
    public static function withNewInvoice(
        ...
        $command->withFreeShipping = $withFreeShipping;
     ...
     * @return bool|null
     */
    public function withFreeShipping()
    {
        return $this->withFreeShipping;
    }
