...
/**
 * Adds attachment and associates it with product
 */
class AddProductAttachmentCommand extends AddAttachmentCommand
{
    /**
     * @var ProductId
     */
    ...
    {
        parent::__construct($localizedNames, $localizedDescriptions);
    }
