...
/**
 * Defines contract to handle @see GetCombinationSupplierOptions query
 */
interface GetCombinationSupplierOptionsHandlerInterface
{
    /**
     * @param GetCombinationSupplierOptions $query
     *
