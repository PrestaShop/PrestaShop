...
namespace PrestaShop\PrestaShop\Core\Domain\Product\Combination\FeatureValue\QueryResult;

/**
 * Transfers combination feature value data in query result
 */
class CombinationFeatureValue
{
    /**
     * @var int
     */
