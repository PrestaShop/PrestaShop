...
class ListedCombinationForEditing
{
    /**
     * @var CombinationId
     */
     ...
     */
    public function setImpactOnPrice(string $impactOnPrice): ListedCombinationForEditing
    {
     ...
     * @return ListedCombinationForEditing
     */
    public function setQuantity(int $quantity): ListedCombinationForEditing
    {
     ...
     * @return ListedCombinationForEditing
     */
    public function setDefault(bool $default): ListedCombinationForEditing
    {
