...
/**
 * Defines contract to handle @see BulkUpdateCombinationsFromListingCommand
 */
interface BulkUpdateCombinationsFromListingHandlerInterface
{
    /**
     * @param BulkUpdateCombinationsFromListingCommand $command
     */
