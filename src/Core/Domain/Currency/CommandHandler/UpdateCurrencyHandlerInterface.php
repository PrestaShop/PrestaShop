...
/**
 * Interface UpdateCurrencyHandlerInterface defines contract for UpdateCurrencyHandler.
 */
interface UpdateCurrencyHandlerInterface
{
    /**
     * @param UpdateCurrencyCommand $command
     *
     * @return CurrencyId
     */
