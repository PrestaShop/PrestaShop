...
/**
 * Interface GetDisplayableCurrencyHandlerInterface defines contract for GetDisplayableCurrencyHandler.
 */
interface GetDisplayableCurrencyHandlerInterface
{
    /**
     * @param GetDisplayableCurrency $query
     *
     * @return DisplayableCurrency
     */
