...
/**
 * Defines contract for GetApplicationForViewing
 */
interface GetApplicationForViewingHandlerInterface
{
    /**
     * @param GetApplicationForViewing $query
     *
     * @return ViewableApplication
     */
    public function handle(GetApplicationForViewing $query);
}
