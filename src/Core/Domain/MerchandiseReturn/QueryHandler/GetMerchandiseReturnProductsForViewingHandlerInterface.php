...
/**
 * Defines contract for GetMerchandiseReturnProductsForViewingHandler
 */
interface GetMerchandiseReturnProductsForViewingHandlerInterface
{
    /**
     * @param GetMerchandiseReturnProductsForViewing $query
     *
