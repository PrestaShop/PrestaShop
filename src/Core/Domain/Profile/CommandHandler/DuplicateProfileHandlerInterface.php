...
/**
 * Interface DuplicateProfileHandlerInterface defines profile deletion handler.
 */
interface DuplicateProfileHandlerInterface
{
    /**
     * Duplicate profile.
     *
     * @param DuplicateProfileCommand $command
     */
