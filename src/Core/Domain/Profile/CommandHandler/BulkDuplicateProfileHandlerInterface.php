...
/**
 * Interface BulkDuplicateProfileHandlerInterface defines profile bulk deletion handler.
 */
interface BulkDuplicateProfileHandlerInterface
{
    /**
     * Duplicate multiple profiles.
     *
     * @param BulkDuplicateProfileCommand $command
     */
