...
class EditableTaxRulesGroup
{
     ...
     * @param bool $active
     */
    public function __construct(TaxRulesGroupId $taxRulesGroupId, string $name, bool $active)
    {
     ...
     */
    public function setShopAssociation(?array $shopAssociation): EditableTaxRulesGroup
    {
