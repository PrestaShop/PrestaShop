...
class OrderReturnProduct
{
    ...
    /**
     * OrderReturnProduct constructor.
     *
     * @param int $orderReturnDetailId
     *
     * @throws OrderReturnConstraintException
     */
    public function __construct(int $orderReturnDetailId)
    {
     ...
     */
    public function setCustomizationId(int $customizationId): OrderReturnProduct
    {
