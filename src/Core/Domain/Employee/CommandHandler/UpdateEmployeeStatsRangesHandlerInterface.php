...
/**
 * Defines contract for UpdateEmployeeStatsRangesHandler.
 */
interface UpdateEmployeeStatsRangesHandlerInterface
{
    /**
     * @param UpdateEmployeeStatsRangesCommand $command
     */
