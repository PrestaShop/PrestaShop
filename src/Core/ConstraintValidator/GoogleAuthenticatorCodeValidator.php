...
final class GoogleAuthenticatorCodeValidator extends ConstraintValidator
{
    ...
    {
        if (!$constraint instanceof GoogleAuthenticatorCode) {
            throw new UnexpectedTypeException($constraint, GoogleAuthenticatorCode::class);
        }
        ...
        $isValid = $this->googleAuthenticatorService->verifyCode($this->contextEmployeeProvider->getTwoFactorSecret(), $value);
