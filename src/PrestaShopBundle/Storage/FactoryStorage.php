...
/**
 * Factory that returns a StorageInterface by name.
 * Storage names are configured in application config (config.yml).
 */
class FactoryStorage implements FactoryStorageInterface
{
