...
class CombinationFeaturesType extends TranslatorAwareType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('feature_id', ChoiceType::class, [
                ...
                'attr' => [
                    'class' => 'combination-feature-selector',
                ],
                'external_link' => [
            ...
            ->add('feature_value_id', ChoiceType::class, [
                ...
                'attr' => [
                    ...
                    'class' => 'combination-feature-value-selector',
                ],
            ])
            ->add('custom_value', TranslatableType::class, [
                ...
                'type' => TextType::class,
                'attr' => [
                    'class' => 'combination-new-custom-values d-none',
                ],
            ])
            ->add('add_feature', IconButtonType::class, [
                ...
                'icon' => 'add_circle',
                'attr' => [
                    'class' => 'btn-outline-secondary combination-feature-value-add-button',
                ],
                'disabled' => true,
            ])
            ->add('feature_collection', CombinationFeatureCollectionType::class)
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults([
            'form_theme' => '@PrestaShop/Admin/Sell/Catalog/Product/FormTheme/combination_features.html.twig',
        ]);
    }
}
