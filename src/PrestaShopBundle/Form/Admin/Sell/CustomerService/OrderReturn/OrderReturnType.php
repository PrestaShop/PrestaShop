...
class OrderReturnType extends TranslatorAwareType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            // Hidden field carrying a JSON-encoded array of {orderDetailId, customizationId}
            // pairs that the front-end appends as the merchant confirms each deletion in the
            // modal (Issue #27628). Parsed by OrderReturnFormDataHandler.
            ->add('staged_product_deletions', HiddenType::class, [
                'required' => false,
                'empty_data' => '',
                'label' => false,
                'attr' => [
                    'data-role' => 'order-return-staged-deletions',
                ],
            ])
        ;
    }
