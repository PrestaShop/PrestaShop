 ...
 */
class CategoryMenuThumbnailsType extends FileType
{
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $view->vars['category_id'] = $options['category_id'];
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults([
            ...
            ->setAllowedTypes('preview_images', ['null', 'array'])
            ->setAllowedTypes('category_id', ['null', 'int'])
        ;
    }
    ...
    {
        return 'category_menu_thumbnails';
    }
