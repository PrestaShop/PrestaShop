...
final class FormHandler extends AbstractFormHandler
{
    ...
    public function getForm()
    {
        ...
        $this->hookDispatcher->dispatchForParameters('actionAdministrationForm', ['form_builder' => &$formBuilder]);
    ...
    public function save(array $data)
    {
        ...
        $this->hookDispatcher->dispatchForParameters('actionAdministrationFormSave', ['errors' => &$errors, 'form_data' => &$data]);
