...
class ProductSeo extends CommonAbstractType
{
    ...
    {
        $remoteUrls = [
            ProductInterface::REDIRECT_TYPE_PRODUCT_MOVED_PERMANENTLY => $this->context->getAdminLink('AdminProducts', true, ['ajax' => 1, 'action' => 'productsList', 'forceJson' => 1, 'disableCombination' => 1, 'exclude_packs' => 0, 'excludeVirtuals' => 0, 'limit' => 20, 'q' => '%QUERY']),
            ProductInterface::REDIRECT_TYPE_PRODUCT_FOUND => $this->context->getAdminLink('AdminProducts', true, ['ajax' => 1, 'action' => 'productsList', 'forceJson' => 1, 'disableCombination' => 1, 'exclude_packs' => 0, 'excludeVirtuals' => 0, 'limit' => 20, 'q' => '%QUERY']),
