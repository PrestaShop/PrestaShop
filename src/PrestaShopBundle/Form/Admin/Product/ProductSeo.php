...
class ProductSeo extends CommonAbstractType
{
    ...
    {
        $remoteUrls = [
            ProductInterface::REDIRECT_PRODUCT_301 => $this->context->getAdminLink('', false) . 'ajax_products_list.php?forceJson=1&disableCombination=1&exclude_packs=0&excludeVirtuals=0&limit=20&q=%QUERY',
            ProductInterface::REDIRECT_PRODUCT_302 => $this->context->getAdminLink('', false) . 'ajax_products_list.php?forceJson=1&disableCombination=1&exclude_packs=0&excludeVirtuals=0&limit=20&q=%QUERY',
            ProductInterface::REDIRECT_CATEGORY_301 => $this->router->generate('admin_get_ajax_categories') . '&query=%QUERY',
            ProductInterface::REDIRECT_CATEGORY_302 => $this->router->generate('admin_get_ajax_categories') . '&query=%QUERY',
        ];
        ...
        $builder->add(
            ...
            ->add(
                ...
                [
                    'choices' => [
                        $this->translator->trans('Permanent redirection to a category (301)', [], 'Admin.Catalog.Feature') => ProductInterface::REDIRECT_CATEGORY_301,
                        $this->translator->trans('Temporary redirection to a category (302)', [], 'Admin.Catalog.Feature') => ProductInterface::REDIRECT_CATEGORY_302,
                        $this->translator->trans('Permanent redirection to a product (301)', [], 'Admin.Catalog.Feature') => ProductInterface::REDIRECT_PRODUCT_301,
                        $this->translator->trans('Temporary redirection to a product (302)', [], 'Admin.Catalog.Feature') => ProductInterface::REDIRECT_PRODUCT_302,
                        $this->translator->trans('No redirection (404)', [], 'Admin.Catalog.Feature') => ProductInterface::REDIRECT_NOT_FOUND,
                    ],
