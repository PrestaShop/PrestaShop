...
class SearchParametersResolver implements ArgumentValueResolverInterface
{
     ...
     */
    public function  __construct(SearchParameters $searchParameters, TokenStorageInterface $tokenStorage, $shopId)
    {
    ...
    public function resolve(Request $request, ArgumentMetadata $argument)
    {
        ...
        if ($request->query->has('filters')) {
            ...
            if ($request->isMethod('GET')) {
                $filters = $this->searchParameters->getFiltersFromRepository($this->employee->getId(), $this->shopId, $request, $filtersClass);
            }
