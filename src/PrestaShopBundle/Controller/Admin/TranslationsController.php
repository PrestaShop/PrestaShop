...
class TranslationsController extends FrameworkBundleAdminController
{
    ...
    public function showSettingsAction(Request $request)
    {
        ...
        $addUpdateLanguageForm = $this->get('prestashop.admin.translations_settings.add_update_language.form_handler')->getForm();
        $exportLanguageForm = $this->get('prestashop.admin.translations_settings.export_language.form_handler')->getForm();
        $copyLanguageForm = $this->get('prestashop.admin.translations_settings.copy_language.form_handler')->getForm();
    ...
    {
        $formHandler = $this->get('prestashop.admin.translations_settings.add_update_language.form_handler');
    ...
    {
        $formHandler = $this->get('prestashop.admin.translations_settings.export_language.form_handler');
    ...
    {
        $formHandler = $this->get('prestashop.admin.translations_settings.copy_language.form_handler');
