...
class AdministrationController extends FrameworkBundleAdminController
{
    ...
    {
        $this->dispatchHook(
            'actionAdminAdmininistrationControllerPostProcess' . $hookName . 'Before',
            ['controller' => $this]
        );

        $this->dispatchHook('actionAdminAdmininistrationControllerPostProcessBefore', ['controller' => $this]);
