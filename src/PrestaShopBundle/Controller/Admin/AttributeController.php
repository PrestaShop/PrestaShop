...
class AttributeController extends FrameworkBundleAdminController
{
    ...
    public function getAllAttributesAction()
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            $dataGroupAttributes[$attribute['id_attribute_group']] = array(
                ...
                'label' => $attribute['public_name'].' : '.$translator->trans('All', array(), 'AdminTabs'),
                'data' => array(
    ...
    public function deleteAttributeAction($idAttribute, $idProduct, Request $request)
    {
        ...
        $response->setData(array('message' => $translator->trans($res['message'], array(), 'AdminProducts')));
    ...
    public function getProductCombinationsAction($idProduct)
    {
        ...
        foreach ($combinations as $combination) {
            ...
            $combinationList[] = array('id' => $newCombination['id_product_attribute'], 'name' => $newCombination['name']);
        }
