    ...
    public function uploadImageAction($idProduct, Request $request)
    {
        ...
        $form = $this->createFormBuilder(null, array('csrf_protection' => false))
            ->add('file', 'file', array(
                'error_bubbling' => true,
                'constraints' => [
                    new \Symfony\Component\Validator\Constraints\NotNull(array('message' => $translator->trans('Please select a file', [], 'AdminProducts'))),
                    new \Symfony\Component\Validator\Constraints\Image(array('maxSize' => '8M')),
                ]
            ))
            ->getForm();
