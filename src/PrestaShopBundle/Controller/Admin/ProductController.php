...
class ProductController extends FrameworkBundleAdminController
{
    ...
    public function catalogAction(
        ...
        $offset = 'last' === $offset ? $persistedFilterParameters['last_offset'] : $offset;
        $limit = 'last' === $limit ? $persistedFilterParameters['last_limit'] : $limit;
        $orderBy = 'last' === $orderBy ? $persistedFilterParameters['last_orderBy'] : $orderBy;
        $sortOrder = 'last' === $sortOrder ? $persistedFilterParameters['last_sortOrder'] : $sortOrder;
