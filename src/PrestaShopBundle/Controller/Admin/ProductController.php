...
class ProductController extends FrameworkBundleAdminController
{
    ...
    public function formAction($id, Request $request)
    {
        ...
        $id_language = empty($languages[0]) ? 1 : $languages[0]['id_lang'];
        $attributeGroups = $doctrine->getRepository('PrestaShopBundle:Attribute')->findByLangAndShop((int) $id_language, (int) $legacyContextService->getContext()->shop->id);
