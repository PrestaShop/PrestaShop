...
namespace PrestaShopBundle\Install {
    ...
    class Upgrade
    {
        ...
        private function checkVersion()
        {
            ...
            if (false === mb_strpos(_PS_INSTALL_VERSION_, '.')) {
                $this->logError(
        ...
        public static function migrateSettingsFile(Event $event = null)
        {
            ...
            if (!file_exists($root_dir . '/app/config/parameters.yml') && $tmp_settings && false !== mb_strpos($tmp_settings, '_DB_SERVER_')) {
