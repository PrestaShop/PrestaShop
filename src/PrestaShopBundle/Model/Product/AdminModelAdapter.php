...
class AdminModelAdapter extends \PrestaShopBundle\Model\AdminModelAdapter
{
    ...
    public function getModelData($form_data, $isMultiShopContext = false)
    {
        ...
        if ($form_data['redirect_type'] != ProductInterface::REDIRECT_NOT_FOUND) {
            ...
            } elseif (ProductInterface::REDIRECT_CATEGORY_301 == $form_data['redirect_type'] || ProductInterface::REDIRECT_CATEGORY_302 == $form_data['redirect_type']) {
                $form_data['id_type_redirected'] = 0;
            } else {
                $form_data['id_type_redirected'] = 0;
                $form_data['redirect_type'] = ProductInterface::REDIRECT_CATEGORY_301;
            }
        } else {
            $form_data['id_type_redirected'] = 0;
        }
