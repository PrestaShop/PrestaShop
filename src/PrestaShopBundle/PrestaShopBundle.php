...
use PrestaShopBundle\DependencyInjection\Compiler\PopulateFormHandlersPass;
...
class PrestaShopBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new PopulateFormHandlersPass(), PassConfig::TYPE_BEFORE_REMOVING);
