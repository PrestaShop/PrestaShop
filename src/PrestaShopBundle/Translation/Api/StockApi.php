...
class StockApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return array(
            ...
            'filter_status_disable' => $this->translator->trans('Disable', array(), 'Admin.Catalog.Feature'),
            'filter_status_enable' => $this->translator->trans('Enable', array(), 'Admin.Catalog.Feature'),
            'filter_status_enabled' => $this->translator->trans('Enable Status', array(), 'Admin.Catalog.Feature'),
