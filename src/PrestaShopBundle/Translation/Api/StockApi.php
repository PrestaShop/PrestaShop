...
class StockApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return array(
            ...
            'filter_status' => $this->translator->trans('Filter by enable status', array(), 'Admin.Catalog.Feature'),
            'filter_status_all' => $this->translator->trans('All', array(), 'Admin.Actions'),
            'filter_status_disable' => $this->translator->trans('Disable', array(), 'Admin.Actions'),
            'filter_status_enable' => $this->translator->trans('Enable', array(), 'Admin.Actions'),
            ...
            'title_status' => $this->translator->trans('Enable Status', array(), 'Admin.Catalog.Feature'),
