...
class StockApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return [
            ...
            'filter_stock_needed' => $this->translator->trans('Filter by products that need Restock', [], 'Admin.Catalog.Feature'),
            'filter_stock_show_only_restockable' => $this->translator->trans('Show only restockable products', [], 'Admin.Catalog.Feature'),
            ...
            'title_to_be_restocked' => $this->translator->trans('Re-stockable product', [], 'Admin.Catalog.Feature'),
