...
class StockApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return array(
            ...
            'head_title' => $this->translator->trans('Stocks management', array(), 'Admin.Catalog.Feature'),
            ...
            'link_overview' => $this->translator->trans('Stocks', array(), 'Admin.Catalog.Feature'),
            'link_stock' => $this->translator->trans('Stocks management', array(), 'Admin.Catalog.Feature'),
            'menu_stock' => $this->translator->trans('Stocks', array(), 'Admin.Catalog.Feature'),
            ...
            'notification_stock_updated' => $this->translator->trans('Stocks successfully updated', array(), 'Admin.Catalog.Notification'),
