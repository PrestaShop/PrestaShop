...
class StockApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return array(
            ...
            'filter_status_all' => $this->translator->trans('All', array(), 'Admin.Catalog.Actions'),
            'filter_status_disable' => $this->translator->trans('Disabled', array(), 'Admin.Catalog.Actions'),
            'filter_status_enable' => $this->translator->trans('Enabled', array(), 'Admin.Catalog.Actions'),
            ...
            'title_status' => $this->translator->trans('Status', array(), 'Admin.Catalog.Feature'),
