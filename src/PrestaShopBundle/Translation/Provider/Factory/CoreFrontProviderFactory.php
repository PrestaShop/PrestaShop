...
class CoreFrontProviderFactory implements ProviderFactoryInterface
{
    /**
    ...
    {
        return $providerType instanceof CoreFrontType;
    }
    ...
    public function build(TypeInterface $providerType): ProviderInterface
    {
        ...
        /* @var CoreFrontType $providerType */
        return new CoreFrontProvider(
