...
/**
 * Represents strategy for 'mails' type of translation.
 * It must use the MailsProvider and required parameters.
 */
class MailsStrategy implements StrategyInterface
{
    /**
     * @var string
     */
