...
use PrestaShop\PrestaShop\Core\Domain\Employee\QueryHandler\GetEmployeeForPasswordResetHandlerInterface;
use PrestaShop\PrestaShop\Core\Domain\Employee\QueryResult\PasswordResettingEmployee;
use PrestaShop\PrestaShop\Core\Domain\Employee\ValueObject\EmployeeId;
use PrestaShop\PrestaShop\Core\Domain\ValueObject\Email;

/**
 * Handle getting employee for password resetting query.
 */
final class GetEmployeeForPasswordResetHandler implements GetEmployeeForPasswordResetHandlerInterface
{
    /**
     * {@inheritdoc}
     */
    public function handle(GetEmployeeForPasswordReset $query)
    {
        ...
        return new PasswordResettingEmployee(
