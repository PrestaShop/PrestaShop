            ...
            try {
                ...
                if ($entity->id != $entityIdValue) {
                    throw new ProfileNotFoundException(
                        sprintf('Profile with id %s cannot be found.', var_export($entityIdValue, true))
                    );
                }
                ...
                throw new ProfileException(
                    sprintf('Unexpected error occurred when deleting Profile with id %s', var_export($entityIdValue, true)),
                    0,
                    $e
                );
            }
