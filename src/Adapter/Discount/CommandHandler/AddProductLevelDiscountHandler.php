...
use PrestaShop\PrestaShop\Core\Domain\Discount\CommandHandler\AddProductLevelDiscountHandlerInterface;
use PrestaShop\PrestaShop\Core\Domain\Discount\ValueObject\DiscountId;

#[AsCommandHandler]
class AddProductLevelDiscountHandler implements AddProductLevelDiscountHandlerInterface
{
    public function __construct(
        private readonly DiscountRepository $cartRuleRepository,
        private readonly CartRuleBuilder $cartRuleBuilder
    ) {
    }

    public function handle(AddProductLevelDiscountCommand $command): DiscountId
    {
