...
/**
 * Class BulkDeleteAttachmentsHandler
 */
final class BulkDeleteAttachmentsHandler extends AbstractAttachmentCommandHandler implements BulkDeleteAttachmentHandlerInterface
{
    /**
     * {@inheritdoc}
     */
