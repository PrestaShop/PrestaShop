...
use PrestaShop\PrestaShop\Core\Domain\Store\QueryHandler\GetStoreForDeletingHandlerInterface;
use PrestaShop\PrestaShop\Core\Domain\Store\QueryResult\StoreForDeleting;
use PrestaShop\PrestaShop\Core\Domain\Store\Repository\StoreRepository;
use PrestaShopException;

class GetStoreForDeletingHandler implements GetStoreForDeletingHandlerInterface
{
    /**
     * @var StoreRepository
     */
     ...
     */
    public function handle(GetStoreForDeleting $query): StoreForDeleting
    {
        try {
        ...
        return new StoreForDeleting($store->id);
    }
}
