...
namespace PrestaShop\PrestaShop\Adapter\Improve\Design;

use PrestaShop\PrestaShop\Core\Configuration\DataConfigurationInterface;
use PrestaShop\PrestaShop\Adapter\Configuration;

/**
 * This class will manage modules positions
 */
class PositionsConfiguration implements DataConfigurationInterface
{
    /**
     * @var Configuration
     */
