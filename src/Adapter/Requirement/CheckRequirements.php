...
class CheckRequirements
{
    ...
    private function getErrorMessages()
    {
        return array(
            ...
            'dom' => $this->translator->trans('Enable the DOM extension on your server.', array(), 'Install'),
            ...
            'mbstring' => $this->translator->trans('Enable the Mbstring extension on your server.', array(), 'Install'),
            ...
            'theme_cache_dir' => $this->translator->trans('Set the write permissions for the "themes/%s/cache/" folder and subfolders, recursively.', array('%s' => _THEME_NAME_), 'Admin.Advparameters.Notification'),
            ...
            'theme_pdf_lang_dir' => $this->translator->trans('Set the write permissions for the "themes/%s/pdf/lang/" folder and subfolders, recursively.', array('%s' => _THEME_NAME_), 'Admin.Advparameters.Notification'),
            'config_sf2_dir' => $this->translator->trans('Set the write permissions for the "app/config/" folder and subfolders, recursively.', array(), 'Admin.Advparameters.Notification'),
            'translations_sf2' => $this->translator->trans('Set the write permissions for the "app/Resources/translations/" folder and subfolders, recursively.', array(), 'Admin.Advparameters.Notification'),
