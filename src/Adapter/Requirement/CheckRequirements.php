...
class CheckRequirements
{
    ...
    private function getErrorMessages()
    {
        return [
            ...
            'new_phpversion' => $this->translator->trans('You are using PHP %s version. Soon, the latest PHP version supported by PrestaShop will be PHP 5.6. To make sure you’re ready for the future, we recommend you to upgrade to PHP 5.6 now!', ['%s' => phpversion()], 'Admin.Advparameters.Notification'),
