...
use PrestaShop\PrestaShop\Core\Domain\Alias\CommandHandler\DeleteAliasSearchTermHandlerInterface;

#[AsCommandHandler]
class DeleteAliasSearchTermHandler implements DeleteAliasSearchTermHandlerInterface
{
