 ...
 */
final class BulkDeleteOrderStateHandler extends AbstractOrderStateHandler implements BulkDeleteOrderStateHandlerInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    public function handle(BulkDeleteOrderStateCommand $command): void
    {
        ...
        if (!empty($errors)) {
            throw new BulkDeleteOrderStateException($errors, 'Failed to delete all of selected addresses');
        }
    }
}
