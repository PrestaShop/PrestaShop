...
class StockMovementFilter
{
    ...
    {
        return implode($separator, array_map(
            static function (MovementReasonId $reasonId): int {
                return $reasonId->getValue();
            },
            $this->getReasonIds()
        ));
    }
    ...
    /**
     * @param MovementReasonId ...$reasonIds
     */
    public function setReasonIds(MovementReasonId ...$reasonIds): self
    {
