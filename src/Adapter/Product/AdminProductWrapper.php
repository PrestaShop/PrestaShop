...
class AdminProductWrapper
{
    ...
    public function processProductCustomization($product, $data)
    {
        ...
        $product->updateCustomizationFieldsToDeleted($customization_ids);

        $usedCustomizationIds = $product->getUsedCustomizationFieldsIds();
        array_walk($usedCustomizationIds, array($this, 'customizationFieldsArrayAdapter'));
        ...
        foreach ($productCustomization as $customizationFiled) {
            ...
            if (in_array((int)$customizationFiled['id_customization_field'], $customization_ids)) {
                Customization::deleteCustomuzationFieldByShop($customizationFiled['id_customization_field'], $shopList);
            }
        }
    ...
    /**
     * Customization fields array adapter
     *
     * @param array $value
     */
    private function customizationFieldsArrayAdapter(&$value){
