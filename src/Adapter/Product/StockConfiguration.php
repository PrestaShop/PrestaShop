...
class StockConfiguration extends AbstractMultistoreConfiguration
{
    ...
    public function getConfiguration()
    {
        ...
        return [
            ...
            'in_stock_label' => (array) $this->configuration->get('PS_LABEL_IN_STOCK_PRODUCTS', null, $shopConstraint),
            'oos_allowed_backorders' => (array) $this->configuration->get('PS_LABEL_OOS_PRODUCTS_BOA', null, $shopConstraint),
            'oos_denied_backorders' => (array) $this->configuration->get('PS_LABEL_OOS_PRODUCTS_BOD', null, $shopConstraint),
