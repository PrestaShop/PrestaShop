...
final class UpdateCartCurrencyHandler implements UpdateCartCurrencyHandlerInterface
{
    ...
    {
        $currency = $this->getLegacyCurrencyObject($command->getNewCurrencyId());
    ...
    private function getLegacyCurrencyObject(CurrencyId $currencyId)
    {
    ...
    private function assertCurrencyCanBeUsed(Currency $currency)
    {
