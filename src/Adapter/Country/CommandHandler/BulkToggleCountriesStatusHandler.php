...
/**
 * Handles bulk countries status toggling
 */
final class BulkToggleCountriesStatusHandler extends AbstractCountryHandler implements BulkToggleCountriesStatusHandlerInterface
{
    /**
     * {@inheritdoc}
     *
