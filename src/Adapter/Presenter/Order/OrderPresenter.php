...
class OrderPresenter extends AbstractLazyPresenter
{
    /* @var CartPresenter */
    ...
    {
        $orderSubtotalPresenter = new OrderSubtotalPresenter();
        return $orderSubtotalPresenter->present($this->order);
    }
    ...
    public function getDetails()
    {
        ...
        return $orderDetailPresenter->present($this->order);
    }
