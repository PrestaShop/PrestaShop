    ...
    public function addQuantityInformation(
        ...
        if ($show_availability) {
            ...
            if ($availableQuantity >= 0) {
                ...
                $this->product['availability_date'] = $product['available_date'];
                $this->product['availability'] = 'available';
            } elseif ($product['cache_default_attribute'] && !empty($product['quantity_all_versions']) && ($product['quantity_all_versions'] - $product['quantity']) > 0) {
            ...
            } elseif ($product['quantity_wanted'] > $availableQuantity && $product['quantity'] > 0) {
                $this->product['availability_message'] = $this->translator->trans(
