...
class AdminModuleDataProvider implements ModuleInterface
{
    ...
    public const _ACTIONS_TRANSLATION_LABELS_ = [
        Module::ACTION_INSTALL => Module::ACTION_INSTALL,
        Module::ACTION_UNINSTALL => Module::ACTION_UNINSTALL,
        Module::ACTION_ENABLE => Module::ACTION_ENABLE,
        Module::ACTION_DISABLE => Module::ACTION_DISABLE,
        Module::ACTION_ENABLE_MOBILE => 'Enable mobile',
        Module::ACTION_DISABLE_MOBILE => 'Disable mobile',
        Module::ACTION_RESET => Module::ACTION_RESET,
        Module::ACTION_UPGRADE => Module::ACTION_UPGRADE,
        'configure' => 'configure',
    ];
